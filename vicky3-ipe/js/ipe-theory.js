...
export const IPE_THEORY_DATA = {
    ...
    concepts: {
        ...
        'seigniorage_negative_carry': {
            ...
            category: 'hegemony',
            summary: '外围国积累的对外净资产以低收益形式回流中心国，中心国再以更高回报反向投资外围——差额即外围向中心缴纳的隐性"铸币税"。',
            ...
            gameEffectDescription: '非英国国家只要保有正的对外净资产，每回合就会被小额抽走一部分流入英国国库——储备越多，缴纳的"铸币税"越多，这正是"外储越多≠越强大"的具体呈现。'
        },
        'credit_blockade': {
            id: 'credit_blockade',

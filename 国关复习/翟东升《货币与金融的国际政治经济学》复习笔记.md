...
<svg viewBox="0 0 780 200" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="老龄化到汇率升值的四步传导链：人口老龄化→可贸易品需求萎缩→通缩压力→购买力上升→汇率升值">
  <defs>
    <marker id="ageArr" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#64748b"/>
    </marker>
  </defs>
  <!-- 四个节点 -->
  <rect x="20" y="70" width="160" height="70" rx="10" fill="#fef3c7" stroke="#d97706" stroke-width="1.5"/>
  <text x="100" y="98" font-size="12.5" font-weight="700" fill="#92400e" text-anchor="middle">① 人口老龄化</text>
  <text x="100" y="118" font-size="10.5" fill="#475569" text-anchor="middle">需求结构变化</text>
  <rect x="215" y="70" width="160" height="70" rx="10" fill="#fef3c7" stroke="#d97706" stroke-width="1.5"/>
  <text x="295" y="98" font-size="12.5" font-weight="700" fill="#92400e" text-anchor="middle">② 可贸易品需求萎缩</text>
  <text x="295" y="118" font-size="10.5" fill="#475569" text-anchor="middle">家电/汽车等通缩压力</text>
  <rect x="410" y="70" width="160" height="70" rx="10" fill="#fef3c7" stroke="#d97706" stroke-width="1.5"/>
  <text x="490" y="98" font-size="12.5" font-weight="700" fill="#92400e" text-anchor="middle">③ 本币购买力上升</text>
  <text x="490" y="118" font-size="10.5" fill="#475569" text-anchor="middle">单位本币买更多</text>
  <rect x="605" y="70" width="160" height="70" rx="10" fill="#dcfce7" stroke="#16a34a" stroke-width="1.8"/>
  <text x="685" y="98" font-size="12.5" font-weight="700" fill="#14532d" text-anchor="middle">④ 汇率升值</text>
  <text x="685" y="118" font-size="10.5" fill="#475569" text-anchor="middle">PPP 作用 · 日德为证</text>
  <!-- 箭头 -->
  <path d="M 180 105 L 215 105" fill="none" stroke="#64748b" stroke-width="1.8" marker-end="url(#ageArr)"/>
  <path d="M 375 105 L 410 105" fill="none" stroke="#64748b" stroke-width="1.8" marker-end="url(#ageArr)"/>
  <path d="M 570 105 L 605 105" fill="none" stroke="#64748b" stroke-width="1.8" marker-end="url(#ageArr)"/>
  <!-- 底部机理 -->
...
<svg viewBox="0 0 780 768" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="本节核心概念与八道题的分布矩阵：26 个核心概念分四名词五理论、翟东升机制术语、判断词与政策词三组，横向对应题1至题8，格内数字为该概念在该题正文中的出现次数">
  ...
  <text x="20" y="370" font-size="9.5" fill="var(--text-main)">货币地租</text>
...
<svg viewBox="0 0 680 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="三外路线核心框架：鼓励外贸、吸引外资、控制外汇三根支柱及其代价">
  ...
  <text x="135" y="380" text-anchor="middle" font-size="12" fill="#dc2626" dominant-baseline="central">货币地租：FDI~15% vs 美债~3%</text>
...
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:4px;">图：三外路线核心框架——三根支柱（外贸·外资·外汇）构成资金循环，但代价是货币地租与政策扭曲</figcaption>
</figure>

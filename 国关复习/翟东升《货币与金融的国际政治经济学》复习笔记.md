...
<svg viewBox="0 0 760 858" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:760px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="货币与金融国际政治经济学的四层理论框架与因果递进关系：历史演变导致现实结构，结构决定中国处境，处境倒逼破局之路">
  ...
  <text x="148" y="333" font-size="8.5" fill="#94a3b8" text-anchor="middle">缴铸币税·广义≈20%GDP</text>
...
- 👉 [点击观看](https://www.bilibili.com/video/BV1JT411G7WV/)
> *必背 · 7题*
...
> ⚠️ **准确理解翟东升的原意（避免踩坑）**：《货币、权力与人》"美元霸权的好处"一节里，铸币税只是**四项好处之一**（另三项：调控全球经济波动节奏并向美元储备持有者转嫁损失、金融制裁杠杆、使美国国力难以被超越），**并非"最核心"的一项**。翟东升还特意纠正朴素的"印纸换资源"说：狭义铸币税不过约千亿、广义也就三千多亿美元，绝对值并不惊人（甚至低于美国军费）；真正可观的是经**财政乘数效应**放大后的效果——相当于美国近 20% 的 GDP 来源于广义铸币税。论述题应把上述**四项好处**一并展开，而非只谈铸币税。
...
**双顺差漏斗模型与负利差循环——微观制度基础与向美元中心国”输血”**
...
<svg viewBox="0 0 800 520" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:800px;display:block;margin:0 auto;font-family:system-ui,-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;" role="img" aria-label="外汇储备形成的微观制度基础与双顺差漏斗模型：经常项目顺差占70%与资本项目顺差FDI双轨注水，通过强制结售汇制度漏斗被动汇入央行，形成官方外储并派生外汇占款与负利差循环">
  <defs>
    <linearGradient id="gradCA" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#f0fdf4"/>
      <stop offset="100%" stop-color="#dcfce7"/>
    </linearGradient>
    <linearGradient id="gradFA" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#eff6ff"/>
      <stop offset="100%" stop-color="#dbeafe"/>
    </linearGradient>
    <linearGradient id="gradFunnel" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#fffbeb"/>
      <stop offset="100%" stop-color="#fef3c7"/>
    </linearGradient>
    <linearGradient id="gradReserves" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#fdf4ff"/>
      <stop offset="100%" stop-color="#fae8ff"/>
    </linearGradient>
    <marker id="arrDownG" markerWidth="8" markerHeight="8" refX="4" refY="6" orient="auto">
      <path d="M1,1 L7,1 L4,7 z" fill="#16a34a"/>
    </marker>
    <marker id="arrDownB" markerWidth="8" markerHeight="8" refX="4" refY="6" orient="auto">
      <path d="M1,1 L7,1 L4,7 z" fill="#2563eb"/>
    </marker>
  ...
  <!-- 总体背景板 -->
  <rect x="0" y="0" width="800" height="520" rx="14" fill="#ffffff" stroke="#e2e8f0" stroke-width="1"/>

  <!-- 顶部主标题 -->
  <rect x="0" y="0" width="800" height="54" rx="14" fill="#0f172a"/>
  <rect x="0" y="40" width="800" height="14" fill="#0f172a"/>
  <text x="400" y="25" text-anchor="middle" font-size="15.5" font-weight="700" fill="#f8fafc">🌊 外汇储备形成的微观制度基础与「双顺差」漏斗模型</text>
  <text x="400" y="44" text-anchor="middle" font-size="11" fill="#94a3b8">核心解答：外汇从何而来（双顺差双轨注入） ➔ 制度如何集中（强制结售汇漏斗） ➔ 最终代价与循环</text>

  <!-- ================= 第一层：双轨并进（双顺差输入，y=64, h=142） ================= -->
  <!-- 左轨：经常项目顺差（实体端，70%主力） -->
  <g transform="translate(20, 64)" filter="url(#cardShadow)">
    <rect x="0" y="0" width="370" height="136" rx="9" fill="url(#gradCA)" stroke="#86efac" stroke-width="1.2"/>
    <rect x="0" y="0" width="370" height="30" rx="9 9 0 0" fill="#15803d"/>
    <text x="185" y="20" text-anchor="middle" font-size="12.5" font-weight="700" fill="#ffffff">① 经常项目顺差（货物贸易 · 实体输出）★ 占外储 ~70%</text>
    
    <text x="16" y="50" font-size="11" fill="#1e293b">• <tspan font-weight="700" fill="#15803d">微观基础一</tspan>：实体经济劳动力成本优势 + 完整产业链生态</text>
    <text x="16" y="69" font-size="10.5" fill="#334155">• <tspan font-weight="700">世界工厂效应</tspan>：全球产业转移承接国，制造业出口创汇能力极强</text>
    <text x="16" y="88" font-size="10.5" fill="#334155">• <tspan font-weight="700">政策诱导</tspan>：出口退税 + 人民币汇率长期相对低估，鼓励外向型创汇</text>
    <text x="16" y="107" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#166534">资金形态</tspan>：中国向全球输出实体劳动与资源，换回巨额可自由兑换美元</text>
    
    <rect x="12" y="115" width="346" height="15" rx="3" fill="#bbf7d0"/>
    <text x="185" y="126" text-anchor="middle" font-size="9" font-weight="700" fill="#14532d">贡献外汇储备绝对主力（2014峰值近4万亿中约70%来自经常项沉淀）</text>
  </g>

  <!-- 右轨：资本项目顺差（金融端，30%补充） -->
  <g transform="translate(410, 64)" filter="url(#cardShadow)">
    <rect x="0" y="0" width="370" height="136" rx="9" fill="url(#gradFA)" stroke="#93c5fd" stroke-width="1.2"/>
    <rect x="0" y="0" width="370" height="30" rx="9 9 0 0" fill="#1d4ed8"/>
    <text x="185" y="20" text-anchor="middle" font-size="12.5" font-weight="700" fill="#ffffff">② 资本项目顺差（外资 FDI 净流入 · 金融注入）</text>
    
    <text x="16" y="50" font-size="11" fill="#1e293b">• <tspan font-weight="700" fill="#1d4ed8">微观基础二</tspan>：跨国资本追逐中国高投资回报率（FDI回报达 10~15%）</text>
    <text x="16" y="69" font-size="10.5" fill="#334155">• <tspan font-weight="700">超国民待遇政策</tspan>：“两免三减半”税收优惠 + 地方政府园区招商引资竞赛</text>
    <text x="16" y="88" font-size="10.5" fill="#334155">• <tspan font-weight="700">资本管制不对称</tspan>：“宽进严出”——外资进得来，但国内民间资本出不去</text>
    <text x="16" y="107" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e40af">同向叠加反常</tspan>：正常国家经常顺差必然资本逆差对外投资；中国却罕见双顺差</text>
    
    <rect x="12" y="115" width="346" height="15" rx="3" fill="#bfdbfe"/>
    <text x="185" y="126" text-anchor="middle" font-size="9" font-weight="700" fill="#1e3a8a">高成本借入外资（借入资金与技术），与出口创汇同向共振注入外汇池</text>
  </g>

  <!-- 汇聚注水导向箭头 -->
  <path d="M 205 200 L 205 214 Q 205 224, 300 224" fill="none" stroke="#16a34a" stroke-width="2.5"/>
  <path d="M 595 200 L 595 214 Q 595 224, 500 224" fill="none" stroke="#2563eb" stroke-width="2.5"/>
  <line x1="300" y1="224" x2="380" y2="224" stroke="#16a34a" stroke-width="2.5"/>
  <line x1="500" y1="224" x2="420" y2="224" stroke="#2563eb" stroke-width="2.5"/>
  <line x1="400" y1="224" x2="400" y2="236" stroke="#b45309" stroke-width="2.5" marker-end="url(#arrDownG)"/>
  <text x="400" y="219" text-anchor="middle" font-size="10.5" font-weight="700" fill="#b45309">双顺差洪流同向注入</text>

  <!-- ================= 第二层：制度关键中枢（强制结售汇漏斗，y=242, h=96） ================= -->
  <g transform="translate(20, 240)" filter="url(#cardShadow)">
    <rect x="0" y="0" width="760" height="96" rx="9" fill="url(#gradFunnel)" stroke="#f59e0b" stroke-width="1.5"/>
    <rect x="0" y="0" width="760" height="26" rx="9 9 0 0" fill="#b45309"/>
    <text x="380" y="18" text-anchor="middle" font-size="12" font-weight="700" fill="#ffffff">③ 核心制度转换器：强制结售汇制度（Micro-Institutional Funnel）</text>
    
    <!-- 漏斗内三阶段流转卡片 -->
    <!-- 阶段A: 企业/机构 -->
    <rect x="18" y="34" width="220" height="52" rx="5" fill="#ffffff" stroke="#fcd34d" stroke-width="0.8"/>
    <text x="128" y="52" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">企业 / 外资机构（民间）</text>
    <text x="128" y="68" text-anchor="middle" font-size="10" fill="#475569">无权自主截留保留美元现汇</text>
    <text x="128" y="80" text-anchor="middle" font-size="9" fill="#dc2626">制度强制：创汇必须限期卖出</text>

    <!-- 转换箭头 -->
    <line x1="244" y1="60" x2="266" y2="60" stroke="#b45309" stroke-width="2" marker-end="url(#arrRight)"/>

    <!-- 阶段B: 指定商业银行 -->
    <rect x="272" y="34" width="216" height="52" rx="5" fill="#ffffff" stroke="#fcd34d" stroke-width="0.8"/>
    <text x="380" y="52" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">外汇指定商业银行</text>
    <text x="380" y="68" text-anchor="middle" font-size="10" fill="#475569">执行法定结汇业务</text>
    <text x="380" y="80" text-anchor="middle" font-size="9" fill="#1e40af">受银行结售汇头寸限额管制</text>

    <!-- 转换箭头 -->
    <line x1="494" y1="60" x2="516" y2="60" stroke="#b45309" stroke-width="2" marker-end="url(#arrRight)"/>

    <!-- 阶段C: 中国人民银行 -->
    <rect x="522" y="34" width="220" height="52" rx="5" fill="#fef2f2" stroke="#fca5a5" stroke-width="0.8"/>
    <text x="632" y="52" text-anchor="middle" font-size="11" font-weight="700" fill="#991b1b">中国人民银行（央行接盘）</text>
    <text x="632" y="68" text-anchor="middle" font-size="10" fill="#7f1d1d">必须无限额兜底收购全部美元</text>
    <text x="632" y="80" text-anchor="middle" font-size="9" font-weight="700" fill="#dc2626">分散民间汇 ➔ 国家官方储备</text>
  </g>

  <!-- 向下沉淀流向箭头 -->
  <line x1="400" y1="338" x2="400" y2="352" stroke="#b45309" stroke-width="2.5" marker-end="url(#arrDownG)"/>

  <!-- ================= 第三层：沉淀结果与深层代价效应（y=354, h=118） ================= -->
  <!-- 左卡片：国内货币效应（外汇占款） -->
  <g transform="translate(20, 354)" filter="url(#cardShadow)">
    <rect x="0" y="0" width="240" height="114" rx="8" fill="#fef2f2" stroke="#fca5a5" stroke-width="1"/>
    <text x="120" y="22" text-anchor="middle" font-size="11.5" font-weight="700" fill="#991b1b">🪙 对内：外汇占款被动投放</text>
    <text x="14" y="44" font-size="10" fill="#334155">• 央行收进美元，等额发行人民币</text>
    <text x="14" y="61" font-size="10" fill="#334155">• 外汇占款一度占基础货币超 80%</text>
    <text x="14" y="78" font-size="10" fill="#dc2626">• 被动输入通胀，倒逼巨额冲销</text>
    <text x="14" y="95" font-size="9.5" fill="#64748b">代价：提准+央票+压低储户利息</text>
  </g>

  <!-- 中卡片：官方储备沉淀核心枢纽 -->
  <g transform="translate(270, 354)" filter="url(#cardShadow)">
    <rect x="0" y="0" width="260" height="114" rx="8" fill="url(#gradReserves)" stroke="#c084fc" stroke-width="1.5"/>
    <text x="130" y="22" text-anchor="middle" font-size="12.5" font-weight="700" fill="#6b21a8">🏦 官方外汇储备沉淀（结果）</text>
    <text x="130" y="42" text-anchor="middle" font-size="11" font-weight="700" fill="#9333ea">2014 峰值近 4 万亿美元</text>
    <text x="16" y="62" font-size="10" fill="#334155">• 政治双刃剑：既是战略护城河</text>
    <text x="16" y="79" font-size="10" fill="#334155">• 又在依附曲线上沦为“金融人质”</text>
    <text x="16" y="97" font-size="9.5" font-weight="600" fill="#7e22ce">• 倒逼转向：自主性必须靠人民币国际化</text>
  </g>

  <!-- 右卡片：对外资产配置（负利差循环） -->
  <g transform="translate(540, 354)" filter="url(#cardShadow)">
    <rect x="0" y="0" width="240" height="114" rx="8" fill="#fff7ed" stroke="#fdba74" stroke-width="1"/>
    <text x="120" y="22" text-anchor="middle" font-size="11.5" font-weight="700" fill="#c2410c">🔄 对外：负利差向美输血</text>
    <text x="14" y="44" font-size="10" fill="#334155">• 储备安全性要求：只能大买美债</text>
    <text x="14" y="61" font-size="10" fill="#166534">• 美债低收益率：仅 ~2–3%</text>
    <text x="14" y="78" font-size="10" font-weight="700" fill="#dc2626">• vs 外资FDI在华回报率 ~10–15%</text>
    <text x="14" y="95" font-size="9.5" font-weight="700" fill="#c2410c">负利差 7~12% ＝ 向美元中心交税</text>
  </g>

  <!-- ================= 底部核心结论速记栏（y=476, h=34） ================= -->
  <g transform="translate(20, 474)">
    <rect x="0" y="0" width="760" height="34" rx="6" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1"/>
    <text x="380" y="15" text-anchor="middle" font-size="10.5" font-weight="700" fill="#0f172a">💡 考场作答公式：微观基础 ＝ 经常项目顺差（出口创汇占70%） ＋ 资本项目顺差（引资FDI占30%） ✖ 强制结售汇（制度漏斗）</text>
    <text x="380" y="28" text-anchor="middle" font-size="9.5" fill="#64748b">翟东升撕开点：外储不是“攒下的真金白银”，而是用实体劳动补贴西方消费、在负利差下向美元霸权缴纳的巨额隐形铸币税</text>
  </g>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">图：外汇储备微观制度基础——经常项目顺差（贸易创汇~70%）与资本项目顺差（FDI引资~30%）双轨注入，经由强制结售汇制度漏斗被动汇入央行，派生外汇占款并形成负利差循环</figcaption>
</figure>
...
> 💡 **记忆口诀**：**"让了利、贬了值、付了息、换了纸、成人质"**——让**利**＝机会成本（该赚没赚，最大）、贬**值**＝会计损失（账面缩水）、付**息**＝冲销成本（央行实付）、换**纸**＝资源错配（实物换债权）、人**质**＝安全风险（武器化）。五句押 i 韵，一笔比一笔亏。
>
...
<figure style="margin:12px 0;padding:12px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 780 540" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="外汇储备的政治意义与中美金融恐怖平衡全景图：上层为外汇储备政治意义的三维展开（一象征、两面性、一出路），中层为外储作为战略资产与质押品的逻辑纽带，下层为中美共生双循环、金融核恐怖平衡及动态瓦解走向">
  <defs>
    <marker id="arrBalGrn" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#16a34a"/>
    </marker>
    <marker id="arrBalAmb" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#d97706"/>
    </marker>
    <marker id="arrBalMut" markerWidth="9" markerHeight="9" refX="7" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="var(--text-muted)"/>
    </marker>
  </defs>

  <!-- 顶部主标题 -->
  <text x="390" y="24" text-anchor="middle" font-size="15" font-weight="700" fill="var(--text-main)">外汇储备的政治意义与中美金融"恐怖平衡"</text>
  <text x="390" y="42" text-anchor="middle" font-size="11.5" fill="var(--text-muted)">一象征 · 两面性 · 一出路 ➔ 相互依赖的战略威慑 ➔ 美元武器化与脱钩解体</text>

  <!-- ================= 模块一：外汇储备的政治意义 ================= -->
  <rect x="25" y="54" width="730" height="166" rx="10" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <rect x="38" y="64" width="280" height="22" rx="5" fill="rgba(99,102,241,0.12)" stroke="#6366f1" stroke-width="0.7"/>
  <text x="178" y="79" text-anchor="middle" font-size="11.5" font-weight="700" fill="#4338ca" dominant-baseline="central">🏛️ 模块一 · 外汇储备的政治意义（权力结构镜像）</text>
  <text x="742" y="79" text-anchor="end" font-size="11" fill="var(--text-muted)" dominant-baseline="central">核心判断：储备越多 ≠ 越强大，深嵌依附关系</text>

  <!-- 卡片 1：一象征 -->
  <rect x="38" y="94" width="222" height="114" rx="8" fill="rgba(37,99,235,0.06)" stroke="#2563eb" stroke-width="0.7"/>
  <text x="50" y="114" font-size="12" font-weight="700" fill="#1d4ed8">1. 一象征（世界工厂）</text>
  <text x="50" y="130" font-size="10" fill="var(--text-muted)">创汇能力与融入全球化凭证</text>
  <text x="50" y="152" font-size="10.5" fill="var(--text-main)">• 强大工业制造与创汇能力集中体现</text>
  <text x="50" y="170" font-size="10.5" fill="var(--text-main)">• 深度融入全球分工体系的"成功凭证"</text>
  <text x="50" y="188" font-size="10.5" fill="var(--text-main)">• 提升对外主权偿付信用与国家评级</text>

  <!-- 卡片 2：两面性 -->
  <rect x="268" y="94" width="244" height="114" rx="8" fill="rgba(220,38,38,0.05)" stroke="#dc2626" stroke-width="0.7"/>
  <text x="280" y="114" font-size="12" font-weight="700" fill="#b91c1c">2. 两面性（实力 vs 依附）</text>
  <text x="280" y="130" font-size="10" fill="var(--text-muted)">中心—外围不对称结构下的双重属性</text>
  <text x="280" y="152" font-size="10.5" fill="#15803d">🟢 实力：干预汇市平抑波动 · 抛售威慑</text>
  <text x="280" y="170" font-size="10.5" fill="#b91c1c">🔴 依附：向中心国输送信用 · 缴铸币税</text>
  <text x="280" y="190" font-size="10" font-weight="600" fill="#dc2626">⚠️ 极端地缘风险下：储备资产变"人质"</text>

  <!-- 卡片 3：一出路 -->
  <rect x="520" y="94" width="222" height="114" rx="8" fill="rgba(22,163,74,0.06)" stroke="#16a34a" stroke-width="0.7"/>
  <text x="532" y="114" font-size="12" font-weight="700" fill="#15803d">3. 一出路（本币国际化）</text>
  <text x="532" y="130" font-size="10" fill="var(--text-muted)">由"外围依附"迈向"自主中心"</text>
  <text x="532" y="152" font-size="10.5" fill="var(--text-main)">• 真正大国标志：让别国储备本币</text>
  <text x="532" y="170" font-size="10.5" fill="var(--text-main)">• 推动人民币国际化，摆脱美元绑架</text>
  <text x="532" y="188" font-size="10.5" fill="var(--text-main)">• 优化资产：增持黄金 · 减持美国国债</text>

  <!-- ================= 承上启下：逻辑纽带 ================= -->
  <rect x="25" y="228" width="730" height="28" rx="6" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.6"/>
  <text x="390" y="246" text-anchor="middle" font-size="11" font-weight="600" fill="var(--text-main)" dominant-baseline="central">🔗 逻辑纽带：外储（美债）既是中美共生循环的资金底座，也是金融核恐怖平衡的"相互质押品"</text>

  <!-- ================= 模块二：中美金融恐怖平衡与动态演变 ================= -->
  <rect x="25" y="264" width="730" height="262" rx="10" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <rect x="38" y="274" width="280" height="22" rx="5" fill="rgba(217,119,6,0.12)" stroke="#d97706" stroke-width="0.7"/>
  <text x="178" y="289" text-anchor="middle" font-size="11.5" font-weight="700" fill="#b45309" dominant-baseline="central">⚖️ 模块二 · 中美金融"恐怖平衡"与动态瓦解</text>

  <!-- 中美双方卡片 -->
  <rect x="38" y="304" width="195" height="96" rx="8" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="0.7"/>
  <text x="135" y="322" text-anchor="middle" font-size="12" font-weight="700" fill="#15803d">🇨🇳 中国（世界工厂·储蓄方）</text>
  <text x="48" y="342" font-size="10.5" fill="var(--text-main)">• 出口廉价工业品赚取美元顺差</text>
  <text x="48" y="360" font-size="10.5" fill="var(--text-main)">• 储备回流买美债（最高持超万亿）</text>
  <text x="48" y="378" font-size="10.5" fill="var(--text-main)">• 痛点：承担负利差与人质冻结风险</text>

  <rect x="547" y="304" width="195" height="96" rx="8" fill="rgba(217,119,6,0.08)" stroke="#d97706" stroke-width="0.7"/>
  <text x="644" y="322" text-anchor="middle" font-size="12" font-weight="700" fill="#b45309">🇺🇸 美国（金融中心·消费方）</text>
  <text x="557" y="342" font-size="10.5" fill="var(--text-main)">• 长期双赤字，借债透支消费</text>
  <text x="557" y="360" font-size="10.5" fill="var(--text-main)">• 依赖中国廉价品抑制国内通胀</text>
  <text x="557" y="378" font-size="10.5" fill="var(--text-main)">• 依赖中国买债压低美长期国债利率</text>

  <!-- 中间双循环流通路径 -->
  <line x1="237" y1="328" x2="542" y2="328" stroke="#16a34a" stroke-width="1.8" marker-end="url(#arrBalGrn)"/>
  <text x="390" y="321" text-anchor="middle" font-size="10.5" font-weight="600" fill="#15803d">出口工业品 ➔ 平抑美通胀、支撑消费</text>

  <line x1="237" y1="360" x2="542" y2="360" stroke="#d97706" stroke-width="1.8" marker-end="url(#arrBalAmb)"/>
  <text x="390" y="353" text-anchor="middle" font-size="10.5" font-weight="600" fill="#b45309">外储买美债 ➔ 压低美利率、为赤字融资</text>

  <text x="390" y="388" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">🔄 共生模式："中国生产、美国消费；中国储蓄、美国借贷"</text>

  <!-- 底部：威慑机制 vs 动态瓦解 -->
  <rect x="38" y="408" width="415" height="106" rx="8" fill="rgba(220,38,38,0.06)" stroke="#dc2626" stroke-width="0.8"/>
  <text x="50" y="427" font-size="11.5" font-weight="700" fill="#b91c1c">💣 "金融核恐怖平衡"（相互确保毁灭的战略威慑）</text>
  <text x="50" y="447" font-size="10.5" fill="var(--text-main)">• 中国大规模抛售美债 ➔ 美债暴跌+美利率飙升 ➔ 自身外储同步巨额缩水</text>
  <text x="50" y="466" font-size="10.5" fill="var(--text-main)">• 美国制裁冻结中国外储 ➔ 中国资产损失 ➔ 美元信用崩塌+丧失低成本融资</text>
  <text x="50" y="492" font-size="11" font-weight="700" fill="#dc2626">➔ 任何一方激进破坏 = 双输核灾难 ➔ "相互人质"构成事实威慑稳定</text>

  <rect x="463" y="408" width="279" height="106" rx="8" fill="rgba(99,102,241,0.06)" stroke="#6366f1" stroke-width="0.8"/>
  <text x="475" y="427" font-size="11.5" font-weight="700" fill="#4338ca">⚡ 动态演变 · 平衡瓦解与时代破局</text>
  <text x="475" y="447" font-size="10.5" fill="var(--text-main)">• 美方毁约：美元结算体系"武器化"（冻结俄外储）</text>
  <text x="475" y="465" font-size="10.5" fill="var(--text-main)">• 信用动摇：动摇无风险资产地位，全球加速反思</text>
  <text x="475" y="483" font-size="10.5" fill="var(--text-main)">• 中方破局：减持美债 · 增持黄金 · 推进 CIPS 系统</text>
  <text x="475" y="501" font-size="10" font-weight="700" fill="#16a34a">➔ 从"共生依附"转向"竞争脱钩"，迈向独立主体</text>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:4px;">图：外汇储备的政治意义与中美金融「恐怖平衡」——上层展现外储的权力结构镜像（一象征、两面性、一出路），下层展现以此为抵押品的中美金融双循环、恐怖平衡威慑及动态瓦解走向</figcaption>
</figure>
...
> **5. 全体国民**——外汇占款投放的人民币，换来的美元回流买美债（~3%）而国内回报 ~10%，7 个百分点利差就是向美元体系缴纳的"铸币税"（穷国补贴富国的逆向转移）。
>
> **四、被补贴的一方（四类受益者）**
...
> 
> **三类受害者** → 储蓄者（负实际利率）、制造业劳动者（双重剥夺）、全体国民（缴纳铸币税）。
> 
...
*   **① 储蓄者（负实际利率）**：金融抑制下，存款利率被行政压低至远低于通胀的水平，实际利率长期为负。居民储蓄实质上被“隐性通胀税”持续稀释。2010 年前后 CPI 一度破 5%，而一年期定存基准利率仅 3% 左右，储户每存 1 万元实际购买力缩水数百元——这是对 13 亿储蓄者无差别征收的“隐性通胀税”。
...
*   **③ 全体国民（缴纳铸币税）**：外汇占款投放的人民币，本质是以全民未来的购买力为代价，换取央行资产负债表上的美元资产。这些美元回流购买美债，收益约 3%；而国内被牺牲的投资回报可达 10%——7 个百分点的利差，就是全体国民向美元体系缴纳的“铸币税”。其实质是一种“穷国补贴富国”的逆向财富转移——翟东升在书中的原话是，这套资本大循环"补贴给了西方资本和全球消费者"。
...
<svg viewBox="0 0 680 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="外汇占款与冲销机制：强制结汇导致央行被动投放基础货币，冲销操作的成本由储蓄者和劳动者承担">
  <defs>
    <marker id="arrSter" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="var(--text-muted)"/>
    </marker>
    <marker id="arrSterR" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
...
>
> <span class="hl">**翟东升批判底线**：外储数字越大，说明中国向美元体系缴纳的"铸币税"越多——这不是财富的积累，而是财富转移的历史记录</span>。
>
> **一句话口诀**：**一体霸权套、两差送钱到、三环结汇交、四因联盟抱**（套/到/交/抱押 ao 韵，按「设套→送钱→上交→抱住」的故事线记）。
...
*   **翟东升叙事**：外储数字越大，说明中国向美元体系缴纳的"铸币税"越多——**这不是财富的积累，而是财富转移的历史记录**。
...
**翟东升《人民币汇率与人民币国际化》课程**
- 内容：翟东升教授的B站付费课程，系统讲解人民币汇率决定因素、汇率政策
- 👉 [点击观看](https://www.bilibili.com/video/BV1Ar4y167k7/)
> *必背 · 9题*
...
> **2. 铸币税（全体国民买单）**——美元回流买美债（~3%）而国内回报~10%，利差即向美元体系缴纳的"铸币税"。
...
翟东升的独到之处在于揭示：**低估 ≠ 简单"出口便宜"，而是一整套隐性财富转移机制**。记忆口诀：**"汇率税 → 铸币税 → 双重剥夺 → 结构锁定"**，分别由储蓄者、纳税人、劳动者、国家战略买单。
...
<figure style="margin:0;">
<svg viewBox="0 0 780 240" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="低估值四大代价的财富转移链：汇率税→铸币税→双重剥夺→结构锁定，分别由储蓄者、纳税人、劳动者、国家买单">
  <defs>
  ...
  <text x="295" y="105" font-size="12.5" font-weight="700" fill="#92400e" text-anchor="middle">② 铸币税</text>
...
>
> **记忆口诀汇总**：高估利弊 **"消进投升 / 出就储"**；低估代价 **"汇率税→铸币税→双重剥夺→结构锁定"**。
...
<div class="dgm">
<div class="dgm-h">📈 长期汇率双驱动机制 · 技术进步 vs 人口老龄化（翟东升反直觉命题）</div>
<figure style="margin:0;">
<svg viewBox="0 0 780 340" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="长期汇率双驱动机制：左翼技术进步提供生产率创汇支撑（受产能对冲），右翼人口老龄化通过可贸易品通缩主导长期升值（核心排序：老龄化 ＞ 技术进步）">
  <defs>
    <marker id="fxArrBlue" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#2563eb"/>
    </marker>
    <marker id="fxArrAmber" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#d97706"/>
    </marker>
  </defs>

  <!-- 顶部标题区 -->
  <text x="390" y="24" text-anchor="middle" font-size="15.5" font-weight="700" fill="var(--text-main)">📈 长期汇率双驱动机制 · 技术进步 vs 人口老龄化</text>
  <text x="390" y="44" text-anchor="middle" font-size="11.5" fill="var(--text-muted)">技术进步是生产率支撑（有产能扩张对冲） ✖ 老龄化是不可逆结构力量（通缩机制主导汇率坚挺）</text>

  <!-- ================= 左翼：技术进步（生产率驱动） ================= -->
  <rect x="20" y="58" width="350" height="216" rx="8" fill="rgba(99,102,241,0.06)" stroke="var(--primary)" stroke-width="1.2"/>
  <rect x="20" y="58" width="350" height="28" rx="8 8 0 0" fill="rgba(99,102,241,0.14)"/>
  <text x="195" y="77" text-anchor="middle" font-size="12.5" font-weight="700" fill="var(--primary)">🔵 变量一：技术进步（生产率支撑）</text>

  <!-- 左翼节点1 -->
  <rect x="34" y="94" width="322" height="34" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="46" y="115" font-size="11" font-weight="700" fill="var(--text-main)">① 全要素生产率 (TFP) 持续提升</text>
  <text x="250" y="115" font-size="9.5" fill="var(--text-muted)">技术创新·工艺精进</text>

  <line x1="195" y1="128" x2="195" y2="137" stroke="#2563eb" stroke-width="1.5" marker-end="url(#fxArrBlue)"/>

  <!-- 左翼节点2 -->
  <rect x="34" y="139" width="322" height="34" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="46" y="160" font-size="11" font-weight="700" fill="var(--text-main)">② 产业竞争力与可贸易品创汇增强</text>
  <text x="250" y="160" font-size="9.5" fill="var(--text-muted)">出口顺差·外汇净流入</text>

  <line x1="195" y1="173" x2="195" y2="182" stroke="#2563eb" stroke-width="1.5" marker-end="url(#fxArrBlue)"/>

  <!-- 左翼节点3 -->
  <rect x="34" y="184" width="322" height="34" rx="6" fill="rgba(99,102,241,0.12)" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="46" y="205" font-size="11" font-weight="700" fill="var(--primary)">③ 本币长期获得升值基本面支撑</text>
  <text x="250" y="205" font-size="9.5" fill="var(--primary)">创汇能力强·货币坚挺</text>

  <!-- 左翼局限对冲注记 -->
  <rect x="34" y="226" width="322" height="38" rx="5" fill="#f8fafc" stroke="#cbd5e1" stroke-width="0.8"/>
  <text x="44" y="242" font-size="9.5" font-weight="600" fill="#475569">⚠️ 对冲约束（为何是次要变量）：</text>
  <text x="44" y="256" font-size="9" fill="#64748b">伴随产能大规模释放与出口降价让利（技术扩散），升值动力部分被抵消</text>

  <!-- ================= 中间核心对比符号 ================= -->
  <rect x="382" y="138" width="26" height="56" rx="4" fill="#fef3c7" stroke="#d97706" stroke-width="1"/>
  <text x="395" y="160" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">主</text>
  <text x="395" y="174" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">导</text>
  <text x="395" y="188" text-anchor="middle" font-size="14" font-weight="700" fill="#dc2626">＞</text>

  <!-- ================= 右翼：人口老龄化（结构性主导） ================= -->
  <rect x="410" y="58" width="350" height="216" rx="8" fill="#fef3c7" stroke="#d97706" stroke-width="1.2"/>
  <rect x="410" y="58" width="350" height="28" rx="8 8 0 0" fill="#fde68a"/>
  <text x="585" y="77" text-anchor="middle" font-size="12.5" font-weight="700" fill="#92400e">🟣 变量二：人口老龄化（主导性结构变量）</text>

  <!-- 右翼四步链 -->
  <rect x="424" y="94" width="156" height="54" rx="6" fill="#fffbeb" stroke="#f59e0b" stroke-width="0.8"/>
  <text x="502" y="114" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">① 人口结构老龄化</text>
  <text x="502" y="132" text-anchor="middle" font-size="9.5" fill="#78350f">劳动人口缩减·需求转移</text>

  <line x1="580" y1="121" x2="589" y2="121" stroke="#d97706" stroke-width="1.5" marker-end="url(#fxArrAmber)"/>

  <rect x="590" y="94" width="156" height="54" rx="6" fill="#fffbeb" stroke="#f59e0b" stroke-width="0.8"/>
  <text x="668" y="114" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">② 可贸易品需求萎缩</text>
  <text x="668" y="132" text-anchor="middle" font-size="9.5" fill="#78350f">耐用品(汽车家电)饱和通缩</text>

  <line x1="668" y1="148" x2="668" y2="157" stroke="#d97706" stroke-width="1.5" marker-end="url(#fxArrAmber)"/>

  <rect x="590" y="159" width="156" height="54" rx="6" fill="#fffbeb" stroke="#f59e0b" stroke-width="0.8"/>
  <text x="668" y="179" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">③ 本币相对购买力上升</text>
  <text x="668" y="197" text-anchor="middle" font-size="9.5" fill="#78350f">供大于求物价跌·单位本币增值</text>

  <line x1="590" y1="186" x2="581" y2="186" stroke="#d97706" stroke-width="1.5" marker-end="url(#fxArrAmber)"/>

  <rect x="424" y="159" width="156" height="54" rx="6" fill="#dcfce7" stroke="#16a34a" stroke-width="1.2"/>
  <text x="502" y="179" text-anchor="middle" font-size="11" font-weight="700" fill="#14532d">④ PPP 推动名义汇率升值</text>
  <text x="502" y="197" text-anchor="middle" font-size="9.5" fill="#15803d">日元、德国马克长期偏强实证</text>

  <!-- 右翼反直觉注记 -->
  <rect x="424" y="226" width="322" height="38" rx="5" fill="#fff" stroke="#fcd34d" stroke-width="0.8"/>
  <text x="434" y="242" font-size="9.5" font-weight="600" fill="#92400e">💡 核心反直觉（为何是主导变量）：</text>
  <text x="434" y="256" font-size="9" fill="#b45309">老龄化是单向、不可逆的深刻结构性力量，对相对购买力的解释力显著强于技术进步</text>

  <!-- ================= 底部总结栏 ================= -->
  <rect x="20" y="284" width="740" height="46" rx="6" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="1"/>
  <text x="390" y="303" text-anchor="middle" font-size="11.5" font-weight="700" fill="#15803d">💡 考场核心论断与排序：老龄化 ＞ 技术进步（"技术支撑、老龄主导"）</text>
  <text x="390" y="320" text-anchor="middle" font-size="10" fill="var(--text-main)">汇率取决于相对购买力（PPP）：老龄化萎缩可贸易品需求诱发通缩，是导致汇率长期走强最有解释力的单一变量。</text>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">
图：长期汇率双驱动机制——<b>技术进步</b>（生产率创汇支撑，受产能扩张部分对冲）与<b>人口老龄化</b>（可贸易品萎缩引发相对通缩，PPP 传导名义升值）。核心排序：<b>老龄化 ＞ 技术进步</b>。
</figcaption>
</figure>
</div>
...
<div class="dgm">
<div class="dgm-h">⚖️ 人民币汇率操纵辨析 · 中美顺差结构根源与三方代价矩阵</div>
<figure style="margin:0;">
<svg viewBox="0 0 800 560" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:800px;display:block;margin:10px auto;font-family:system-ui,-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;" role="img" aria-label="人民币汇率操纵辨析中美顺差结构根源与三方代价矩阵图">
  <defs>
    <filter id="shadowRmb" x="-2%" y="-2%" width="104%" height="106%" filterUnits="userSpaceOnUse">
      <feDropShadow dx="0" dy="1.5" stdDeviation="2" flood-opacity="0.06"/>
    </filter>
  </defs>

  <!-- 背景框 -->
  <rect width="800" height="560" rx="14" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1.5"/>

  <!-- 顶部标题 -->
  <g transform="translate(400, 24)">
    <text x="0" y="0" font-size="16" font-weight="700" fill="#0f172a" text-anchor="middle">⚖️ 人民币汇率操纵辨析 · 中美顺差结构根源与三方代价矩阵</text>
    <text x="0" y="19" font-size="11" fill="#64748b" text-anchor="middle">政治经济学定性：汇率未被操纵 ｜ 顺差根在两国内生结构与全球分工 ｜ 指控系美方地缘博弈工具</text>
  </g>

  <!-- 顶部核心论断横幅 -->
  <g transform="translate(20, 52)">
    <rect width="760" height="34" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="1.2"/>
    <text x="380" y="21" font-size="11" font-weight="700" fill="#1e40af" text-anchor="middle">🎯 核心论断：人民币汇率未被操纵，更非巨幅顺差之因。贸易失衡本质是“美储蓄不足·过度消费”与“中国全链供给”的结构对接，“操纵”实为美施压筹码。</text>
  </g>

  <!-- 中层一：中美巨幅顺差的内生结构根源（双核对照） -->
  <g transform="translate(20, 94)">
    <!-- 美方内生结构 -->
    <g transform="translate(0, 0)" filter="url(#shadowRmb)">
      <rect width="345" height="132" rx="8" fill="#fef2f2" stroke="#ef4444" stroke-width="1.2"/>
      <path d="M0,8 Q0,0 8,0 L337,0 Q345,0 345,8 L345,26 L0,26 Z" fill="#dc2626"/>
      <text x="172" y="18" font-size="11" font-weight="700" fill="#ffffff" text-anchor="middle">🇺🇸 美国内生结构失衡（贸易逆差根本源头）</text>
      
      <text x="12" y="44" font-size="9.5" font-weight="700" fill="#991b1b">• 低储蓄与过度消费：</text>
      <text x="12" y="58" font-size="9" fill="#334155">国民储蓄率极低，信贷透支消费，总需求恒大于总产出（I &gt; S）</text>
      
      <text x="12" y="74" font-size="9.5" font-weight="700" fill="#991b1b">• 财政与经常账户“双赤字”：</text>
      <text x="12" y="88" font-size="9" fill="#334155">依赖美元霸权无限印钞发债，必以经常账户巨额逆差吸纳全球商品</text>
      
      <text x="12" y="104" font-size="9.5" font-weight="700" fill="#991b1b">• 跨国资本全球套利：</text>
      <text x="12" y="118" font-size="9" fill="#334155">华尔街资本为追求暴利主动外包中低端制造，加剧本土产业空心化</text>
    </g>

    <!-- 中间传导枢纽 -->
    <g transform="translate(354, 18)">
      <rect width="52" height="96" rx="8" fill="#ffffff" stroke="#94a3b8" stroke-width="1"/>
      <text x="26" y="24" font-size="10" font-weight="700" fill="#0f172a" text-anchor="middle">国际</text>
      <text x="26" y="38" font-size="10" font-weight="700" fill="#0f172a" text-anchor="middle">分工</text>
      <path d="M 12 50 L 40 50" stroke="#cbd5e1" stroke-width="1"/>
      <text x="26" y="66" font-size="9" font-weight="600" fill="#475569" text-anchor="middle">比较</text>
      <text x="26" y="79" font-size="9" font-weight="600" fill="#475569" text-anchor="middle">优势</text>
      <text x="26" y="91" font-size="8" fill="#dc2626" text-anchor="middle">非汇率</text>
    </g>

    <!-- 中方内生优势 -->
    <g transform="translate(415, 0)" filter="url(#shadowRmb)">
      <rect width="345" height="132" rx="8" fill="#ecfdf5" stroke="#10b981" stroke-width="1.2"/>
      <path d="M0,8 Q0,0 8,0 L337,0 Q345,0 345,8 L345,26 L0,26 Z" fill="#059669"/>
      <text x="172" y="18" font-size="11" font-weight="700" fill="#ffffff" text-anchor="middle">🇨🇳 中国内生要素优势（全球高性价比供给源）</text>
      
      <text x="12" y="44" font-size="9.5" font-weight="700" fill="#065f46">• 高储蓄与再投资生态：</text>
      <text x="12" y="58" font-size="9" fill="#334155">国民储蓄率高达45%左右，支撑大规模现代化基建与产业投资</text>
      
      <text x="12" y="74" font-size="9.5" font-weight="700" fill="#065f46">• 完整产业体系与规模效应：</text>
      <text x="12" y="88" font-size="9" fill="#334155">全门类制造集群+高素质工程师红利，提供无可替代的供应链韧性</text>
      
      <text x="12" y="104" font-size="9.5" font-weight="700" fill="#065f46">• 东亚三角贸易枢纽转化：</text>
      <text x="12" y="118" font-size="9" fill="#334155">吸纳日韩东盟零部件在华组装，东亚对美总顺差高度集中由中国体现</text>
    </g>
  </g>

  <!-- 中层二：美财政部自设“汇率操纵”三项量化指标核验看板 -->
  <g transform="translate(20, 234)">
    <rect width="760" height="106" rx="8" fill="#fffbeb" stroke="#d97706" stroke-width="1.2"/>
    <path d="M0,8 Q0,0 8,0 L752,0 Q760,0 760,8 L760,25 L0,25 Z" fill="#b45309"/>
    <text x="380" y="17" font-size="11" font-weight="700" fill="#ffffff" text-anchor="middle">📋 美财政部自设“汇率操纵”三项量化指标核验（法理与实证均站不住脚）</text>

    <!-- 三指标对比卡 -->
    <g transform="translate(10, 31)">
      <!-- 指标 1 -->
      <rect x="0" y="0" width="240" height="46" rx="6" fill="#ffffff" stroke="#fde68a" stroke-width="1"/>
      <text x="10" y="16" font-size="10" font-weight="700" fill="#1e293b">1. 对美商品贸易顺差 &gt; 200亿美元</text>
      <rect x="180" y="4" width="50" height="16" rx="4" fill="#fef3c7"/>
      <text x="205" y="16" font-size="9" font-weight="700" fill="#b45309" text-anchor="middle">【符合】</text>
      <text x="10" y="32" font-size="8.8" fill="#64748b">国际分工与转口贸易必然，非汇率操纵</text>

      <!-- 指标 2 -->
      <rect x="250" y="0" width="240" height="46" rx="6" fill="#ffffff" stroke="#fca5a5" stroke-width="1"/>
      <text x="260" y="16" font-size="10" font-weight="700" fill="#1e293b">2. 经常账户盈余 &gt; GDP 3%</text>
      <rect x="420" y="4" width="60" height="16" rx="4" fill="#fee2e2"/>
      <text x="450" y="16" font-size="9" font-weight="700" fill="#dc2626" text-anchor="middle">【❌ 不符合】</text>
      <text x="260" y="32" font-size="8.8" fill="#64748b">中国长期在 1.5%–2% 国际公认合理区间</text>

      <!-- 指标 3 -->
      <rect x="500" y="0" width="240" height="46" rx="6" fill="#ffffff" stroke="#fca5a5" stroke-width="1"/>
      <text x="510" y="16" font-size="10" font-weight="700" fill="#1e293b">3. 持续单向干预外汇市场</text>
      <rect x="670" y="4" width="60" height="16" rx="4" fill="#fee2e2"/>
      <text x="700" y="16" font-size="9" font-weight="700" fill="#dc2626" text-anchor="middle">【❌ 完全相反】</text>
      <text x="510" y="32" font-size="8.8" fill="#64748b">央行曾动用万亿外储逆向抛售“防贬值”</text>
    </g>

    <!-- 底部政经实证结论条 -->
    <rect x="10" y="81" width="740" height="19" rx="4" fill="#fef2f2" stroke="#fecaca" stroke-width="0.8"/>
    <text x="380" y="94" font-size="9.5" font-weight="700" fill="#991b1b" text-anchor="middle">⚠️ 政治博弈铁证：美于 2019.8 经贸摩擦白热化时违规强扣“操纵国”帽子 ➔ 2020.1 签署一阶段协议即刻撤销 ➔ 坐实纯属对华施压工具</text>
  </g>

  <!-- 第三层：三方政治经济时代价全景剖析矩阵 -->
  <g transform="translate(20, 348)">
    <rect width="760" height="168" rx="8" fill="#ffffff" stroke="#94a3b8" stroke-width="1.2"/>
    <path d="M0,8 Q0,0 8,0 L752,0 Q760,0 760,8 L760,25 L0,25 Z" fill="#334155"/>
    <text x="380" y="17" font-size="11" font-weight="700" fill="#ffffff" text-anchor="middle">💥 汇率问题政治化的三方代价全景矩阵（政治经济学视角：谁在为非理性博弈买单？）</text>

    <!-- 列 1: 对中方 -->
    <g transform="translate(10, 30)">
      <rect width="236" height="130" rx="6" fill="#eff6ff" stroke="#93c5fd" stroke-width="1"/>
      <rect width="236" height="20" rx="4" fill="#dbeafe"/>
      <text x="118" y="14" font-size="10" font-weight="700" fill="#1e40af" text-anchor="middle">🇨🇳 对中方之代价（主权与转型阵痛）</text>
      
      <text x="8" y="34" font-size="9.2" font-weight="700" fill="#1e3a8a">• 政策自主性受扰：</text>
      <text x="8" y="47" font-size="8.8" fill="#334155">汇率沦为外部长臂管辖目标，干扰自主汇改节奏</text>
      
      <text x="8" y="65" font-size="9.2" font-weight="700" fill="#1e3a8a">• 出口部门与就业承压：</text>
      <text x="8" y="78" font-size="8.8" fill="#334155">若被迫快速非理性升值，将严重挤压外贸中小企业，造成就业短期震荡</text>
      
      <text x="8" y="96" font-size="9.2" font-weight="700" fill="#1e3a8a">• 外储风险与福利外溢：</text>
      <text x="8" y="109" font-size="8.8" fill="#334155">巨额外储沉淀于低收益美债，遭受美元通胀贬值、购买力缩水与资产安全风险</text>
    </g>

    <!-- 列 2: 对美方 -->
    <g transform="translate(262, 30)">
      <rect width="236" height="130" rx="6" fill="#fef2f2" stroke="#fca5a5" stroke-width="1"/>
      <rect width="236" height="20" rx="4" fill="#fee2e2"/>
      <text x="118" y="14" font-size="10" font-weight="700" fill="#b91c1c" text-anchor="middle">🇺🇸 对美方之代价（结构反噬与民粹）</text>
      
      <text x="8" y="34" font-size="9.2" font-weight="700" fill="#991b1b">• 掩盖病灶、延误结构改革：</text>
      <text x="8" y="47" font-size="8.8" fill="#334155">“替罪羊政治”转移焦点，掩盖财政赤字与低储蓄顽疾，丧失改革契机</text>
      
      <text x="8" y="65" font-size="9.2" font-weight="700" fill="#991b1b">• 通胀反噬与消费者买单：</text>
      <text x="8" y="78" font-size="8.8" fill="#334155">施压升值与关税壁垒直接转嫁给美国本土消费者，抬升生活成本与通胀中枢</text>
      
      <text x="8" y="96" font-size="9.2" font-weight="700" fill="#991b1b">• 制造空心化与政治撕裂：</text>
      <text x="8" y="109" font-size="8.8" fill="#334155">未能挽回铁锈带制造业流失，蓝领阶层相对贫困化加剧，激化国内政治极化</text>
    </g>

    <!-- 列 3: 对全球 -->
    <g transform="translate(514, 30)">
      <rect width="236" height="130" rx="6" fill="#f5f3ff" stroke="#d8b4fe" stroke-width="1"/>
      <rect width="236" height="20" rx="4" fill="#ede9fe"/>
      <text x="118" y="14" font-size="10" font-weight="700" fill="#6d28d9" text-anchor="middle">🌐 对全球之代价（多边倒退与动荡）</text>
      
      <text x="8" y="34" font-size="9.2" font-weight="700" fill="#581c87">• 破坏多边贸易与金融秩序：</text>
      <text x="8" y="47" font-size="8.8" fill="#334155">单边主义霸凌践踏 WTO/IMF 规则体系与多边协调机制公信力</text>
      
      <text x="8" y="65" font-size="9.2" font-weight="700" fill="#581c87">• 诱发全球竞争性货币博弈：</text>
      <text x="8" y="78" font-size="8.8" fill="#334155">大国汇率争端引发贸易保护主义蔓延与竞争性贬值恐慌，加剧去全球化</text>
      
      <text x="8" y="96" font-size="9.2" font-weight="700" fill="#581c87">• 跨境资本与金融体系动荡：</text>
      <text x="8" y="109" font-size="8.8" fill="#334155">汇率预期紊乱导致跨境热钱大进大出，推高新兴市场汇率风险与债务脆弱性</text>
    </g>
  </g>

  <!-- 底部考场作答核心金句 -->
  <g transform="translate(20, 524)">
    <rect width="760" height="28" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1"/>
    <text x="380" y="18" font-size="10.5" font-weight="700" fill="#0f172a" text-anchor="middle">🎯 考场破题金句：中美贸易顺差是“宏观储蓄-投资失衡”的必然映射，指责汇率操纵是政治借口，唯有各自深化结构性改革方能破局</text>
  </g>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">
图：<b>人民币汇率操纵辨析 · 中美顺差结构根源与三方代价矩阵</b>（两国内生结构对比 · 美三指标核验 · 中美全球三方时代代价剖析）。
</figcaption>
</figure>
</div>
...
<figure style="margin:12px 0;padding:8px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 680 380" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="人民币汇率2012年前后两段对比：之前被低估抗拒升值服务出口导向，之后拒绝贬值走向均衡略高估服务财富增长，伴随治国理念三大变迁">
  <defs>
    <marker id="arr2012" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#854F0B"/>
    </marker>
  </defs>
  <text x="340" y="26" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">⚖️ 人民币汇率两段对比 · 2012 年前后</text>
  <text x="340" y="44" text-anchor="middle" font-size="12" fill="var(--text-muted)">汇率水平差异 + 治国理念从"生存逻辑"到"发展·共富逻辑"的跃迁</text>
  <rect x="30" y="64" width="290" height="32" rx="6" fill="rgba(95,94,90,0.12)" stroke="#5F5E5A" stroke-width="0.7"/>
  <text x="175" y="80" text-anchor="middle" font-size="13" font-weight="700" fill="#444441" dominant-baseline="central">2012 之前 · "被低估"</text>
  <rect x="30" y="104" width="290" height="74" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="126" font-size="11.5" font-weight="700" fill="var(--text-main)">政策"抗拒升值"</text>
  ...
  <line x1="325" y1="141" x2="353" y2="141" stroke="#854F0B" stroke-width="1.6" marker-end="url(#arr2012)"/>
  <text x="339" y="172" text-anchor="middle" font-size="10" font-weight="700" fill="var(--text-muted)">生存逻辑</text>
  <text x="339" y="186" text-anchor="middle" font-size="10" font-weight="700" fill="var(--text-muted)">→ 发展·共富</text>
  <rect x="360" y="64" width="290" height="32" rx="6" fill="rgba(15,110,86,0.12)" stroke="#0F6E56" stroke-width="0.7"/>
  <text x="505" y="80" text-anchor="middle" font-size="13" font-weight="700" fill="#085041" dominant-baseline="central">2012 之后 · "均衡甚至略高估"</text>
  <rect x="360" y="104" width="290" height="74" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="126" font-size="11.5" font-weight="700" fill="var(--text-main)">政策"拒绝贬值"</text>
  ...
  <rect x="30" y="232" width="210" height="34" rx="8" fill="rgba(95,94,90,0.08)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="135" y="249" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)" dominant-baseline="central">① 从"保就业"</text>
  <line x1="245" y1="249" x2="285" y2="249" stroke="#854F0B" stroke-width="1.4" marker-end="url(#arr2012)"/>
  <rect x="290" y="232" width="360" height="34" rx="8" fill="rgba(15,110,86,0.10)" stroke="#0F6E56" stroke-width="0.6"/>
  <text x="470" y="249" text-anchor="middle" font-size="11" font-weight="700" fill="#085041" dominant-baseline="central">到"提收入" · 升值＝提升人均GDP／2035共富关键杠杆</text>
  <rect x="30" y="276" width="210" height="34" rx="8" fill="rgba(95,94,90,0.08)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="135" y="293" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)" dominant-baseline="central">② 从"世界工厂"</text>
  <line x1="245" y1="293" x2="285" y2="293" stroke="#854F0B" stroke-width="1.4" marker-end="url(#arr2012)"/>
  <rect x="290" y="276" width="360" height="34" rx="8" fill="rgba(15,110,86,0.10)" stroke="#0F6E56" stroke-width="0.6"/>
  <text x="470" y="293" text-anchor="middle" font-size="11" font-weight="700" fill="#085041" dominant-baseline="central">到"强大市场" · 内需+创新能力构建新优势</text>
  <rect x="30" y="320" width="210" height="34" rx="8" fill="rgba(95,94,90,0.08)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="135" y="337" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)" dominant-baseline="central">③ 从"注重积累"</text>
  <line x1="245" y1="337" x2="285" y2="337" stroke="#854F0B" stroke-width="1.4" marker-end="url(#arr2012)"/>
  <rect x="290" y="320" width="360" height="34" rx="8" fill="rgba(15,110,86,0.10)" stroke="#0F6E56" stroke-width="0.6"/>
  <text x="470" y="337" text-anchor="middle" font-size="11" font-weight="700" fill="#085041" dominant-baseline="central">到"关注民生" · 升值增强国民国际购买力</text>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">图：2012 年前"低估保就业"，2012 年后"拒贬提收入"——底层是<b>治国理念从"生存逻辑"向"发展·共富逻辑"</b>的跃迁，三大变迁一一对应。</figcaption>
</figure>
...
<figure style="margin:12px 0;padding:12px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 680 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="固定汇率与浮动汇率优缺点四象限对照：左列固定汇率、右列浮动汇率，上行优点、下行缺点，中间转型四大挑战">
  <!-- 标题 -->
...
<figure style="margin:0;">
<svg viewBox="0 0 780 290" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:system-ui,-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;" role="img" aria-label="贸易渠道套利三种手法对照：发票造假伪造价格、预收延付伪造时间、转口虚假交割伪造真实性；共同本质是用经常账户贸易外壳掩盖资本账户套利内核">
  <defs>
  ...
  <!-- 顶部小引导标 -->
  <text x="390" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#1e293b">🧾 贸易渠道套利三手法 · 核心维度与操作对照</text>
  <text x="390" y="38" text-anchor="middle" font-size="10.5" fill="#64748b">突破资本管制的经典漏洞：“贸易外壳 + 资本内核”，三手法分别伪造“价、时、真”</text>

  <!-- 卡片1：发票造假 -->
  <g transform="translate(20, 50)" filter="url(#boxShadow)">
    <rect x="0" y="0" width="236" height="184" rx="9" fill="#fffbeb" stroke="#fcd34d" stroke-width="1.2"/>
    <rect x="0" y="0" width="236" height="32" rx="9 9 0 0" fill="#fef3c7"/>
    <text x="118" y="21" text-anchor="middle" font-size="12.5" font-weight="700" fill="#92400e">① 发票造假</text>
    
    <!-- 伪造维度徽章 -->
    <rect x="18" y="42" width="200" height="24" rx="4" fill="#fef3c7" stroke="#f59e0b" stroke-width="0.8"/>
    <text x="118" y="58" text-anchor="middle" font-size="11" fill="#78350f">伪造维度：<tspan font-weight="700" fill="#b45309">价格 (Price)</tspan></text>

    <!-- 操作手法 -->
    <text x="24" y="86" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e293b">核心操作</tspan>：高报出口 / 低报进口</text>
    <text x="24" y="105" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e293b">资金流向</tspan>：境内多收汇 / 少付汇</text>
    <text x="24" y="124" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#b91c1c">套利诉求</tspan>：境内高息 + 人民币升值</text>
    <text x="24" y="143" font-size="10" fill="#64748b">• <tspan font-weight="600">经典案例</tspan>：100万美元货物报成150万</text>
    
    <!-- 底部标签 -->
    <rect x="18" y="154" width="200" height="18" rx="3" fill="#fef3c7"/>
    <text x="118" y="167" text-anchor="middle" font-size="9" font-weight="600" fill="#b45309">虚增顺差 · 央行被迫被动结汇</text>
  </g>

  <!-- 卡片2：预收延付 -->
  <g transform="translate(272, 50)" filter="url(#boxShadow)">
    <rect x="0" y="0" width="236" height="184" rx="9" fill="#eff6ff" stroke="#bfdbfe" stroke-width="1.2"/>
    <rect x="0" y="0" width="236" height="32" rx="9 9 0 0" fill="#dbeafe"/>
    <text x="118" y="21" text-anchor="middle" font-size="12.5" font-weight="700" fill="#1e40af">② 预收延付</text>
    
    <!-- 伪造维度徽章 -->
    <rect x="18" y="42" width="200" height="24" rx="4" fill="#dbeafe" stroke="#3b82f6" stroke-width="0.8"/>
    <text x="118" y="58" text-anchor="middle" font-size="11" fill="#1e3a8a">伪造维度：<tspan font-weight="700" fill="#1d4ed8">时间 (Timing)</tspan></text>

    <!-- 操作手法 -->
    <text x="24" y="86" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e293b">核心操作</tspan>：预收货款 / 延迟付款</text>
    <text x="24" y="105" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e293b">资金流向</tspan>：提前收汇入境内、拖后付汇</text>
    <text x="24" y="124" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#b91c1c">套利诉求</tspan>：打时间差吃境内外利差</text>
    <text x="24" y="143" font-size="10" fill="#64748b">• <tspan font-weight="600">经典案例</tspan>：跨国关联企业账期人为操纵</text>

    <!-- 底部标签 -->
    <rect x="18" y="154" width="200" height="18" rx="3" fill="#dbeafe"/>
    <text x="118" y="167" text-anchor="middle" font-size="9" font-weight="600" fill="#1e40af">贸易信贷包装 · 热钱快进快出</text>
  </g>

  <!-- 卡片3：转口虚假交割 -->
  <g transform="translate(524, 50)" filter="url(#boxShadow)">
    <rect x="0" y="0" width="236" height="184" rx="9" fill="#faf5ff" stroke="#e9d5ff" stroke-width="1.2"/>
    <rect x="0" y="0" width="236" height="32" rx="9 9 0 0" fill="#f3e8ff"/>
    <text x="118" y="21" text-anchor="middle" font-size="12.5" font-weight="700" fill="#6b21a8">③ 转口虚假交割</text>
    
    <!-- 伪造维度徽章 -->
    <rect x="18" y="42" width="200" height="24" rx="4" fill="#f3e8ff" stroke="#a855f7" stroke-width="0.8"/>
    <text x="118" y="58" text-anchor="middle" font-size="11" fill="#581c87">伪造维度：<tspan font-weight="700" fill="#7e22ce">真实性 (Authenticity)</tspan></text>

    <!-- 操作手法 -->
    <text x="24" y="86" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e293b">核心操作</tspan>：保税区转口 / 仓单质押流转</text>
    <text x="24" y="105" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#1e293b">资金流向</tspan>：同一批贵金属/集成电路空转</text>
    <text x="24" y="124" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#b91c1c">套利诉求</tspan>：跨境循环开立信用证套现套利</text>
    <text x="24" y="143" font-size="10" fill="#64748b">• <tspan font-weight="600">经典案例</tspan>：内地-香港异常高额贵金属贸易</text>

    <!-- 底部标签 -->
    <rect x="18" y="154" width="200" height="18" rx="3" fill="#f3e8ff"/>
    <text x="118" y="167" text-anchor="middle" font-size="9" font-weight="600" fill="#6b21a8">货不动钱空转 · 放大外汇储备虚火</text>
  </g>

  <!-- 底部共性提炼栏 -->
  <g transform="translate(20, 246)">
    <rect x="0" y="0" width="740" height="34" rx="6" fill="#fef2f2" stroke="#fca5a5" stroke-width="1"/>
    <text x="370" y="15" text-anchor="middle" font-size="11" font-weight="700" fill="#991b1b">💡 共同本质：利用经常账户必须开放的制度特征，把资本账户跨境套利资金伪装为贸易款项，规避外汇管制</text>
    <text x="370" y="28" text-anchor="middle" font-size="9.5" fill="#64748b">翟东升撕开点：套利根源不在“微观不守规矩”，而在汇率单边升值预期；治本之道是让汇率双向波动消除无风险套利空间（811汇改动因）</text>
  </g>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">
...
**货币金融学公开课第一讲：货币的本质：从金本位制到信用货币**
- 内容：详细讲解金本位制度的历史演变、运行机制
- 👉 [点击观看](https://www.bilibili.com/video/BV1K24y1Q7mW/)
> *必背 · 5题*
...
.gold-anim .gcurve { }
.gold-anim .glbl { }
.gold-anim .ganim-replay {
  margin-left: 10px; font-size: 0.72rem; font-weight: 600; cursor: pointer;
  border: 1px solid var(--border); border-radius: 6px; padding: 2px 8px;
  background: var(--card-bg); color: var(--primary); font-family: inherit;
}
.gold-anim .ganim-replay:hover { background: var(--primary); color: #fff; }
/* JS初始化前曲线完全显示(优雅降级); 初始化时JS给.gcurve加隐藏态再draw-on */
@media (prefers-reduced-motion: reduce) {
  .gold-anim .gcurve { stroke-dashoffset: 0 !important; }
  .gold-anim .glbl { opacity: 1 !important; }
}
</style>
...
<rect x="80" y="169" width="640" height="52" fill="#a855f7" fill-opacity="0.05"/>
  ...
  <path class="gcurve c-money" data-len="677" d="M 80.0 195.0 L 102.9 195.0 L 125.7 195.0 L 148.6 195.0 L 171.4 202.9 L 194.3 215.1 L 217.1 226.9 L 240.0 238.3 L 262.9 248.8 L 285.7 258.5 L 308.6 267.1 L 331.4 274.4 L 354.3 280.4 L 377.1 285.0 L 400.0 288.0 L 422.9 289.5 L 445.7 289.3 L 468.6 287.5 L 491.4 284.2 L 514.3 279.4 L 537.1 273.1 L 560.0 265.5 L 582.9 256.6 L 605.7 246.8 L 628.6 236.0 L 651.4 224.6 L 674.3 212.7 L 697.1 200.4 L 720.0 195.0" fill="none" stroke="#6366f1" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
  <path class="gcurve c-price" data-len="660" d="M 80.0 195.0 L 102.9 195.0 L 125.7 195.0 L 148.6 195.0 L 171.4 195.0 L 194.3 195.0 L 217.1 195.0 L 240.0 197.7 L 262.9 207.5 L 285.7 216.9 L 308.6 225.8 L 331.4 234.0 L 354.3 241.3 L 377.1 247.5 L 400.0 252.4 L 422.9 256.0 L 445.7 258.1 L 468.6 258.8 L 491.4 258.0 L 514.3 255.6 L 537.1 251.9 L 560.0 246.8 L 582.9 240.5 L 605.7 233.1 L 628.6 224.8 L 651.4 215.8 L 674.3 206.3 L 697.1 196.6 L 720.0 195.0" fill="none" stroke="#16a34a" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"/>
  <path class="gcurve c-fx"    data-len="650" d="M 80.0 221.4 L 100.0 218.9 L 120.0 214.0 L 140.0 207.5 L 160.0 200.2 L 180.0 192.9 L 200.0 186.5 L 220.0 181.5 L 240.0 178.4 L 260.0 177.4 L 280.0 178.3 L 300.0 180.9 L 320.0 184.9 L 340.0 189.6 L 360.0 194.4 L 380.0 199.0 L 400.0 202.7 L 420.0 205.3 L 440.0 206.6 L 460.0 206.5 L 480.0 205.2 L 500.0 202.9 L 520.0 199.9 L 540.0 196.7 L 560.0 193.6 L 580.0 190.8 L 600.0 188.8 L 620.0 187.6 L 640.0 187.3 L 660.0 187.8 L 680.0 189.1 L 700.0 190.9 L 720.0 193.0"    fill="none" stroke="#a855f7" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" opacity="0.85"/>
  <circle cx="106" cy="195" r="3.5" fill="#dc2626"/>
...
## <a id="人民币国际化"></a>人民币国际化


### 📺 B站视频推荐

**翟东升《人民币汇率与人民币国际化》课程**
- 内容：课程专门讲解人民币国际化进程、挑战与前景
- 👉 [点击观看](https://www.bilibili.com/video/BV1Ar4y167k7/)
> *必背 · 4题*
...
<figure style="margin:0;">
<svg viewBox="0 0 800 520" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:800px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="人民币国际化全景图：上半区六步走策略推进路径（贸·商·路·换·数·避），下半区战略机遇期双重对照（美元信用自毁 vs 人民币窗口打开）">
  <defs>
    <marker id="rmbArrBlue" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#2563eb"/>
    </marker>
    <marker id="rmbArrGreen" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#16a34a"/>
    </marker>
  </defs>

  <!-- 顶部标题区 -->
  <text x="400" y="24" text-anchor="middle" font-size="16" font-weight="700" fill="var(--text-main)">🪙 人民币国际化 · 策略六步走路径 ➜ 战略机遇期双重对照</text>
  <text x="400" y="44" text-anchor="middle" font-size="11.5" fill="var(--text-muted)">功能补齐链（由易到难·不求单极霸权） ✖ 外部催化窗口（对手自毁信用·顺应多极化）</text>

  <!-- ================= 第一部分：策略与步骤（六步功能链） ================= -->
  <rect x="20" y="58" width="760" height="22" rx="4" fill="rgba(99,102,241,0.08)" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="30" y="73" font-size="11.5" font-weight="700" fill="var(--primary)">一、策略与步骤：按"由易到难、由浅到深"推进六步走（功能补齐链）</text>

  <!-- 六个递进卡片 -->
  <!-- 1. 贸 -->
  <rect x="20" y="86" width="118" height="96" rx="6" fill="#eff6ff" stroke="#3b82f6" stroke-width="1"/>
  <rect x="20" y="86" width="118" height="22" rx="6 6 0 0" fill="#dbeafe"/>
  <text x="79" y="101" text-anchor="middle" font-size="11" font-weight="700" fill="#1e40af">1. 贸 (贸易结算)</text>
  <text x="26" y="122" font-size="9.5" fill="#334155">• 跨境贸易本币结算</text>
  <text x="26" y="138" font-size="9.5" fill="#334155">• 不动资本账户</text>
  <text x="26" y="154" font-size="9.5" fill="#334155">• 风险最低 · 是地基</text>
  <rect x="24" y="162" width="110" height="15" rx="3" fill="#bfdbfe"/>
  <text x="79" y="173" text-anchor="middle" font-size="8.5" font-weight="600" fill="#1e40af">计价与结算功能</text>

  <line x1="140" y1="134" x2="147" y2="134" stroke="#2563eb" stroke-width="1.5" marker-end="url(#rmbArrBlue)"/>

  <!-- 2. 商 -->
  <rect x="148" y="86" width="118" height="96" rx="6" fill="#eff6ff" stroke="#3b82f6" stroke-width="1"/>
  <rect x="148" y="86" width="118" height="22" rx="6 6 0 0" fill="#dbeafe"/>
  <text x="207" y="101" text-anchor="middle" font-size="11" font-weight="700" fill="#1e40af">2. 商 (大宗计价)</text>
  <text x="154" y="122" font-size="9.5" fill="#334155">• 最大买方规模优势</text>
  <text x="154" y="138" font-size="9.5" fill="#334155">• 原油/铁矿石期货</text>
  <text x="154" y="154" font-size="9.5" fill="#334155">• 集中度转定价权</text>
  <rect x="152" y="162" width="110" height="15" rx="3" fill="#bfdbfe"/>
  <text x="207" y="173" text-anchor="middle" font-size="8.5" font-weight="600" fill="#1e40af">争夺国际定价权</text>

  <line x1="268" y1="134" x2="275" y2="134" stroke="#2563eb" stroke-width="1.5" marker-end="url(#rmbArrBlue)"/>

  <!-- 3. 路 -->
  <rect x="276" y="86" width="118" height="96" rx="6" fill="#eef2ff" stroke="#6366f1" stroke-width="1"/>
  <rect x="276" y="86" width="118" height="22" rx="6 6 0 0" fill="#e0e7ff"/>
  <text x="335" y="101" text-anchor="middle" font-size="11" font-weight="700" fill="#3730a3">3. 路 (一带一路)</text>
  <text x="282" y="122" font-size="9.5" fill="#334155">• 沿线基建投融资</text>
  <text x="282" y="138" font-size="9.5" fill="#334155">• 贷出去、花回来</text>
  <text x="282" y="154" font-size="9.5" fill="#334155">• 境外真实闭环场景</text>
  <rect x="280" y="162" width="110" height="15" rx="3" fill="#c7d2fe"/>
  <text x="335" y="173" text-anchor="middle" font-size="8.5" font-weight="600" fill="#3730a3">资本输出与回流</text>

  <line x1="396" y1="134" x2="403" y2="134" stroke="#2563eb" stroke-width="1.5" marker-end="url(#rmbArrBlue)"/>

  <!-- 4. 换 -->
  <rect x="404" y="86" width="118" height="96" rx="6" fill="#eef2ff" stroke="#6366f1" stroke-width="1"/>
  <rect x="404" y="86" width="118" height="22" rx="6 6 0 0" fill="#e0e7ff"/>
  <text x="463" y="101" text-anchor="middle" font-size="11" font-weight="700" fill="#3730a3">4. 换 (货币互换)</text>
  <text x="410" y="122" font-size="9.5" fill="#334155">• 40+央行互换协议</text>
  <text x="410" y="138" font-size="9.5" fill="#334155">• 境外流动性支持</text>
  <text x="410" y="154" font-size="9.5" fill="#334155">• 脱离美元清算网</text>
  <rect x="408" y="162" width="110" height="15" rx="3" fill="#c7d2fe"/>
  <text x="463" y="173" text-anchor="middle" font-size="8.5" font-weight="600" fill="#3730a3">清算基建与流动性</text>

  <line x1="524" y1="134" x2="531" y2="134" stroke="#2563eb" stroke-width="1.5" marker-end="url(#rmbArrBlue)"/>

  <!-- 5. 数 -->
  <rect x="532" y="86" width="118" height="96" rx="6" fill="#f0fdf4" stroke="#16a34a" stroke-width="1"/>
  <rect x="532" y="86" width="118" height="22" rx="6 6 0 0" fill="#dcfce7"/>
  <text x="591" y="101" text-anchor="middle" font-size="11" font-weight="700" fill="#14532d">5. 数 (数字货币)</text>
  <text x="538" y="122" font-size="9.5" fill="#334155">• e-CNY + CIPS</text>
  <text x="538" y="138" font-size="9.5" fill="#334155">• 技术性绕开SWIFT</text>
  <text x="538" y="154" font-size="9.5" fill="#334155">• 独立支付新通道</text>
  <rect x="536" y="162" width="110" height="15" rx="3" fill="#bbf7d0"/>
  <text x="591" y="173" text-anchor="middle" font-size="8.5" font-weight="600" fill="#14532d">技术绕越SWIFT</text>

  <line x1="652" y1="134" x2="659" y2="134" stroke="#16a34a" stroke-width="1.5" marker-end="url(#rmbArrGreen)"/>

  <!-- 6. 避 -->
  <rect x="660" y="86" width="120" height="96" rx="6" fill="#f0fdf4" stroke="#16a34a" stroke-width="1"/>
  <rect x="660" y="86" width="120" height="22" rx="6 6 0 0" fill="#dcfce7"/>
  <text x="720" y="101" text-anchor="middle" font-size="11" font-weight="700" fill="#14532d">6. 避 (储备避险)</text>
  <text x="666" y="122" font-size="9.5" fill="#334155">• 各国央行主动储备</text>
  <text x="666" y="138" font-size="9.5" fill="#334155">• 承认主权信用</text>
  <text x="666" y="154" font-size="9.5" fill="#334155">• 跻身多极格局一极</text>
  <rect x="664" y="162" width="112" height="15" rx="3" fill="#bbf7d0"/>
  <text x="720" y="173" text-anchor="middle" font-size="8.5" font-weight="600" fill="#14532d">终极国际储备货币</text>

  <!-- 递进注记 -->
  <rect x="20" y="188" width="760" height="20" rx="3" fill="var(--code-bg)" stroke="var(--border)"/>
  <text x="400" y="202" text-anchor="middle" font-size="10" fill="var(--text-muted)">递进逻辑：贸易起步（低风险不碰资本账户） ➔ 实体与清算网铺开 ➔ 数字货币技术突围 ➔ 终极储备资产</text>

  <!-- ================= 第二部分：战略机遇期双重对照 ================= -->
  <rect x="20" y="216" width="760" height="22" rx="4" fill="rgba(245,158,11,0.10)" stroke="#d97706" stroke-width="0.8"/>
  <text x="30" y="231" font-size="11.5" font-weight="700" fill="#92400e">二、当下战略机遇期特征：外部对手自毁信用（催化剂） ✖ 内部贸易基本盘（硬支撑）</text>

  <!-- 左侧：美元信用自毁 -->
  <rect x="20" y="244" width="362" height="208" rx="8" fill="#fee2e2" stroke="#dc2626" stroke-width="1.2" opacity="0.85"/>
  <rect x="20" y="244" width="362" height="28" rx="8 8 0 0" fill="#fecaca"/>
  <text x="201" y="263" text-anchor="middle" font-size="13" font-weight="700" fill="#7f1d1d">🔻 美元信用"自毁"下行（外部催化剂）</text>

  <text x="34" y="292" font-size="11.5" font-weight="700" fill="#991b1b">① 制裁武器化</text>
  <text x="44" y="308" font-size="10" fill="#475569">俄乌冲突冻结俄央行外储 · SWIFT 沦为地缘打压工具</text>

  <text x="34" y="332" font-size="11.5" font-weight="700" fill="#991b1b">② 中立性神话破灭</text>
  <text x="44" y="348" font-size="10" fill="#475569">"美元是安全中立资产"叙事坍塌，主权资产安全受疑</text>

  <text x="34" y="372" font-size="11.5" font-weight="700" fill="#991b1b">③ 财政赤字货币化与通胀</text>
  <text x="44" y="388" font-size="10" fill="#475569">无限 QE 滥发 · 债务激增稀释美债实际购买力与信誉</text>

  <text x="34" y="412" font-size="11.5" font-weight="700" fill="#991b1b">④ 滥用"过度特权"</text>
  <text x="44" y="428" font-size="10" fill="#475569">长期双赤字收割全球流动性 · 国际社会对美元信任透支</text>

  <!-- 中间转换桥梁 -->
  <rect x="388" y="322" width="24" height="52" rx="4" fill="#fef3c7" stroke="#d97706" stroke-width="0.8"/>
  <text x="400" y="342" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">彼</text>
  <text x="400" y="356" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">落</text>
  <text x="400" y="369" text-anchor="middle" font-size="12" font-weight="700" fill="#16a34a">→</text>

  <!-- 右侧：人民币窗口 -->
  <rect x="418" y="244" width="362" height="208" rx="8" fill="#dcfce7" stroke="#16a34a" stroke-width="1.2" opacity="0.85"/>
  <rect x="418" y="244" width="362" height="28" rx="8 8 0 0" fill="#bbf7d0"/>
  <text x="599" y="263" text-anchor="middle" font-size="13" font-weight="700" fill="#14532d">🟢 人民币窗口"被动打开"（内部基本盘）</text>

  <text x="432" y="292" font-size="11.5" font-weight="700" fill="#166534">① 全球南方去美元化真实诉求</text>
  <text x="442" y="308" font-size="10" fill="#475569">规避汇率收割与制裁封锁，寻求中立稳定结算货币</text>

  <text x="432" y="332" font-size="11.5" font-weight="700" fill="#166534">② 中国贸易基本盘坚实支撑</text>
  <text x="442" y="348" font-size="10" fill="#475569">140+ 国主要贸易伙伴 · 最大货物贸易国提供天然场景</text>

  <text x="432" y="372" font-size="11.5" font-weight="700" fill="#166534">③ 数字货币技术弯道超车</text>
  <text x="442" y="388" font-size="10" fill="#475569">e-CNY + CIPS 先发优势，跳过传统美元代理行清算路径</text>

  <text x="432" y="412" font-size="11.5" font-weight="700" fill="#166534">④ 全球储备资产多元化配置</text>
  <text x="442" y="428" font-size="10" fill="#475569">各国央行增持黄金与人民币，自发开展国际资产再平衡</text>

  <!-- ================= 底部核心总结 ================= -->
  <rect x="20" y="460" width="760" height="48" rx="6" fill="#fef3c7" stroke="#d97706" stroke-width="1"/>
  <text x="400" y="480" text-anchor="middle" font-size="11" font-weight="700" fill="#92400e">💡 核心撕开点：不是"中国更强了"，而是"对手自毁信用"——外部赐予的战略窗口，比任何主动出击都更有效</text>
  <text x="400" y="497" text-anchor="middle" font-size="10" fill="#78350f">战略定力：由易到难补齐货币功能；目标不是争夺"下一个单极美元霸权"，而是推动构建多元平衡的国际货币新秩序。</text>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">
图：人民币国际化全景——<b>策略推进六步走</b>（贸·商·路·换·数·避功能补齐链）与<b>当下战略机遇期双重对照</b>（美元信用自毁下行 vs 人民币窗口被动打开）。
</figcaption>
</figure>
</div>
...
<svg viewBox="0 0 680 430" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="日元五病根广压空锁附递进坍塌链与人民币六字立主缓深盘技联反向操作对照，每穴一药映射，底部结论安全依附与货币挑战不可兼得">
  <defs>
    <marker id="arrYen" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#A32D2D"/>
    </marker>
  </defs>
  <text x="340" y="26" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">🔁 日元五病根 → 人民币六对策 · 病理-药方映射</text>
  <text x="340" y="44" text-anchor="middle" font-size="12" fill="var(--text-muted)">五病根是"递进坍塌"因果链 · 六启示是"反向操作"——日本的每个死穴，中国都补上一个对策</text>
  <rect x="30" y="64" width="290" height="30" rx="6" fill="rgba(163,45,45,0.12)" stroke="#A32D2D" stroke-width="0.7"/>
  <text x="175" y="79" text-anchor="middle" font-size="13" font-weight="700" fill="#791F1F" dominant-baseline="central">🇯🇵 日元五病根 · "广压空锁附"</text>
  <rect x="30" y="100" width="290" height="40" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="117" font-size="11" font-weight="700" fill="#A32D2D">广 · 汇率主权丧失（总病根）</text>
  <text x="44" y="132" font-size="10" fill="var(--text-muted)">广场协议逼升值 240→120 · 两年升一倍</text>
  <line x1="175" y1="142" x2="175" y2="146" stroke="#A32D2D" stroke-width="1.4" marker-end="url(#arrYen)"/>
  <rect x="30" y="148" width="290" height="40" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="165" font-size="11" font-weight="700" fill="#A32D2D">压 · 被迫开放资本账户</text>
  <text x="44" y="180" font-size="10" fill="var(--text-muted)">热钱大进大出 · 失去金融节奏控制</text>
  <line x1="175" y1="190" x2="175" y2="194" stroke="#A32D2D" stroke-width="1.4" marker-end="url(#arrYen)"/>
  <rect x="30" y="196" width="290" height="40" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="213" font-size="11" font-weight="700" fill="#A32D2D">空 · 金融市场空洞化</text>
  <text x="44" y="228" font-size="10" fill="var(--text-muted)">无深广资产池 · 国际化"悬空"</text>
  <line x1="175" y1="238" x2="175" y2="242" stroke="#A32D2D" stroke-width="1.4" marker-end="url(#arrYen)"/>
  <rect x="30" y="244" width="290" height="40" rx="8" fill="rgba(163,45,45,0.06)" stroke="#A32D2D" stroke-width="0.7"/>
  <text x="44" y="261" font-size="11" font-weight="700" fill="#A32D2D">锁 · 安全依附美国（死局）</text>
  <text x="44" y="276" font-size="10" fill="var(--text-muted)">驻军+安保同盟 · 不敢挑战美元</text>
  <line x1="175" y1="286" x2="175" y2="290" stroke="#A32D2D" stroke-width="1.4" marker-end="url(#arrYen)"/>
  <rect x="30" y="292" width="290" height="40" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="309" font-size="11" font-weight="700" fill="#A32D2D">附 · 产业萎缩（结果）</text>
  <text x="44" y="324" font-size="10" fill="var(--text-muted)">失去二三十年 · 货币信用反噬</text>
  <text x="175" y="356" text-anchor="middle" font-size="10.5" font-weight="700" fill="#A32D2D">递进坍塌链：外因→结构→结果</text>
  <rect x="360" y="64" width="290" height="30" rx="6" fill="rgba(15,110,86,0.12)" stroke="#0F6E56" stroke-width="0.7"/>
  <text x="505" y="79" text-anchor="middle" font-size="13" font-weight="700" fill="#085041" dominant-baseline="central">🇨🇳 人民币六字立 · "主缓深盘技联"</text>
  <rect x="360" y="100" width="290" height="38" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="117" font-size="11" font-weight="700" fill="#0F6E56">主 · 汇率主权不让</text>
  <text x="374" y="131" font-size="10" fill="var(--text-muted)">拒绝广场协议式逼迫升值</text>
  <rect x="360" y="146" width="290" height="38" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="163" font-size="11" font-weight="700" fill="#0F6E56">缓 · 资本开放缓进</text>
  <text x="374" y="177" font-size="10" fill="var(--text-muted)">审慎渐进 · 防热钱冲击</text>
  <rect x="360" y="192" width="290" height="38" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="209" font-size="11" font-weight="700" fill="#0F6E56">深 · 市场深度优先</text>
  <text x="374" y="223" font-size="10" fill="var(--text-muted)">建深广境内人民币资产市场</text>
  <rect x="360" y="238" width="290" height="38" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="255" font-size="11" font-weight="700" fill="#0F6E56">盘 · 贸易基本盘守住</text>
  ...
  <line x1="322" y1="168" x2="358" y2="165" stroke="#854F0B" stroke-width="1.2" opacity="0.75" marker-end="url(#arrYen)"/>
  <line x1="322" y1="216" x2="358" y2="211" stroke="#854F0B" stroke-width="1.2" opacity="0.75" marker-end="url(#arrYen)"/>
  <line x1="322" y1="264" x2="358" y2="303" stroke="#854F0B" stroke-width="1.2" opacity="0.75" marker-end="url(#arrYen)"/>
  <line x1="322" y1="312" x2="358" y2="349" stroke="#854F0B" stroke-width="1.2" opacity="0.75" marker-end="url(#arrYen)"/>
  <rect x="30" y="378" width="620" height="36" rx="8" fill="rgba(99,102,241,0.08)" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="340" y="396" text-anchor="middle" font-size="12" font-weight="700" fill="var(--text-main)" dominant-baseline="central">安全依附与货币挑战不可兼得 → 日本死于安全依附，中国赢在主权独立</text>
</svg>
...
**硬核科普：布雷顿森林体系是如何运作的？为什么会垮台？**
- 内容：详细解析布雷顿森林体系的建立、运作机制、崩溃原因
- 👉 [点击观看](https://www.bilibili.com/video/BV12e411D79o/)
> *重难点 · 5题*
...
> **3. 三利器：美元的三大霸权工具**——①铸币税（向全球收租）；②美元潮汐（放水—加息周期收割外围）；③SWIFT 制裁（以清算系统为武器）。
...
<figure style="margin:12px 0;padding:12px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 680 360" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="布雷顿森林体系论述主线：三稳建秩序→双困埋炸弹→一冲终崩塌，1971美国主动违约">
  <defs>
    <marker id="arrBws" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="var(--text-muted)"/>
    </marker>
  </defs>
  <!-- 标题 -->
...
<div class="dgm">
<div class="dgm-h">💱 国际货币体系大变迁 · 牙买加特征 · 三层转化动力 · 人民币逆向启示</div>
<figure style="margin:0;">
<svg viewBox="0 0 820 580" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:10px auto;font-family:system-ui,-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;" role="img" aria-label="国际货币体系大变迁全景图：牙买加体系表面无锚实为石油美元与财富转移收割机；布森向牙买加转化三层因果（政治主动违约扳机、结构特里芬困境炸药、黄金仅兑1/4导火索）；人民币国际化逆美元之道的四维启示（大宗商品锚、自主CIPS基础设施、制造业实体底盘、多极治理新秩序）">
  <defs>
    <linearGradient id="gradTopTier" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#f8fafc"/>
      <stop offset="100%" stop-color="#f1f5f9"/>
    </linearGradient>
    <linearGradient id="gradCause" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#fffbeb"/>
      <stop offset="100%" stop-color="#fef3c7"/>
    </linearGradient>
    <linearGradient id="gradRmb" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#f0fdf4"/>
      <stop offset="100%" stop-color="#dcfce7"/>
    </linearGradient>
    <marker id="arrBw" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L7,3 z" fill="#475569"/>
    </marker>
    <filter id="shadowBox" x="-3%" y="-3%" width="106%" height="110%" filterUnits="userSpaceOnUse">
      <feDropShadow dx="0" dy="2" stdDeviation="2.5" flood-opacity="0.05"/>
    </filter>
  </defs>

  <!-- 总体背景板 -->
  <rect x="0" y="0" width="820" height="580" rx="14" fill="#ffffff" stroke="#e2e8f0" stroke-width="1"/>

  <!-- 顶部主标题 -->
  <rect x="0" y="0" width="820" height="56" rx="14" fill="#0f172a"/>
  <rect x="0" y="42" width="820" height="14" fill="#0f172a"/>
  <text x="410" y="26" text-anchor="middle" font-size="16" font-weight="700" fill="#f8fafc">💱 国际货币体系大变迁 · 牙买加特征 · 三层转化动力 · 人民币逆向启示</text>
  <text x="410" y="45" text-anchor="middle" font-size="11.5" fill="#94a3b8">从「虚假无锚的全球财富转移收割机」到「政治主动违约扳机」，再到「逆美元之道的多极化破局」</text>

  <!-- ================= 第一层：现行牙买加体系本质解构（上层，y=66, h=144） ================= -->
  <g transform="translate(18, 66)">
    <!-- 区域外框 -->
    <rect x="0" y="0" width="784" height="142" rx="9" fill="url(#gradTopTier)" stroke="#cbd5e1" stroke-width="1" filter="url(#shadowBox)"/>
    <rect x="0" y="0" width="784" height="28" rx="9" fill="#334155"/>
    <rect x="0" y="18" width="784" height="10" fill="#334155"/>
    <text x="20" y="19" font-size="12.5" font-weight="700" fill="#ffffff">🏛️ 第一层 · 现行牙买加体系的内容与特征：制度表象 vs 权力本质</text>

    <!-- 左半：制度表象（主流教材三特征） -->
    <rect x="10" y="36" width="374" height="96" rx="6" fill="#ffffff" stroke="#e2e8f0" stroke-width="0.8"/>
    <text x="22" y="54" font-size="11.5" font-weight="700" fill="#1e293b">制度表象（主流教材四大内容）</text>
    <text x="22" y="73" font-size="10.5" fill="#334155"><tspan font-weight="700" fill="#2563eb">1. 黄金非货币化</tspan>：黄金退出官方法定货币，退化为普通储备资产</text>
    <text x="22" y="91" font-size="10.5" fill="#334155"><tspan font-weight="700" fill="#2563eb">2. 汇率制度多样化</tspan>：浮动汇率合法化，浮动/盯住/货币局多轨并存</text>
    <text x="22" y="109" font-size="10.5" fill="#334155"><tspan font-weight="700" fill="#2563eb">3. 国际储备多元化</tspan>：美元为主导，欧元/日元/英镑/人民币与SDR并存</text>
    <text x="22" y="124" font-size="9.5" fill="#64748b">主流视角误区：视其为“各国自由选择、无中心自主协调的进步制度”</text>

    <!-- 右半：翟东升撕开点（财富转移本质） -->
    <rect x="394" y="36" width="380" height="96" rx="6" fill="#fff7ed" stroke="#fdba74" stroke-width="0.8"/>
    <text x="406" y="54" font-size="11.5" font-weight="700" fill="#c2410c">翟东升撕开点：以美国利益为轴心的财富转移机制</text>
    <text x="406" y="73" font-size="10.5" fill="#334155"><tspan font-weight="700" fill="#ea580c">★ 隐性真锚（命根子）</tspan>：1973-74美沙协议将美元锚定全球石油能源</text>
    <text x="406" y="91" font-size="10.5" fill="#334155"><tspan font-weight="700" fill="#ea580c">★ 三大战略收割工具</tspan>：铸币税(全球印钞征税) + 潮汐收割 + SWIFT武器化</text>
    <text x="406" y="109" font-size="10.5" fill="#334155"><tspan font-weight="700" fill="#ea580c">★ 体系定性</tspan>：超级嚣张特权下的非对称全球财富转移与吸血架构</text>
    <text x="406" y="124" font-size="9.5" fill="#9a3412">核心论断：“表面无锚浮动是假象，实质是不可兑现的隐性石油美元本位”</text>
  </g>

  <!-- ================= 第二层：布森→牙买加体系转化原因（中层，y=218, h=160） ================= -->
  <g transform="translate(18, 218)">
    <rect x="0" y="0" width="784" height="158" rx="9" fill="url(#gradCause)" stroke="#fcd34d" stroke-width="1" filter="url(#shadowBox)"/>
    <rect x="0" y="0" width="784" height="28" rx="9" fill="#b45309"/>
    <rect x="0" y="18" width="784" height="10" fill="#b45309"/>
    <text x="20" y="19" font-size="12.5" font-weight="700" fill="#ffffff">💥 第二层 · 布雷顿森林向牙买加体系转化的三层次优先级（翟东升核心判定）</text>

    <!-- 卡片1: 政治层（扳机，最重） -->
    <g transform="translate(10, 36)">
      <rect x="0" y="0" width="248" height="112" rx="6" fill="#ffffff" stroke="#fde68a" stroke-width="0.8"/>
      <rect x="8" y="8" width="72" height="18" rx="4" fill="#dc2626"/>
      <text x="44" y="21" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">政治层·扳机</text>
      <text x="86" y="21" font-size="11" font-weight="700" fill="#991b1b">美国主权主动违约</text>
      <text x="10" y="42" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#b91c1c">答题最重权重（决定开不开枪）</tspan></text>
      <text x="10" y="59" font-size="10.5" fill="#334155">• 1971.8.15 尼克松关闭黄金兑换窗口</text>
      <text x="10" y="76" font-size="10.5" fill="#334155">• “守规则代价太高 vs 破规则保霸权”</text>
      <text x="10" y="93" font-size="10.5" fill="#334155">• 美果断选后者，揭示单一主权货币道德风险</text>
      <text x="10" y="106" font-size="9" fill="#64748b">苏珊·斯特兰奇：嚣张特权升级为“超级嚣张特权”</text>
    </g>
    ...
    <g transform="translate(268, 36)">
      ...
      <text x="44" y="21" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">结构层·炸药</text>
      <text x="86" y="21" font-size="11" font-weight="700" fill="#92400e">特里芬困境内在死结</text>
      <text x="10" y="42" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#b45309">数学根本矛盾（决定能不能炸）</tspan></text>
      <text x="10" y="59" font-size="10.5" fill="#334155">• 提供国际清偿力 ➔ 必须长期贸易逆差</text>
      <text x="10" y="76" font-size="10.5" fill="#334155">• 维持美元黄金信誉 ➔ 必须长期贸易顺差</text>
      <text x="10" y="93" font-size="10.5" fill="#334155">• 方向彻底相反、数学上不可调和</text>
      <text x="10" y="106" font-size="9" fill="#64748b">结论：只要选择单一主权货币作世界货币，崩溃注定</text>
    </g>

    <!-- 卡片3: 经济层（导火索，环境） -->
    <g transform="translate(526, 36)">
      <rect x="0" y="0" width="248" height="112" rx="6" fill="#ffffff" stroke="#fde68a" stroke-width="0.8"/>
      <rect x="8" y="8" width="76" height="18" rx="4" fill="#475569"/>
      <text x="46" y="21" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">经济层·导火索</text>
      <text x="90" y="21" font-size="11" font-weight="700" fill="#1e293b">黄金储备挤兑绝境</text>
      <text x="10" y="40" font-size="10.5" fill="#334155">• <tspan font-weight="700" fill="#475569">现实催化事件（决定何时点燃）</tspan></text>
      <text x="10" y="56" font-size="10.5" fill="#334155">• 越战与赤字恶性膨胀导致海外美元超发</text>
      <text x="10" y="72" font-size="10.5" fill="#334155">• 欧日经济崛起，纷纷要求兑现黄金挤兑</text>
      <text x="10" y="88" font-size="10" font-weight="700" fill="#dc2626">• 1971黄金储备(~110亿)仅兑海外美元约1/4</text>
      <text x="10" y="104" font-size="9" fill="#64748b">• 硬事实：守规则在物理上已不可能，唯有违约</text>
    </g>
  </g>

  <!-- ================= 第三层：对人民币国际化启示（下层，y=386, h=146） ================= -->
  <g transform="translate(18, 386)">
    <rect x="0" y="0" width="784" height="144" rx="9" fill="url(#gradRmb)" stroke="#86efac" stroke-width="1" filter="url(#shadowBox)"/>
    <rect x="0" y="0" width="784" height="28" rx="9" fill="#15803d"/>
    <rect x="0" y="18" width="784" height="10" fill="#15803d"/>
    <text x="20" y="19" font-size="12.5" font-weight="700" fill="#ffffff">🇨🇳 第三层 · 对人民币国际化的启示：“美元怎么确立，人民币就逆着走”（反向拆解）</text>

    <!-- 启示1: 锚定大宗商品 -->
    <g transform="translate(10, 36)">
      <rect x="0" y="0" width="182" height="98" rx="6" fill="#ffffff" stroke="#bbf7d0" stroke-width="0.8"/>
      <text x="12" y="20" font-size="11" font-weight="700" fill="#166534">① 锚定实物大宗（破石油锚）</text>
      <text x="12" y="38" font-size="10" fill="#334155">• 美元靠美沙协议锁死石油</text>
      <text x="12" y="55" font-size="10" fill="#15803d">• 人民币推原油/铁矿/锂电计价</text>
      <text x="12" y="72" font-size="10" fill="#334155">• “一揽子大宗商品锚”抗通胀</text>
      <text x="12" y="89" font-size="9.5" fill="#64748b">从纸币信用走向实体硬资源锚</text>
    </g>

    <!-- 启示2: 自主清算系统 -->
    <g transform="translate(202, 36)">
      <rect x="0" y="0" width="182" height="98" rx="6" fill="#ffffff" stroke="#bbf7d0" stroke-width="0.8"/>
      <text x="12" y="20" font-size="11" font-weight="700" fill="#166534">② 自主通道（破SWIFT霸权）</text>
      <text x="12" y="38" font-size="10" fill="#334155">• 美元把CHIPS/SWIFT武器化</text>
      <text x="12" y="55" font-size="10" fill="#15803d">• 中国全力构筑自主CIPS网络</text>
      <text x="12" y="72" font-size="10" fill="#334155">• 研发数字人民币(mBridge桥)</text>
      <text x="12" y="89" font-size="9.5" fill="#64748b">另辟去中心化抗制裁结算走廊</text>
    </g>

    <!-- 启示3: 制造业底盘 -->
    <g transform="translate(394, 36)">
      <rect x="0" y="0" width="182" height="98" rx="6" fill="#ffffff" stroke="#bbf7d0" stroke-width="0.8"/>
      <text x="12" y="20" font-size="11" font-weight="700" fill="#166534">③ 坚守制造底盘（破金融脱实）</text>
      <text x="12" y="38" font-size="10" fill="#334155">• 美元脱实向虚导致制造业空心</text>
      <text x="12" y="55" font-size="10" fill="#15803d">• 人民币终极信用是强大工业产能</text>
      <text x="12" y="72" font-size="10" fill="#334155">• 守住CICE产业链编辑能力</text>
      <text x="12" y="89" font-size="9.5" fill="#64748b">商品供给力才是货币终极购买力</text>
    </g>

    <!-- 启示4: 多极共治愿景 -->
    <g transform="translate(586, 36)">
      <rect x="0" y="0" width="188" height="98" rx="6" fill="#ffffff" stroke="#bbf7d0" stroke-width="0.8"/>
      <text x="12" y="20" font-size="11" font-weight="700" fill="#166534">④ 推动多极格局（破单极特权）</text>
      <text x="12" y="38" font-size="10" fill="#334155">• 目标绝非做“下一个美元霸权”</text>
      <text x="12" y="55" font-size="10" fill="#15803d">• 避免重蹈特里芬困境与过度剥削</text>
      <text x="12" y="72" font-size="10" fill="#334155">• 倡导“一带一路”多边本币互换</text>
      <text x="12" y="89" font-size="9.5" fill="#64748b">构建多元制衡的超主权治理秩序</text>
    </g>
  </g>

  <!-- 底部记忆口诀速记条（y=540, h=30） -->
  <g transform="translate(18, 540)">
    <rect x="0" y="0" width="784" height="28" rx="6" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1"/>
    <text x="392" y="18" text-anchor="middle" font-size="10.5" font-weight="700" fill="#1e293b">💡 答题口诀：牙买加“黄金退·汇率浮·石油真锚收割机”；转化“政治主动违约(扳机)+结构特里芬(炸药)+黄金1/4(导火索)”；启示“锚/网/体/局逆着走”</text>
  </g>
</svg>
<figcaption style="margin-top:6px;font-size:11px;color:var(--text-muted);text-align:center;">
图：<b>国际货币体系大变迁全景图</b>（牙买加体系表象 vs 石油美元隐性真锚与收割机 ➔ 政治主动违约扳机+结构特里芬炸药+黄金1/4导火索 ➔ 人民币国际化四维逆向启示）。
</figcaption>
</figure>
</div>
...
<svg viewBox="0 0 680 430" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="美元潮汐四步收割循环与外围国三重脆弱：放水→吹泡→收水→收割环形闭环，叠加货币错配·资本开放·商品依赖三靶子">
  <defs>
    <marker id="arrTide" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#64748b"/>
    </marker>
    <marker id="arrTideR" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#dc2626"/>
    </marker>
  </defs>
  <!-- 标题 -->
...
## <a id="中心-外围体系"></a>中心-外围体系


### 📺 B站视频推荐

**国际政治经济学-课程介绍-张建新**
- 内容：讲解国际政治经济学基本框架，包括中心-外围体系等核心理论
- 👉 [点击观看](https://www.bilibili.com/video/BV1ff4y1S7U7/)
> *重难点 · 5题*
...
<svg viewBox="0 0 900 560" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:900px;display:block;margin:0 auto;font-family:inherit;background:#f8fafc;border:1px solid #e2e8f0;border-radius:14px;" role="img" aria-label="套叠型中心—外围结构：左侧四层同心圆（美国/准中央/外围工业国/原料国），右侧全球·区域·国内三级俄罗斯套娃自相似嵌套，底部不对称交换劫贫济富">
  <defs>
    <linearGradient id="nest-core" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#ef4444"/>
      <stop offset="100%" stop-color="#991b1b"/>
    </linearGradient>
    <marker id="nest-arrow" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
  ...
  <g transform="translate(30,62)">
    <circle cx="180" cy="190" r="168" fill="#fef3c7" stroke="#d97706" stroke-width="2.2"/>
    <circle cx="180" cy="190" r="128" fill="#fed7aa" stroke="#ea580c" stroke-width="2.2"/>
    <circle cx="180" cy="190" r="88" fill="#fecaca" stroke="#dc2626" stroke-width="2.2"/>
    <circle cx="180" cy="190" r="50" fill="url(#nest-core)" stroke="#7f1d1d" stroke-width="1.8"/>
    <text x="180" y="40" text-anchor="middle" font-size="12" font-weight="700" fill="#854d0e">④ 最外围 · 原料国</text>
    ...
    <path d="M 180 358 L 180 250" fill="none" stroke="#dc2626" stroke-width="1.8" stroke-dasharray="4 3" marker-end="url(#nest-arrow)" opacity="0.75"/>
    <text x="196" y="310" font-size="10" font-weight="700" fill="#b91c1c">财富向心抽吸</text>
  </g>
  <!-- 中间分隔 -->
  <line x1="400" y1="70" x2="400" y2="430" stroke="#cbd5e1" stroke-width="2" stroke-dasharray="4 4"/>
  <rect x="368" y="232" width="64" height="24" rx="10" fill="#f8fafc" stroke="#94a3b8" stroke-width="1"/>
  <text x="400" y="248" text-anchor="middle" font-size="11" font-weight="700" fill="#475569">⟳ 自相似</text>
  <!-- 右侧俄罗斯套娃三级 -->
  <g transform="translate(430,62)">
    <text x="210" y="18" text-anchor="middle" font-size="13.5" font-weight="700" fill="#0f172a">🪆 「套叠」= 自相似嵌套同构</text>
    <text x="210" y="36" text-anchor="middle" font-size="11" fill="#64748b">同一套「中心—外围」逻辑在三种地理尺度上重复</text>
    <g transform="translate(0,52)">
      <circle cx="28" cy="36" r="22" fill="#fef3c7" stroke="#d97706" stroke-width="1.6"/>
      <circle cx="28" cy="36" r="14" fill="#fecaca" stroke="#dc2626" stroke-width="1.4"/>
      <circle cx="28" cy="36" r="7" fill="url(#nest-core)"/>
      <text x="28" y="70" text-anchor="middle" font-size="10" font-weight="700" fill="#475569">全球尺度</text>
    ...
    <g transform="translate(0,148)">
      ...
      <rect x="60" y="4" width="340" height="78" rx="8" fill="#ffffff" stroke="#8b5cf6" stroke-width="1.5"/>
      <text x="74" y="24" font-size="12.5" font-weight="700" fill="#6d28d9">② 区域中套娃（东亚）</text>
    ...
    <g transform="translate(0,244)">
      ...
      <circle cx="28" cy="36" r="14" fill="#fecaca" stroke="#dc2626" stroke-width="1.4"/>
      <circle cx="28" cy="36" r="7" fill="url(#nest-core)"/>
      <text x="28" y="70" text-anchor="middle" font-size="10" font-weight="700" fill="#475569">国内尺度</text>
      <rect x="60" y="4" width="340" height="88" rx="8" fill="#ffffff" stroke="#059669" stroke-width="1.5"/>
      <text x="74" y="24" font-size="12.5" font-weight="700" fill="#047857">③ 国内小套娃（中国）</text>
  ...
  <g transform="translate(24,468)">
    <rect x="0" y="0" width="852" height="72" rx="8" fill="#fff7ed" stroke="#fb923c" stroke-width="1.2"/>
    <text x="16" y="22" font-size="12" font-weight="700" fill="#9a3412">⚖️ 不对称交换 · 「劫贫济富」</text>
...
<div class="dgm">
<div class="dgm-h">🌐 世界市场体系分类模型 · 双向要素环流与中国突围全景</div>
<figure style="margin:0;">
<svg viewBox="0 0 820 620" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:10px auto;font-family:system-ui,-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;" role="img" aria-label="世界市场体系四类国家分类模型与双向要素环流全景图">
  <defs>
    <marker id="arrFlowGold" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L8,3 z" fill="#b45309"/>
    </marker>
    <marker id="arrFlowBlue" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
  ...
  <!-- 外框背景 -->
  <rect width="820" height="620" rx="14" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1.5"/>

  <!-- 顶部标题横幅 -->
  <g transform="translate(410, 26)">
    <text x="0" y="0" font-size="16" font-weight="700" fill="#0f172a" text-anchor="middle">🌐 世界市场体系四类国家分类模型与双向要素环流全景</text>
    <text x="0" y="19" font-size="11" fill="#64748b" text-anchor="middle">核心标准：向体系出口何种剩余以换取所需 ｜ 翟东升 IPE 四重生存方式 · 实物与法币双向对流 · 中国突围路径</text>
  </g>

  <!-- 第一层：四类国家分类模型 & 四重生存方式阶梯 -->
  <!-- 1. 中央国家 (美国) -->
  <g transform="translate(20, 60)" filter="url(#cardShadow)">
    <rect width="185" height="152" rx="10" fill="#eff6ff" stroke="#3b82f6" stroke-width="1.5"/>
    <path d="M0,10 Q0,0 10,0 L175,0 Q185,0 185,10 L185,28 L0,28 Z" fill="#1e3a8a"/>
    <text x="92" y="19" font-size="12" font-weight="700" fill="#ffffff" text-anchor="middle">🇺🇸 中央国家 · 美国</text>
    
    <rect x="12" y="34" width="161" height="22" rx="6" fill="#dbeafe" stroke="#93c5fd" stroke-width="1"/>
    <text x="92" y="49" font-size="11" font-weight="700" fill="#1e40af" text-anchor="middle">靠信心生活（信用霸权）</text>
    
    <text x="14" y="72" font-size="10" font-weight="700" fill="#1e3a8a">核心出口品：</text>
    <text x="14" y="87" font-size="9.5" fill="#334155">美元（法币）+ 无形资产</text>
    <text x="14" y="100" font-size="9" fill="#64748b">（规则·专利·品牌·文化）</text>
    
    <line x1="12" y1="107" x2="173" y2="107" stroke="#bfdbfe" stroke-width="0.8"/>
    <text x="14" y="121" font-size="9" font-weight="600" fill="#1e3a8a">体系特征：</text>
    <text x="14" y="134" font-size="8.8" fill="#475569">享有全球铸币税与金融定价权；</text>
    <text x="14" y="146" font-size="8.8" fill="#475569">吸纳全球廉价商品与矿产资源</text>
  </g>

  <!-- 2. 准中央国家 (西欧/日本) -->
  <g transform="translate(218, 60)" filter="url(#cardShadow)">
    <rect width="185" height="152" rx="10" fill="#f0fdfa" stroke="#0d9488" stroke-width="1.5"/>
    <path d="M0,10 Q0,0 10,0 L175,0 Q185,0 185,10 L185,28 L0,28 Z" fill="#0f766e"/>
    <text x="92" y="19" font-size="12" font-weight="700" fill="#ffffff" text-anchor="middle">🇪🇺🇯🇵 准中央 · 欧日</text>
    
    <rect x="12" y="34" width="161" height="22" rx="6" fill="#ccfbf1" stroke="#99f6e4" stroke-width="1"/>
    <text x="92" y="49" font-size="11" font-weight="700" fill="#0f766e" text-anchor="middle">靠理性生存（纪律积累）</text>
    
    <text x="14" y="72" font-size="10" font-weight="700" fill="#0f766e">核心出口品：</text>
    <text x="14" y="87" font-size="9.5" fill="#334155">高附加值工业品与精密设备</text>
    <text x="14" y="100" font-size="9" fill="#64748b">（核心技术零部件·精密机床）</text>
    
    <line x1="12" y1="107" x2="173" y2="107" stroke="#99f6e4" stroke-width="0.8"/>
    <text x="14" y="121" font-size="9" font-weight="600" fill="#0f766e">体系特征：</text>
    <text x="14" y="134" font-size="8.8" fill="#475569">拥有深厚工业资本与技术壁垒；</text>
    <text x="14" y="146" font-size="8.8" fill="#475569">兼具实体制造与局部金融话语权</text>
  </g>

  <!-- 3. 外围工业国 (中国/东亚/印度) -->
  <g transform="translate(416, 60)" filter="url(#cardShadow)">
    <rect width="185" height="152" rx="10" fill="#fffbeb" stroke="#d97706" stroke-width="1.5"/>
    <path d="M0,10 Q0,0 10,0 L175,0 Q185,0 185,10 L185,28 L0,28 Z" fill="#b45309"/>
    <text x="92" y="19" font-size="12" font-weight="700" fill="#ffffff" text-anchor="middle">🇨🇳 外围工业国 · 中国等</text>
    
    <rect x="12" y="34" width="161" height="22" rx="6" fill="#fef3c7" stroke="#fde68a" stroke-width="1"/>
    <text x="92" y="49" font-size="11" font-weight="700" fill="#b45309" text-anchor="middle">靠勤劳谋生（规模产能）</text>
    
    <text x="14" y="72" font-size="10" font-weight="700" fill="#b45309">核心出口品：</text>
    <text x="14" y="87" font-size="9.5" fill="#334155">劳动/资本密集型制成品</text>
    <text x="14" y="100" font-size="9" fill="#64748b">（消费电子·家电·机械构件）</text>
    
    <line x1="12" y1="107" x2="173" y2="107" stroke="#fde68a" stroke-width="0.8"/>
    <text x="14" y="121" font-size="9" font-weight="600" fill="#b45309">体系特征：</text>
    <text x="14" y="134" font-size="8.8" fill="#475569">提供全球最大规模劳动力与产能；</text>
    <text x="14" y="146" font-size="8.8" fill="#475569">面临“两头在外”，承担劳动环境代价</text>
  </g>

  <!-- 4. 原料提供国 (中东/拉美/非洲) -->
  <g transform="translate(614, 60)" filter="url(#cardShadow)">
    <rect width="185" height="152" rx="10" fill="#ecfdf5" stroke="#059669" stroke-width="1.5"/>
    <path d="M0,10 Q0,0 10,0 L175,0 Q185,0 185,10 L185,28 L0,28 Z" fill="#047857"/>
    <text x="92" y="19" font-size="12" font-weight="700" fill="#ffffff" text-anchor="middle">🌍 原料提供国 · 资源国</text>
    
    <rect x="12" y="34" width="161" height="22" rx="6" fill="#d1fae5" stroke="#a7f3d0" stroke-width="1"/>
    <text x="92" y="49" font-size="11" font-weight="700" fill="#047857" text-anchor="middle">靠运气生存（天然禀赋）</text>
    
    <text x="14" y="72" font-size="10" font-weight="700" fill="#047857">核心出口品：</text>
    <text x="14" y="87" font-size="9.5" fill="#334155">能源（石油天然气）与矿产</text>
    <text x="14" y="100" font-size="9" fill="#64748b">（铁矿·铜·农产品初级原料）</text>
    
    <line x1="12" y1="107" x2="173" y2="107" stroke="#a7f3d0" stroke-width="0.8"/>
    <text x="14" y="121" font-size="9" font-weight="600" fill="#047857">体系特征：</text>
    <text x="14" y="134" font-size="8.8" fill="#475569">极度缺乏工业创造，深陷荷兰病；</text>
    <text x="14" y="146" font-size="8.8" fill="#475569">受大宗商品周期与美元潮汐支配</text>
  </g>

  <!-- 第二层：双向要素环流与体系剩余抽取机制 -->
  <g transform="translate(20, 222)">
    <rect width="780" height="138" rx="10" fill="#ffffff" stroke="#94a3b8" stroke-width="1.2"/>
    <path d="M0,10 Q0,0 10,0 L770,0 Q780,0 780,10 L780,26 L0,26 Z" fill="#334155"/>
    <text x="390" y="18" font-size="11.5" font-weight="700" fill="#ffffff" text-anchor="middle">🔄 世界体系双向环流与剩余抽取机制（“实物供给” vs “信用回流”非对称闭环）</text>

    <!-- 上流：实物链 (右往左) -->
    <rect x="15" y="34" width="750" height="42" rx="6" fill="#fffbeb" stroke="#fcd34d" stroke-width="1"/>
    <text x="25" y="50" font-size="10" font-weight="700" fill="#b45309">① 实物供给链（逆向输入）</text>
    <path d="M 680 58 L 545 58" fill="none" stroke="#b45309" stroke-width="2" marker-end="url(#arrFlowGold)"/>
    <path d="M 450 58 L 330 58" fill="none" stroke="#b45309" stroke-width="2" marker-end="url(#arrFlowGold)"/>
    <path d="M 230 58 L 130 58" fill="none" stroke="#b45309" stroke-width="2" marker-end="url(#arrFlowGold)"/>
    
    <text x="705" y="62" font-size="9.5" font-weight="600" fill="#047857" text-anchor="middle">原料国（石油/矿产）</text>
    <text x="495" y="52" font-size="8.5" fill="#78350f" text-anchor="middle">能源矿产供给</text>
    <text x="390" y="62" font-size="9.5" font-weight="700" fill="#b45309" text-anchor="middle">外围工业国（全链加工）</text>
    <text x="280" y="52" font-size="8.5" fill="#78350f" text-anchor="middle">高性价比制成品</text>
    <text x="180" y="62" font-size="9.5" font-weight="600" fill="#0f766e" text-anchor="middle">准中央（部件集成）</text>
    <text x="70" y="62" font-size="9.5" font-weight="700" fill="#1e3a8a" text-anchor="middle">中央国（终端消费）</text>
    <text x="390" y="71" font-size="8.5" fill="#92400e" text-anchor="middle">【实物剩余流向】：外围辛劳生产可贸易品，满足中央国低储蓄下的过度消费</text>

    <!-- 下流：金融信用链 (左往右) -->
    <rect x="15" y="82" width="750" height="46" rx="6" fill="#eff6ff" stroke="#93c5fd" stroke-width="1"/>
    <text x="25" y="98" font-size="10" font-weight="700" fill="#1e40af">② 金融信用链（顺向回流）</text>
    <path d="M 125 106 L 245 106" fill="none" stroke="#1e40af" stroke-width="2" marker-end="url(#arrFlowBlue)"/>
    <path d="M 365 106 L 475 106" fill="none" stroke="#1e40af" stroke-width="2" marker-end="url(#arrFlowBlue)"/>
    <path d="M 570 106 L 665 106" fill="none" stroke="#1e40af" stroke-width="2" marker-end="url(#arrFlowBlue)"/>
    
    <text x="70" y="110" font-size="9.5" font-weight="700" fill="#1e3a8a" text-anchor="middle">中央国（美联储/财政部）</text>
    <text x="185" y="100" font-size="8.5" fill="#1e40af" text-anchor="middle">输出美元/贸易逆差</text>
    <text x="305" y="110" font-size="9.5" font-weight="700" fill="#b45309" text-anchor="middle">外围国积累万额外储</text>
    <text x="420" y="100" font-size="8.5" fill="#1e40af" text-anchor="middle">外储购买美债回流</text>
    <text x="525" y="110" font-size="9.5" font-weight="700" fill="#1e3a8a" text-anchor="middle">华尔街廉价融资</text>
    <text x="618" y="100" font-size="8.5" fill="#1e40af" text-anchor="middle">FDI高收益返投</text>
    <text x="715" y="110" font-size="9.5" font-weight="600" fill="#047857" text-anchor="middle">外围资产被收割</text>
    <text x="390" y="122" font-size="8.5" fill="#1e40af" text-anchor="middle">【金融剩余闭环】：“布雷顿森林体系 II”——中央国凭空印纸币买商品，外围借钱给中央国反被抽吸铸币税</text>
  </g>

  <!-- 第三层：中国在体系中的地位演进与突围趋势全景 -->
  <g transform="translate(20, 368)">
    <rect width="780" height="202" rx="10" fill="#faf5ff" stroke="#8b5cf6" stroke-width="1.5"/>
    <path d="M0,10 Q0,0 10,0 L770,0 Q780,0 780,10 L780,28 L0,28 Z" fill="#6d28d9"/>
    <text x="390" y="19" font-size="12" font-weight="700" fill="#ffffff" text-anchor="middle">🇨🇳 中国在世界体系中的地位演进与突围趋势（从“超级外围”跃升“准中央”的三维路径）</text>

    <!-- 当前地位与特征卡片 (左侧) -->
    <g transform="translate(14, 38)">
      <rect width="220" height="152" rx="8" fill="#ffffff" stroke="#c084fc" stroke-width="1.2"/>
      <rect width="220" height="24" rx="6" fill="#f3e8ff"/>
      <text x="110" y="16" font-size="11" font-weight="700" fill="#6b21a8" text-anchor="middle">📍 当前地位：超级半外围跃升期</text>
      
      <text x="10" y="38" font-size="9.5" font-weight="700" fill="#4c1d95">• 历史跃迁轨迹：</text>
      <text x="10" y="52" font-size="9" fill="#334155">改革初原料国 ➔ 代工外围 ➔ 冲刺准中央</text>
      
      <text x="10" y="70" font-size="9.5" font-weight="700" fill="#4c1d95">• 产能王者与产业链编辑（CICE）：</text>
      <text x="10" y="84" font-size="9" fill="#334155">制造业占全球约30%，全球最完整门类</text>
      
      <text x="10" y="102" font-size="9.5" font-weight="700" fill="#dc2626">• 体系软肋与依附瓶颈：</text>
      <text x="10" y="116" font-size="9" fill="#475569">高端芯片/精密母机/算法软件被“卡脖子”；</text>
      <text x="10" y="129" font-size="9" fill="#475569">人民币国际份额（~3%）与实物产能失衡；</text>
      <text x="10" y="142" font-size="9" fill="#475569">万亿外储面临低息美债贬值与制裁风险</text>
    </g>
    ...
    <g transform="translate(244, 38)">
      ...
      <g transform="translate(0, 0)">
        <rect width="170" height="152" rx="8" fill="#ffffff" stroke="#38bdf8" stroke-width="1.2"/>
        <rect width="170" height="24" rx="6" fill="#e0f2fe"/>
        <text x="85" y="16" font-size="10.5" font-weight="700" fill="#0369a1" text-anchor="middle">① 产业向顶端攀升（硬实力）</text>
        
        <rect x="8" y="29" width="154" height="20" rx="4" fill="#f0f9ff"/>
        <text x="85" y="43" font-size="9" font-weight="700" fill="#0284c7" text-anchor="middle">从“靠勤劳”➔“靠理性”</text>
        
        <text x="8" y="64" font-size="9" fill="#334155">• <tspan font-weight="700">新质生产力</tspan>：主攻芯片攻关、</text>
        <text x="14" y="77" font-size="9" fill="#334155">EDA软件与工业母机替代；</text>
        
        <text x="8" y="95" font-size="9" fill="#334155">• <tspan font-weight="700">“新三样”制高点</tspan>：电动汽车、</text>
        <text x="14" y="108" font-size="9" fill="#334155">锂电池、光伏实现全产业链主导；</text>
        
        <text x="8" y="126" font-size="9" fill="#334155">• <tspan font-weight="700">标准与专利跃迁</tspan>：掌握技术制定权，</text>
        <text x="14" y="139" font-size="9" fill="#334155">摆脱微薄组装费，获取高额技术剩余</text>
      </g>

      <!-- 路径 2: 货币突围 -->
      <g transform="translate(178, 0)">
        <rect width="170" height="152" rx="8" fill="#ffffff" stroke="#f59e0b" stroke-width="1.2"/>
        <rect width="170" height="24" rx="6" fill="#fef3c7"/>
        <text x="85" y="16" font-size="10.5" font-weight="700" fill="#b45309" text-anchor="middle">② 货币金融权自主（金融权）</text>
        
        <rect x="8" y="29" width="154" height="20" rx="4" fill="#fffbeb"/>
        <text x="85" y="43" font-size="9" font-weight="700" fill="#d97706" text-anchor="middle">打破美元潮汐与铸币税</text>
        
        <text x="8" y="64" font-size="9" fill="#334155">• <tspan font-weight="700">本币结算与CIPS</tspan>：拓展双边货币</text>
        <text x="14" y="77" font-size="9" fill="#334155">互换，摆脱SWIFT制裁威胁；</text>
        
        <text x="8" y="95" font-size="9" fill="#334155">• <tspan font-weight="700">大宗商品计价权</tspan>：石油天然气</text>
        <text x="14" y="108" font-size="9" fill="#334155">人民币计价，挂钩庞大工业产出；</text>
        
        <text x="8" y="126" font-size="9" fill="#334155">• <tspan font-weight="700">外储资产多元化</tspan>：减持低收益美债，</text>
        <text x="14" y="139" font-size="9" fill="#334155">增持黄金与海外优质实体资产</text>
      </g>

      <!-- 路径 3: 秩序重塑 -->
      <g transform="translate(356, 0)">
        <rect width="170" height="152" rx="8" fill="#ffffff" stroke="#10b981" stroke-width="1.2"/>
        <rect width="170" height="24" rx="6" fill="#d1fae5"/>
        <text x="85" y="16" font-size="10.5" font-weight="700" fill="#047857" text-anchor="middle">③ 规则与公共产品（秩序权）</text>
        
        <rect x="8" y="29" width="154" height="20" rx="4" fill="#ecfdf5"/>
        <text x="85" y="43" font-size="9" font-weight="700" fill="#059669" text-anchor="middle">打破中心-外围二元垄断</text>
        
        <text x="8" y="64" font-size="9" fill="#334155">• <tspan font-weight="700">“双循环”格局</tspan>：依托超大国内市场，</text>
        <text x="14" y="77" font-size="9" fill="#334155">成为全球消费中心与吸纳枢纽；</text>
        
        <text x="8" y="95" font-size="9" fill="#334155">• <tspan font-weight="700">共建“一带一路”</tspan>：输出高铁基建、</text>
        <text x="14" y="108" font-size="9" fill="#334155">特高压与绿色能源等新型公共品；</text>
        
        <text x="8" y="126" font-size="9" fill="#334155">• <tspan font-weight="700">多极均衡世界</tspan>：团结“全球南方”，</text>
        <text x="14" y="139" font-size="9" fill="#334155">推动国际政治经济新秩序平等重组</text>
      </g>
    </g>
  </g>
  ...
  <g transform="translate(20, 578)">
    <rect width="780" height="30" rx="6" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="1"/>
    <text x="390" y="19" font-size="10.5" font-weight="700" fill="#0f172a" text-anchor="middle">🎯 考场提分金句：分类标准看“出口何种剩余以换取所需”；中国正以“工业全门类+自主货币+全球公共产品”推动体系由二元掠夺走向多极均衡</text>
  </g>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">
图：<b>世界市场体系分类模型 · 双向要素环流与中国突围趋势</b>（四类国家生存方式阶梯 · 实物与金融对流闭环 · 中国跃升三维路径）。
</figcaption>
</figure>
</div>
...
<svg viewBox="0 0 920 480" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:920px;display:block;margin:10px auto;font-family:inherit;" role="img" aria-label="一位置三指标三方向思维导图">
  <rect width="920" height="480" rx="16" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1.5"/>
  <g transform="translate(145, 240)">
    <rect x="-125" y="-38" width="250" height="76" rx="14" fill="#1e3a8a" stroke="#1e40af" stroke-width="2"/>
    <text x="0" y="-10" font-size="13.5" font-weight="700" fill="#ffffff" text-anchor="middle">中国在全球市场体系中</text>
  ...
  <path d="M 270 240 C 335 240, 335 85, 400 85" fill="none" stroke="#2563eb" stroke-width="2.5" opacity="0.75"/>
  <path d="M 270 240 C 335 240, 335 235, 400 235" fill="none" stroke="#d97706" stroke-width="2.5" opacity="0.75"/>
  <path d="M 270 240 C 335 240, 335 390, 400 390" fill="none" stroke="#059669" stroke-width="2.5" opacity="0.75"/>
  <g transform="translate(400, 85)">
    <rect x="0" y="-28" width="490" height="56" rx="10" fill="#eff6ff" stroke="#2563eb" stroke-width="1.5"/>
    <text x="16" y="-6" font-size="12.5" font-weight="700" fill="#1e40af">📍 1. 一位置（定位）: 半外围跃升期</text>
    <text x="16" y="14" font-size="11" fill="#334155">从“外围工业国（靠勤劳谋生）”➔ 冲刺“准中央国（靠理性生存）”关口</text>
  </g>
  <g transform="translate(400, 160)">
    <rect x="0" y="0" width="490" height="150" rx="10" fill="#fffbeb" stroke="#d97706" stroke-width="1.5"/>
    <text x="16" y="22" font-size="12.5" font-weight="700" fill="#92400e">📊 2. 三指标（现阶段特点与证据链）</text>
    <rect x="14" y="32" width="462" height="32" rx="6" fill="#ffffff" stroke="#fde68a" stroke-width="1"/>
    <text x="24" y="52" font-size="10.5" fill="#78350f">• <tspan font-weight="700">实物/商品</tspan>：制造业占全球 30%（产能霸主 vs EUV光刻机卡脖子）</text>
    ...
    <rect x="14" y="108" width="462" height="32" rx="6" fill="#ffffff" stroke="#fde68a" stroke-width="1"/>
    <text x="24" y="128" font-size="10.5" fill="#78350f">• <tspan font-weight="700">资本/资产</tspan>：高储蓄买 2%美债 vs 外资在华 FDI 享 15%+高收益倒挂</text>
  </g>
  <g transform="translate(400, 325)">
    <rect x="0" y="0" width="490" height="130" rx="10" fill="#ecfdf5" stroke="#059669" stroke-width="1.5"/>
    <text x="16" y="22" font-size="12.5" font-weight="700" fill="#065f46">🚀 3. 三方向（下一步三位一体破局路径）</text>
...
**【西南财经大学】《货币金融学》国家精品课程**
- 内容：系统讲解货币政策工具、传导机制等
- 👉 [点击观看](https://www.bilibili.com/video/BV1dm4y1Z7df/)
> *重难点 · 10题*
...
<svg viewBox="0 0 780 380" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="货币政策四大政治考量按国内国际、内容制度二维度定位：通胀就业、汇率政治、央行独立性、大国货币博弈">
  ...
  <line x1="40" y1="190" x2="740" y2="190" stroke="#94a3b8" stroke-width="1.5" stroke-dasharray="4 4"/>
  <!-- 轴标签 -->
  ...
  <!-- ② 汇率政治（右上·跨国内国际内容） -->
  <rect x="420" y="55" width="280" height="120" rx="10" fill="#fef3c7" stroke="#d97706" stroke-width="1.5"/>
  <text x="560" y="80" font-size="13" font-weight="700" fill="#92400e" text-anchor="middle">② 汇率政治</text>
  ...
  <!-- ③ 央行独立性（左下·国内制度） -->
  <rect x="80" y="215" width="280" height="120" rx="10" fill="#dcfce7" stroke="#16a34a" stroke-width="1.5"/>
  <text x="220" y="240" font-size="13" font-weight="700" fill="#14532d" text-anchor="middle">③ 央行与政府的关系</text>
...
## <a id="全球金融危机史"></a>全球金融危机史


### 📺 B站视频推荐

**耶鲁大学《全球金融危机》中英字幕**
- 内容：耶鲁大学公开课，系统讲解全球金融危机的历史、原因和影响
- 👉 [点击观看](https://www.bilibili.com/video/BV1Ep421o779/)
> *重难点 · 7题*
...
#### **1. [名] 2008年全球金融危机（次贷危机）/ 欧洲债务危机 / 拉美债务危机。**
...
<figure style="margin:12px 0;padding:8px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 680 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="三危机横向对比图：2008全球金融危机、欧洲债务危机、拉美债务危机在时间发源地核心机制制度根源后果应对四维度对比">
  ...
  <rect x="30" y="64" width="190" height="30" rx="6" fill="rgba(163,45,45,0.12)" stroke="#A32D2D" stroke-width="0.7"/>
  <text x="125" y="79" text-anchor="middle" font-size="12" font-weight="700" fill="#791F1F" dominant-baseline="central">2008全球金融危机</text>
  <rect x="250" y="64" width="190" height="30" rx="6" fill="rgba(217,119,6,0.12)" stroke="#D97706" stroke-width="0.7"/>
  <text x="345" y="79" text-anchor="middle" font-size="12" font-weight="700" fill="#92400e" dominant-baseline="central">欧洲债务危机</text>
  <rect x="470" y="64" width="190" height="30" rx="6" fill="rgba(24,95,165,0.12)" stroke="#185FA5" stroke-width="0.7"/>
  <text x="565" y="79" text-anchor="middle" font-size="12" font-weight="700" fill="#0C447C" dominant-baseline="central">拉美债务危机</text>
  <rect x="30" y="102" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="120" font-size="10.5" font-weight="700" fill="var(--text-main)">时间·发源地</text>
  ...
  <rect x="250" y="102" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="264" y="120" font-size="10.5" font-weight="700" fill="var(--text-main)">时间·发源地</text>
  ...
  <rect x="470" y="102" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="484" y="120" font-size="10.5" font-weight="700" fill="var(--text-main)">时间·发源地</text>
  ...
  <rect x="30" y="172" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="190" font-size="10.5" font-weight="700" fill="var(--text-main)">核心机制</text>
  ...
  <rect x="250" y="172" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="264" y="190" font-size="10.5" font-weight="700" fill="var(--text-main)">核心机制</text>
  <text x="264" y="207" font-size="10" fill="var(--text-muted)">国债收益率飙升</text>
  <text x="264" y="221" font-size="10" fill="var(--text-muted)">政府融资困难·求援</text>
  <rect x="470" y="172" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="484" y="190" font-size="10.5" font-weight="700" fill="var(--text-main)">核心机制</text>
  <text x="484" y="207" font-size="10" fill="var(--text-muted)">外债违约·资本逆转</text>
  <text x="484" y="221" font-size="10" fill="var(--text-muted)">（沃尔克加息引爆）</text>
  <rect x="30" y="242" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="260" font-size="10.5" font-weight="700" fill="var(--text-main)">制度根源</text>
  ...
  <rect x="250" y="242" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="264" y="260" font-size="10.5" font-weight="700" fill="var(--text-main)">制度根源</text>
  ...
  <rect x="470" y="242" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="484" y="260" font-size="10.5" font-weight="700" fill="var(--text-main)">制度根源</text>
  <text x="484" y="277" font-size="10" fill="var(--text-muted)">负债增长战略</text>
  <text x="484" y="291" font-size="10" fill="var(--text-muted)">结构单一·依赖外债</text>
  <rect x="30" y="312" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="330" font-size="10.5" font-weight="700" fill="var(--text-main)">后果·应对</text>
  ...
  <rect x="250" y="312" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="264" y="330" font-size="10.5" font-weight="700" fill="var(--text-main)">后果·应对</text>
  ...
  <rect x="470" y="312" width="190" height="62" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="484" y="330" font-size="10.5" font-weight="700" fill="var(--text-main)">后果·应对</text>
  <text x="484" y="347" font-size="10" fill="var(--text-muted)">"失去的十年"</text>
...
<svg viewBox="0 0 680 470" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="欧债危机三层结构：诱因三层导火索、症结四层炸药统币分财、改革四策对症下药，症结与改革一一对应">
  <defs>
    <marker id="arrOZ" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#0F6E56"/>
    </marker>
  </defs>
  <text x="340" y="26" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">🏛️ 欧债危机 · 诱因 × 症结 → 改革（三层结构）</text>
  <text x="340" y="44" text-anchor="middle" font-size="12" fill="var(--text-muted)">诱因＝导火索（外生·什么时候爆）｜症结＝炸药（内生·为什么会爆）｜改革＝对症结反向操作</text>
  <rect x="30" y="62" width="620" height="28" rx="6" fill="rgba(217,119,6,0.12)" stroke="#D97706" stroke-width="0.7"/>
  <text x="340" y="76" text-anchor="middle" font-size="12.5" font-weight="700" fill="#92400e" dominant-baseline="central">① 诱因 · 导火索（触发因素，非根本原因）</text>
  <rect x="30" y="96" width="180" height="56" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="120" y="114" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">外部冲击</text>
  ...
  <line x1="100" y1="276" x2="100" y2="298" stroke="#0F6E56" stroke-width="1.4" marker-end="url(#arrOZ)"/>
  <line x1="250" y1="276" x2="250" y2="298" stroke="#0F6E56" stroke-width="1.4" marker-end="url(#arrOZ)"/>
  <line x1="400" y1="276" x2="400" y2="298" stroke="#0F6E56" stroke-width="1.4" marker-end="url(#arrOZ)"/>
  <line x1="550" y1="276" x2="550" y2="298" stroke="#0F6E56" stroke-width="1.4" marker-end="url(#arrOZ)"/>
  <rect x="295" y="278" width="90" height="20" rx="10" fill="rgba(15,110,86,0.14)" stroke="#0F6E56" stroke-width="0.6"/>
  <text x="340" y="288" text-anchor="middle" font-size="10.5" font-weight="700" fill="#085041" dominant-baseline="central">对症下药</text>
...
<svg viewBox="0 0 680 380" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="拉美债务危机成因双栏对照：内因（负债增长·结构脆弱·资本外逃）与外因（沃尔克加息·商品暴跌·资本逆转）共振引爆危机">
  <defs>
    <marker id="arrLam" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#dc2626"/>
    </marker>
  </defs>
  <!-- 标题 -->
...
<figure style="margin:12px 0;padding:12px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 780 660" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="亚洲金融危机全景图解：内生脆弱性与外部冲击成因，及五大经济体对策后果对照">
  <defs>
    <marker id="afcArr" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#dc2626"/>
    </marker>
    <marker id="afcArrGray" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L8,3 z" fill="#64748b"/>
    </marker>
  </defs>

  <!-- 顶部标题区 -->
  <text x="390" y="24" text-anchor="middle" font-size="16" font-weight="700" fill="var(--text-main)">🌏 1997 亚洲金融危机 · 全景图解：危机成因 ➜ 五大经济体对策后果</text>
  <text x="390" y="44" text-anchor="middle" font-size="11.5" fill="var(--text-muted)">内因"错配·举债·赤字"构筑火药桶 · 外因"投机饱和做空"引爆 · 五体对策迥异决定兴衰结局</text>

  <!-- ================= 第一部分：危机成因 ================= -->
  <rect x="20" y="58" width="740" height="24" rx="4" fill="rgba(220,38,38,0.08)" stroke="#dc2626" stroke-width="0.8"/>
  <text x="30" y="74" font-size="12" font-weight="700" fill="#dc2626">一、危机成因：内部三重脆弱性（火药桶） ✖ 外部投机饱和攻击（导火索）</text>

  <!-- 卡片1：汇率与开放错配 -->
  <rect x="20" y="88" width="176" height="106" rx="8" fill="#fef2f2" stroke="#dc2626" stroke-width="1"/>
  <rect x="20" y="88" width="176" height="26" rx="8 8 0 0" fill="#fee2e2"/>
  <text x="108" y="105" text-anchor="middle" font-size="11.5" font-weight="700" fill="#991b1b">① 制度错配（汇率与开放）</text>
  <text x="28" y="128" font-size="10" fill="#475569">• 僵化固定汇率（盯住美元）</text>
  <text x="28" y="146" font-size="10" fill="#475569">• 资本账户过早/过快开放</text>
  <text x="28" y="164" font-size="10" fill="#475569">• 国际短期热钱涌入吹大泡沫</text>
  <text x="28" y="182" font-size="9.5" fill="#dc2626" font-weight="600">导致资产价格虚高与脆弱性</text>

  <!-- 卡片2：外债双重错配 -->
  <rect x="208" y="88" width="176" height="106" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="1"/>
  <rect x="208" y="88" width="176" height="26" rx="8 8 0 0" fill="#ffedd5"/>
  <text x="296" y="105" text-anchor="middle" font-size="11.5" font-weight="700" fill="#9a3412">② 债务与银行双重错配</text>
  <text x="216" y="128" font-size="10" fill="#475569">• 银行监管缺位，盲目信贷</text>
  <text x="216" y="146" font-size="10" fill="#475569">• 期限错配（借短期投长期）</text>
  <text x="216" y="164" font-size="10" fill="#475569">• 币种错配（借美元投本地）</text>
  <text x="216" y="182" font-size="9.5" fill="#ea580c" font-weight="600">大量沉淀于房地产非贸易品</text>

  <!-- 卡片3：经常账户逆差 -->
  <rect x="396" y="88" width="176" height="106" rx="8" fill="#fefce8" stroke="#ca8a04" stroke-width="1"/>
  <rect x="396" y="88" width="176" height="26" rx="8 8 0 0" fill="#fef9c3"/>
  <text x="484" y="105" text-anchor="middle" font-size="11.5" font-weight="700" fill="#854d0e">③ 经常账户持续逆差</text>
  <text x="404" y="128" font-size="10" fill="#475569">• 出口竞争力下滑（中国汇改）</text>
  <text x="404" y="146" font-size="10" fill="#475569">• 汇率僵化高估无法自发调节</text>
  <text x="404" y="164" font-size="10" fill="#475569">• 经常账户持续失血形成逆差</text>
  <text x="404" y="182" font-size="9.5" fill="#ca8a04" font-weight="600">高度依赖外资资本流入续命</text>

  <!-- 卡片4：外部投机冲击 -->
  <rect x="584" y="88" width="176" height="106" rx="8" fill="#fdf2f8" stroke="#db2777" stroke-width="1"/>
  <rect x="584" y="88" width="176" height="26" rx="8 8 0 0" fill="#fce7f3"/>
  <text x="672" y="105" text-anchor="middle" font-size="11.5" font-weight="700" fill="#9d174d">④ 外部冲击·投机做空</text>
  <text x="592" y="128" font-size="10" fill="#475569">• 国际对冲基金（量子基金）</text>
  <text x="592" y="146" font-size="10" fill="#475569">• 远期外汇市场饱和做空泰铢</text>
  <text x="592" y="164" font-size="10" fill="#475569">• 击溃央行干预防线·资本外逃</text>
  <text x="592" y="182" font-size="9.5" fill="#db2777" font-weight="600">引爆区域多米诺骨牌金融传染</text>

  <!-- 引爆传导横条 -->
  <rect x="20" y="200" width="740" height="24" rx="4" fill="#1e293b"/>
  <text x="390" y="216" text-anchor="middle" font-size="10.5" font-weight="600" fill="#f8fafc">💥 引爆传导链：泰铢失守被迫浮动 (1997.7) ➔ 外债剧增·企业爆仓 ➔ 恐慌资本撤离 ➔ 席卷东亚/东南亚</text>

  <!-- ================= 第二部分：五大经济体对策与后果 ================= -->
  <rect x="20" y="232" width="740" height="24" rx="4" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="30" y="248" font-size="12" font-weight="700" fill="var(--primary)">二、五大经济体对策与后果矩阵（对策不同 ➜ 兴衰迥异）</text>

  <!-- 表头 -->
  <rect x="20" y="260" width="105" height="26" rx="4" fill="var(--code-bg)" stroke="var(--border)"/>
  <text x="72" y="277" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">经济体/定位</text>
  <rect x="130" y="260" width="370" height="26" rx="4" fill="var(--code-bg)" stroke="var(--border)"/>
  <text x="315" y="277" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">主要应对策略</text>
  <rect x="505" y="260" width="255" height="26" rx="4" fill="var(--code-bg)" stroke="var(--border)"/>
  <text x="632" y="277" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">危机后果与严重程度</text>

  <!-- 1. 泰国（起点·重创）-->
  <rect x="20" y="290" width="105" height="52" rx="6" fill="#fee2e2" stroke="#dc2626" stroke-width="0.8"/>
  <text x="72" y="310" text-anchor="middle" font-size="12" font-weight="700" fill="#991b1b">泰国</text>
  <text x="72" y="328" text-anchor="middle" font-size="9.5" fill="#dc2626">危机起点</text>

  <rect x="130" y="290" width="370" height="52" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="140" y="310" font-size="10.5" fill="var(--text-main)">• 初期动用全部外储干预保卫泰铢</text>
  <text x="140" y="328" font-size="10.5" fill="var(--text-main)">• 1997.7 耗尽外储被迫浮动，全盘接受 IMF 严苛紧缩条件</text>

  <rect x="505" y="290" width="255" height="52" rx="6" fill="#fef2f2" stroke="#dc2626" stroke-width="0.6"/>
  <text x="515" y="310" font-size="10.5" fill="var(--text-main)">货币腰斩·企业外债剧增·大批倒闭</text>
  <text x="515" y="328" font-size="10.5" font-weight="700" fill="#dc2626">深度衰退（严重 🔴🔴🔴）</text>

  <!-- 2. 印尼（最惨烈）-->
  <rect x="20" y="346" width="105" height="52" rx="6" fill="#fecaca" stroke="#b91c1c" stroke-width="1"/>
  <text x="72" y="366" text-anchor="middle" font-size="12" font-weight="700" fill="#7f1d1d">印尼</text>
  <text x="72" y="384" text-anchor="middle" font-size="9.5" fill="#991b1b">最为惨烈</text>

  <rect x="130" y="346" width="370" height="52" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="140" y="366" font-size="10.5" fill="var(--text-main)">• 初期抵抗后接受 IMF 方案，放开汇率</text>
  <text x="140" y="384" font-size="10.5" fill="var(--text-main)">• 腐败裙带资本主义与政治动荡叠加，政策信誉全失致卢比雪崩</text>

  <rect x="505" y="346" width="255" height="52" rx="6" fill="#fee2e2" stroke="#b91c1c" stroke-width="0.8"/>
  <text x="515" y="366" font-size="10.5" fill="var(--text-main)">卢比贬值超80%·通胀飙升·民不聊生</text>
  <text x="515" y="384" font-size="10.5" font-weight="700" fill="#7f1d1d">苏哈托下台·社会动荡（最惨 🔴🔴🔴🔴）</text>

  <!-- 3. 韩国（应对范例）-->
  <rect x="20" y="402" width="105" height="52" rx="6" fill="#dcfce7" stroke="#16a34a" stroke-width="0.8"/>
  <text x="72" y="422" text-anchor="middle" font-size="12" font-weight="700" fill="#14532d">韩国</text>
  <text x="72" y="440" text-anchor="middle" font-size="9.5" fill="#16a34a">应对范例</text>

  <rect x="130" y="402" width="370" height="52" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="140" y="422" font-size="10.5" fill="var(--text-main)">• 外储枯竭向 IMF 申请巨额救助，忍受高利率与财政紧缩</text>
  <text x="140" y="440" font-size="10.5" fill="var(--text-main)">• 大刀阔斧改革：大宇破产整顿财阀、重组金融、彻底开放</text>

  <rect x="505" y="402" width="255" height="52" rx="6" fill="#f0fdf4" stroke="#16a34a" stroke-width="0.6"/>
  <text x="515" y="422" font-size="10.5" fill="var(--text-main)">痛苦改革重建韧性·外储迅速反弹</text>
  <text x="515" y="440" font-size="10.5" font-weight="700" fill="#15803d">1999 强劲反弹复苏（范例 🟢）</text>

  <!-- 4. 香港（代价保卫）-->
  <rect x="20" y="458" width="105" height="52" rx="6" fill="#fef3c7" stroke="#d97706" stroke-width="0.8"/>
  <text x="72" y="478" text-anchor="middle" font-size="12" font-weight="700" fill="#92400e">香港</text>
  <text x="72" y="496" text-anchor="middle" font-size="9.5" fill="#d97706">代价保卫</text>

  <rect x="130" y="458" width="370" height="52" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="140" y="478" font-size="10.5" fill="var(--text-main)">• 联系汇率保卫战：动用千亿外储入市买入港股与期指</text>
  <text x="140" y="496" font-size="10.5" fill="var(--text-main)">• 飙升同业拆借利率至 300% 惩罚做空，阻断投机者"汇股双杀"</text>

  <rect x="505" y="458" width="255" height="52" rx="6" fill="#fffbeb" stroke="#d97706" stroke-width="0.6"/>
  <text x="515" y="478" font-size="10.5" fill="var(--text-main)">成功击退国际投机客，捍卫联汇信誉</text>
  <text x="515" y="496" font-size="10.5" font-weight="700" fill="#b45309">股市楼市暴跌·1998衰退（代价 🟡🟡）</text>

  <!-- 5. 台湾（弹性缓冲）-->
  <rect x="20" y="514" width="105" height="52" rx="6" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="72" y="534" text-anchor="middle" font-size="12" font-weight="700" fill="var(--primary)">台湾</text>
  <text x="72" y="552" text-anchor="middle" font-size="9.5" fill="var(--primary)">弹性缓冲</text>

  <rect x="130" y="514" width="370" height="52" rx="6" fill="var(--card-bg)" stroke="var(--border)"/>
  <text x="140" y="534" font-size="10.5" fill="var(--text-main)">• 主动放弃僵化汇率实行管理浮动，让新台币有序适度贬值</text>
  <text x="140" y="552" font-size="10.5" fill="var(--text-main)">• 动用巨额外储稳定内部金融流动性，辅以扩张性财政货币政策</text>

  <rect x="505" y="514" width="255" height="52" rx="6" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.6"/>
  <text x="515" y="534" font-size="10.5" fill="var(--text-main)">保留外汇元气与出口竞争力</text>
  <text x="515" y="552" font-size="10.5" font-weight="700" fill="var(--primary)">受冲击较轻·未严重衰退（缓冲 🔵）</text>

  <!-- ================= 底部启示总结 ================= -->
  <rect x="20" y="574" width="740" height="66" rx="8" fill="rgba(99,102,241,0.08)" stroke="var(--primary)" stroke-width="1"/>
  <text x="390" y="596" text-anchor="middle" font-size="11.5" font-weight="700" fill="var(--primary)">💡 核心启示与答题框架（一机制通吃）</text>
  <text x="390" y="615" text-anchor="middle" font-size="10.5" fill="var(--text-main)">口诀：内因"错配·举债·赤字"，外因"投机卖空+传染"；五体"韩改革·港保卫·台弹性·泰起点·印尼最惨"。</text>
  <text x="390" y="632" text-anchor="middle" font-size="10" fill="var(--text-muted)">启示：审慎宏观金融监管（防期限币种错配） + 灵活汇率缓冲机制 + 充裕外汇储备池 + 坚决政治稳定是危机自救根本。</text>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">图：亚洲金融危机全景剖析——<b>成因</b>（汇率错配+双重债务错配+经常账户赤字+投机卖空）与<b>五经济体对策后果</b>（韩改革·港保卫·台弹性·泰起点·印尼最惨）。</figcaption>
</figure>
...
## <a id="外资-fdi-与中国工业化"></a>外资(FDI)与中国工业化

### 📺 B站视频推荐

**外资在华40年，怎么一路走来？又意味着什么？**
- 内容：回顾外资在中国的发展历程，分析其对工业化进程的影响
- 👉 [点击观看](https://www.bilibili.com/opus/938036242024497185)
...
<svg viewBox="0 0 780 768" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:780px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="本节核心概念与八道题的分布矩阵：26 个核心概念分四名词五理论、翟东升机制术语、判断词与政策词三组，横向对应题1至题8，格内数字为该概念在该题正文中的出现次数">
  ...
  <line x1="210" y1="30" x2="210" y2="54" stroke="#cbd5e1" stroke-width="1"/>
  <rect x="14" y="62" width="744" height="18" rx="5" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="22" y="75" font-size="9.5" font-weight="700" fill="#4f46e5">① 四名词与五理论</text>
  <text x="20" y="98" font-size="9.5" fill="var(--text-main)">FDI 外商直接投资</text>
  <rect x="220" y="86" width="56" height="18" rx="4" fill="#4f46e5" stroke="#4f46e5" stroke-width="0.8"/>
  <text x="248" y="99" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle">7</text>
  <rect x="288" y="86" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="99" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="356" y="86" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="99" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="86" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="452" y="99" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="492" y="86" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="99" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="86" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="99" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="86" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="656" y="99" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">3</text>
  <rect x="696" y="86" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="724" y="99" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">3</text>
  <text x="20" y="120" font-size="9.5" fill="var(--text-main)">雁行模式</text>
  <rect x="220" y="108" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="248" y="121" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="288" y="108" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="121" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="356" y="108" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="121" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="108" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="121" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="108" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="121" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="108" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="121" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="108" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="121" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="108" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="121" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="142" font-size="9.5" fill="var(--text-main)">微笑曲线</text>
  <rect x="220" y="130" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="248" y="143" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">6</text>
  <rect x="288" y="130" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="143" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="130" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="143" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="130" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="143" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="130" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="143" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="130" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="143" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="130" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="143" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="130" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="724" y="143" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <text x="20" y="164" font-size="9.5" fill="var(--text-main)">产业链编辑能力 CICE</text>
  <rect x="220" y="152" width="56" height="18" rx="4" fill="#4f46e5" stroke="#4f46e5" stroke-width="0.8"/>
  <text x="248" y="165" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle">12</text>
  <rect x="288" y="152" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="165" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="152" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="165" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="152" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="165" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="152" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="165" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="152" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="165" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="152" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="165" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="152" width="56" height="18" rx="4" fill="#4f46e5" stroke="#4f46e5" stroke-width="0.8"/>
  <text x="724" y="165" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle">7</text>
  <text x="20" y="186" font-size="9.5" fill="var(--text-main)">两缺口模型</text>
  <rect x="220" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="174" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="187" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="356" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="174" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="187" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="208" font-size="9.5" fill="var(--text-main)">区位优势 OLI</text>
  <rect x="220" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="196" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="209" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">4</text>
  <rect x="356" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="196" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="209" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="230" font-size="9.5" fill="var(--text-main)">产品生命周期</text>
  <rect x="220" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="218" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="231" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="356" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="218" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="231" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="252" font-size="9.5" fill="var(--text-main)">全球价值链分工</text>
  <rect x="220" y="240" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="253" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="240" width="56" height="18" rx="4" fill="#a5b4fc" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="253" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">3</text>
  <rect x="356" y="240" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="384" y="253" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="424" y="240" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="253" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="240" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="520" y="253" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="560" y="240" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="588" y="253" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="628" y="240" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="656" y="253" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="696" y="240" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="253" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="274" font-size="9.5" fill="var(--text-main)">以市场换技术</text>
  <rect x="220" y="262" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="248" y="275" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="288" y="262" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="316" y="275" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="356" y="262" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="275" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="262" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="275" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="262" width="56" height="18" rx="4" fill="#eef2ff" stroke="#6366f1" stroke-width="0.8"/>
  <text x="520" y="275" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="560" y="262" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="275" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="262" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="275" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="262" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="275" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="14" y="290" width="744" height="18" rx="5" fill="#f0fdfa" stroke="#0d9488" stroke-width="0.8"/>
  <text x="22" y="303" font-size="9.5" font-weight="700" fill="#0f766e">② 翟东升的机制与自创术语</text>
  <text x="20" y="326" font-size="9.5" fill="var(--text-main)">三外路线</text>
  <rect x="220" y="314" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="327" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="314" width="56" height="18" rx="4" fill="#f0fdfa" stroke="#0d9488" stroke-width="0.8"/>
  <text x="316" y="327" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="356" y="314" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="327" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="314" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="327" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="314" width="56" height="18" rx="4" fill="#f0fdfa" stroke="#0d9488" stroke-width="0.8"/>
  <text x="520" y="327" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="560" y="314" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="327" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="314" width="56" height="18" rx="4" fill="#0f766e" stroke="#0f766e" stroke-width="0.8"/>
  <text x="656" y="327" font-size="9.5" font-weight="700" fill="#ffffff" text-anchor="middle">11</text>
  <rect x="696" y="314" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="327" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="348" font-size="9.5" fill="var(--text-main)">大交易 / 资金循环</text>
  <rect x="220" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="336" width="56" height="18" rx="4" fill="#5eead4" stroke="#0d9488" stroke-width="0.8"/>
  <text x="656" y="349" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="696" y="336" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="349" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="370" font-size="9.5" fill="var(--text-main)">铸币税</text>
  <rect x="220" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="358" width="56" height="18" rx="4" fill="#5eead4" stroke="#0d9488" stroke-width="0.8"/>
  <text x="656" y="371" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">6</text>
  <rect x="696" y="358" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="371" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="392" font-size="9.5" fill="var(--text-main)">勤劳换纸</text>
  <rect x="220" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="380" width="56" height="18" rx="4" fill="#5eead4" stroke="#0d9488" stroke-width="0.8"/>
  <text x="656" y="393" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">3</text>
  <rect x="696" y="380" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="393" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="414" font-size="9.5" fill="var(--text-main)">价格革命</text>
  <rect x="220" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="402" width="56" height="18" rx="4" fill="#5eead4" stroke="#0d9488" stroke-width="0.8"/>
  <text x="520" y="415" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">3</text>
  <rect x="560" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="402" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="415" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="436" font-size="9.5" fill="var(--text-main)">政策洼地</text>
  <rect x="220" y="424" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="437" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="424" width="56" height="18" rx="4" fill="#f0fdfa" stroke="#0d9488" stroke-width="0.8"/>
  <text x="316" y="437" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="356" y="424" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="437" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="424" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="437" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="424" width="56" height="18" rx="4" fill="#f0fdfa" stroke="#0d9488" stroke-width="0.8"/>
  <text x="520" y="437" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="560" y="424" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="588" y="437" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="628" y="424" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="437" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="424" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="437" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="14" y="452" width="744" height="18" rx="5" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="22" y="465" font-size="9.5" font-weight="700" fill="#b45309">③ 判断词与政策词</text>
  <text x="20" y="488" font-size="9.5" fill="var(--text-main)">战略工具（外资定性）</text>
  <rect x="220" y="476" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="248" y="489" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="288" y="476" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="489" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="476" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="384" y="489" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="424" y="476" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="489" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="476" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="489" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="476" width="56" height="18" rx="4" fill="#fcd34d" stroke="#b89a40" stroke-width="0.8"/>
  <text x="588" y="489" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="628" y="476" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="489" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="476" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="489" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="510" font-size="9.5" fill="var(--text-main)">二重性</text>
  <rect x="220" y="498" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="511" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="498" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="511" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="498" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="384" y="511" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="424" y="498" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="511" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="498" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="511" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="498" width="56" height="18" rx="4" fill="#fcd34d" stroke="#b89a40" stroke-width="0.8"/>
  <text x="588" y="511" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">5</text>
  <rect x="628" y="498" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="511" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="498" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="511" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="532" font-size="9.5" fill="var(--text-main)">低端锁定</text>
  <rect x="220" y="520" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="248" y="533" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="288" y="520" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="533" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="520" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="384" y="533" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  <rect x="424" y="520" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="533" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="520" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="520" y="533" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="560" y="520" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="588" y="533" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="628" y="520" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="533" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="520" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="533" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <text x="20" y="554" font-size="9.5" fill="var(--text-main)">发展权 ⇄ 控制权</text>
  <rect x="220" y="542" width="56" height="18" rx="4" fill="#fcd34d" stroke="#b89a40" stroke-width="0.8"/>
  <text x="248" y="555" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">4</text>
  <rect x="288" y="542" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="316" y="555" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
  ...
  <rect x="424" y="542" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="555" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="542" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="555" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="542" width="56" height="18" rx="4" fill="#fcd34d" stroke="#b89a40" stroke-width="0.8"/>
  <text x="588" y="555" font-size="9.5" font-weight="700" fill="#1e293b" text-anchor="middle">6</text>
  <rect x="628" y="542" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="555" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="542" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="555" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  ...
  <rect x="288" y="564" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="316" y="577" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="356" y="564" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="384" y="577" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="424" y="564" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="452" y="577" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="492" y="564" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="520" y="577" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="560" y="564" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="588" y="577" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">2</text>
  <rect x="628" y="564" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="656" y="577" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  <rect x="696" y="564" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="577" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  ...
  <rect x="696" y="586" width="56" height="18" rx="4" fill="var(--code-bg)" stroke="var(--border)" stroke-width="0.8"/>
  <text x="724" y="599" font-size="9.5" font-weight="400" fill="var(--text-muted)" text-anchor="middle">·</text>
  ...
  <rect x="696" y="630" width="56" height="18" rx="4" fill="#fef3c7" stroke="#b89a40" stroke-width="0.8"/>
  <text x="724" y="643" font-size="9.5" font-weight="600" fill="#1e293b" text-anchor="middle">1</text>
...
| **铸币税** | FDI 在华回报约 **15%** vs 外储买美债约 **3%**，约 12 个百分点负利差＝向美元体系缴纳的铸币税 |
...
翟东升对三外路线的剖析可拆成三个层次：**三根支柱**（外贸、外资、外汇）支撑起**资金循环机制**（引资→出口→储备→回流），但循环的代价是**铸币税、勤劳换纸、政策扭曲**。理解这三个层次，就能把"成就—机制—代价"的逻辑链讲透。

> 💡 **翟东升视角**：三外路线是中国在特定发展阶段**充分利用全球化红利**的精准战略，但双顺差积累的巨额外储也使中国向美元体系缴纳了大量"铸币税"。随着经济转型，"三外路线"正向"双循环 + 人民币国际化"新模式演进。
...
<svg viewBox="0 0 680 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="三外路线核心框架：鼓励外贸、吸引外资、控制外汇三根支柱及其代价">
  <defs>
    <marker id="arrSW" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="var(--text-muted)"/>
    </marker>
    <marker id="arrSWr" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#dc2626"/>
    </marker>
  </defs>
  <text x="340" y="28" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">三外路线核心框架</text>
  <text x="340" y="46" text-anchor="middle" font-size="12" fill="var(--text-muted)">翟东升 · 中国对外经济战略核心</text>
  <rect x="40" y="70" width="180" height="60" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="130" y="94" text-anchor="middle" font-size="14" font-weight="500" fill="var(--text-main)" dominant-baseline="central">鼓励外贸</text>
  <text x="130" y="114" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">出口导向 · 嵌入全球价值链</text>
  <rect x="250" y="70" width="180" height="60" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="340" y="94" text-anchor="middle" font-size="14" font-weight="500" fill="var(--text-main)" dominant-baseline="central">吸引外资</text>
  <text x="340" y="114" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">税收优惠 · 引入 FDI 和技术</text>
  <rect x="460" y="70" width="180" height="60" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="550" y="94" text-anchor="middle" font-size="14" font-weight="500" fill="var(--text-main)" dominant-baseline="central">控制外汇</text>
  <text x="550" y="114" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">强制结售汇 · 资本管制</text>
  <line x1="220" y1="100" x2="248" y2="100" stroke="var(--text-muted)" stroke-width="1" marker-end="url(#arrSW)"/>
  <line x1="430" y1="100" x2="458" y2="100" stroke="var(--text-muted)" stroke-width="1" marker-end="url(#arrSW)"/>
  <text x="340" y="170" text-anchor="middle" font-size="13" font-weight="500" fill="var(--text-main)">资金循环机制</text>
  <rect x="100" y="190" width="160" height="44" rx="8" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="0.5"/>
  <text x="180" y="212" text-anchor="middle" font-size="13" font-weight="500" fill="#16a34a" dominant-baseline="central">FDI 进入中国建厂</text>
  <rect x="290" y="190" width="160" height="44" rx="8" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="0.5"/>
  <text x="370" y="212" text-anchor="middle" font-size="13" font-weight="500" fill="#16a34a" dominant-baseline="central">出口赚取外汇</text>
  <rect x="480" y="190" width="160" height="44" rx="8" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="0.5"/>
  <text x="560" y="212" text-anchor="middle" font-size="13" font-weight="500" fill="#16a34a" dominant-baseline="central">强制结汇→外储</text>
  <line x1="260" y1="212" x2="288" y2="212" stroke="#16a34a" stroke-width="1" marker-end="url(#arrSW)"/>
  <line x1="450" y1="212" x2="478" y2="212" stroke="#16a34a" stroke-width="1" marker-end="url(#arrSW)"/>
  <line x1="560" y1="234" x2="560" y2="260" stroke="#16a34a" stroke-width="1" marker-end="url(#arrSW)"/>
  <rect x="460" y="262" width="180" height="44" rx="8" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="0.5"/>
  <text x="550" y="284" text-anchor="middle" font-size="12" font-weight="500" fill="#16a34a" dominant-baseline="central">外储 ~4万亿 (2014)</text>
  <text x="340" y="340" text-anchor="middle" font-size="13" font-weight="500" fill="#dc2626">翟东升批判视角：代价与扭曲</text>
  <rect x="40" y="358" width="190" height="44" rx="8" fill="rgba(220,38,38,0.08)" stroke="#dc2626" stroke-width="0.5"/>
  <text x="135" y="380" text-anchor="middle" font-size="12" fill="#dc2626" dominant-baseline="central">铸币税：FDI~15% vs 美债~3%</text>
  <rect x="250" y="358" width="190" height="44" rx="8" fill="rgba(220,38,38,0.08)" stroke="#dc2626" stroke-width="0.5"/>
  <text x="345" y="380" text-anchor="middle" font-size="12" fill="#dc2626" dominant-baseline="central">勤劳换纸：压制实际购买力</text>
  <rect x="460" y="358" width="190" height="44" rx="8" fill="rgba(220,38,38,0.08)" stroke="#dc2626" stroke-width="0.5"/>
  <text x="555" y="380" text-anchor="middle" font-size="12" fill="#dc2626" dominant-baseline="central">货币政策扭曲：冲销困境</text>
  <line x1="460" y1="306" x2="230" y2="356" stroke="#dc2626" stroke-width="0.8" stroke-dasharray="4 3" marker-end="url(#arrSWr)"/>
  <line x1="640" y1="306" x2="650" y2="356" stroke="#dc2626" stroke-width="0.8" stroke-dasharray="4 3" marker-end="url(#arrSWr)"/>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:4px;">图：三外路线核心框架——三根支柱（外贸·外资·外汇）构成资金循环，但代价是铸币税与政策扭曲</figcaption>
</figure>
...
<svg viewBox="0 0 680 360" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="资金循环机制总览：引资-出口-储备-回流的完整资金闭环（大交易）">
  <defs>
    <marker id="arrCirc" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="var(--primary)"/>
    </marker>
  </defs>
  <text x="340" y="28" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">资金循环机制总览（大交易）</text>
  <text x="340" y="46" text-anchor="middle" font-size="12" fill="var(--text-muted)">引资 → 出口 → 储备 → 回流：一个首尾相接的闭环</text>
  <rect x="40" y="80" width="140" height="64" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="110" y="104" text-anchor="middle" font-size="13" font-weight="500" fill="var(--text-main)" dominant-baseline="central">① 引资</text>
  <text x="110" y="124" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">FDI 流入中国</text>
  <rect x="210" y="80" width="140" height="64" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="280" y="104" text-anchor="middle" font-size="13" font-weight="500" fill="var(--text-main)" dominant-baseline="central">② 出口</text>
  <text x="280" y="124" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">商品出口赚外汇</text>
  <rect x="380" y="80" width="140" height="64" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="450" y="104" text-anchor="middle" font-size="13" font-weight="500" fill="var(--text-main)" dominant-baseline="central">③ 储备</text>
  <text x="450" y="124" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">强制结汇→外储</text>
  <rect x="550" y="80" width="120" height="64" rx="10" fill="var(--primary-soft)" stroke="var(--primary)" stroke-width="0.5"/>
  <text x="610" y="104" text-anchor="middle" font-size="13" font-weight="500" fill="var(--text-main)" dominant-baseline="central">④ 回流</text>
  ...
  <line x1="350" y1="112" x2="378" y2="112" stroke="var(--primary)" stroke-width="1.2" marker-end="url(#arrCirc)"/>
  <line x1="520" y1="112" x2="548" y2="112" stroke="var(--primary)" stroke-width="1.2" marker-end="url(#arrCirc)"/>
  <path d="M 610 144 Q 610 220, 340 220 Q 110 220, 110 160" fill="none" stroke="var(--primary)" stroke-width="1.2" stroke-dasharray="5 3" marker-end="url(#arrCirc)"/>
  <text x="340" y="245" text-anchor="middle" font-size="11" fill="var(--primary)" font-style="italic">美元回流支撑美国低利率+消费 → 继续买中国商品 → 循环重启</text>
  <rect x="40" y="280" width="300" height="60" rx="8" fill="rgba(22,163,74,0.08)" stroke="#16a34a" stroke-width="0.5"/>
  <text x="190" y="300" text-anchor="middle" font-size="12" font-weight="500" fill="#16a34a" dominant-baseline="central">中国侧：得到资本+技术+就业</text>
  <text x="190" y="320" text-anchor="middle" font-size="11" fill="var(--text-muted)" dominant-baseline="central">付出：廉价劳动力 + 环境资源 + 外储"人质"</text>
  <rect x="360" y="280" width="300" height="60" rx="8" fill="rgba(245,158,11,0.08)" stroke="#d97706" stroke-width="0.5"/>
  <text x="510" y="300" text-anchor="middle" font-size="12" font-weight="500" fill="#d97706" dominant-baseline="central">美国侧：得到廉价商品+融资</text>
...
*   **铸币税（负利差）**：FDI 在华回报率约 15%，而外储买美债收益率仅约 3%——这个约 12 个百分点的差额，就是中国向美元体系缴纳的"铸币税"（翟东升术语）。详见外汇储备 Q2 的负利差循环图。
...
>
> **记忆口诀**：**"外贸、外资、外汇"三支柱 → "引资、出口、储备、回流"四循环 → "铸币税、勤劳换纸、政策扭曲"三代价**。再加一句"正转向双循环+人民币国际化"作为升华。
...
<figure style="margin:12px 0;padding:8px 16px;border-left:4px solid var(--primary);background:var(--code-bg);border-radius:0 6px 6px 0;">
<svg viewBox="0 0 680 380" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="产业转移三类转出与四策掌控：成本规制贸易三种驱动力对应三类转出产业，保关键节点主动输出加速升级强化技术自主四策掌控，核心是产业链编辑能力CICE">
  <defs>
    <marker id="arrInd" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#D97706"/>
    </marker>
  </defs>
  <text x="340" y="26" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">🏭 产业转移 · 三类转出 × 四策掌控</text>
  <text x="340" y="44" text-anchor="middle" font-size="12" fill="var(--text-muted)">三种驱动力决定谁走（成本·规制·贸易）· 四种策略决定留下什么（核心是 CICE）</text>
  <rect x="30" y="64" width="290" height="30" rx="6" fill="rgba(217,119,6,0.12)" stroke="#D97706" stroke-width="0.7"/>
  <text x="175" y="79" text-anchor="middle" font-size="13" font-weight="700" fill="#92400e" dominant-baseline="central">三类转出 · 驱动力递进</text>
  <rect x="30" y="100" width="290" height="60" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="118" font-size="11" font-weight="700" fill="#92400e">成本驱动 → 劳动密集型低端制造</text>
  ...
  <rect x="30" y="168" width="290" height="60" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="186" font-size="11" font-weight="700" fill="#92400e">规制驱动 → 高污染高耗能</text>
  ...
  <rect x="30" y="236" width="290" height="60" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="254" font-size="11" font-weight="700" fill="#92400e">贸易驱动 → 出口导向组装加工</text>
  ...
  <rect x="360" y="64" width="290" height="30" rx="6" fill="rgba(15,110,86,0.12)" stroke="#0F6E56" stroke-width="0.7"/>
  <text x="505" y="79" text-anchor="middle" font-size="13" font-weight="700" fill="#085041" dominant-baseline="central">四策掌控 · 从"被动防御"到"主动编辑"</text>
  <rect x="360" y="100" width="290" height="42" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="117" font-size="11" font-weight="700" fill="#0F6E56">① 保关键节点</text>
  <text x="374" y="132" font-size="10" fill="var(--text-muted)">核心零部件留国内（MLCC·模具·特种材料）</text>
  <rect x="360" y="150" width="290" height="42" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="167" font-size="11" font-weight="700" fill="#0F6E56">② 主动输出产业链（一带一路逻辑）</text>
  <text x="374" y="182" font-size="10" fill="var(--text-muted)">以 CICE 掌握海外产业网络核心</text>
  <rect x="360" y="200" width="290" height="42" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="217" font-size="11" font-weight="700" fill="#0F6E56">③ 加速产业升级</text>
  <text x="374" y="232" font-size="10" fill="var(--text-muted)">微笑曲线两端：研发设计+品牌营销</text>
  <rect x="360" y="250" width="290" height="42" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="267" font-size="11" font-weight="700" fill="#0F6E56">④ 强化技术自主</text>
  <text x="374" y="282" font-size="10" fill="var(--text-muted)">芯片·操作系统·工业软件"卡脖子"突破</text>
  <line x1="322" y1="130" x2="358" y2="121" stroke="#D97706" stroke-width="1.2" opacity="0.7" marker-end="url(#arrInd)"/>
  <line x1="322" y1="198" x2="358" y2="171" stroke="#D97706" stroke-width="1.2" opacity="0.7" marker-end="url(#arrInd)"/>
  <line x1="322" y1="266" x2="358" y2="221" stroke="#D97706" stroke-width="1.2" opacity="0.7" marker-end="url(#arrInd)"/>
  <rect x="30" y="312" width="620" height="52" rx="8" fill="rgba(99,102,241,0.08)" stroke="var(--primary)" stroke-width="0.8"/>
  <text x="340" y="330" text-anchor="middle" font-size="12" font-weight="700" fill="var(--text-main)" dominant-baseline="central">金句：让转移的只是低附加值环节，让留下来的是定价权和关键技术</text>
...
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">图：<b>三类转出</b>由成本/规制/贸易三种驱动力推出（劳密·高污·组装），<b>四策掌控</b>把核心留在国内（关键节点·主动输出·产业升级·技术自主），核心是<b>产业链编辑能力（CICE）</b>。</figcaption>
</figure>
...
## <a id="美元霸权与美国政策"></a>美元霸权与美国政策


### 📺 B站视频推荐

**到底什么是美元霸权？深度解析特朗普加关税的最终意图**
- 内容：深度解析美元霸权的形成、运作机制
- 👉 [点击观看](https://www.bilibili.com/video/BV13goMYtE9q/)
> *补充*
...
<svg viewBox="0 0 680 350" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="美元霸权四概念关系图：中心美元霸权，外围石油美元是信用锚、美元指数是强弱标尺、SWIFT是制裁工具">
  <defs>
    <marker id="arrUSD" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#534AB7"/>
    </marker>
  </defs>
  <text x="340" y="26" text-anchor="middle" font-size="15" font-weight="500" fill="var(--text-main)">💵 美元霸权四概念 · 霸权—工具关系</text>
  <text x="340" y="44" text-anchor="middle" font-size="12" fill="var(--text-muted)">霸权是本质 · 石油美元是"锚" · 美元指数是"标尺" · SWIFT是"工具"</text>
  <rect x="90" y="62" width="210" height="70" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="195" y="82" text-anchor="middle" font-size="12" font-weight="700" fill="#B45309">石油美元 · 信用"锚"</text>
  ...
  <rect x="380" y="62" width="210" height="70" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="485" y="82" text-anchor="middle" font-size="12" font-weight="700" fill="#185FA5">美元指数 · "标尺"</text>
  ...
  <rect x="230" y="150" width="220" height="74" rx="10" fill="rgba(83,74,183,0.10)" stroke="#534AB7" stroke-width="1"/>
  <text x="340" y="172" text-anchor="middle" font-size="13" font-weight="700" fill="#3C3489">美元霸权 · 本质</text>
  ...
  <line x1="340" y1="150" x2="230" y2="134" stroke="#534AB7" stroke-width="1.3" marker-end="url(#arrUSD)"/>
  <line x1="340" y1="150" x2="450" y2="134" stroke="#534AB7" stroke-width="1.3" marker-end="url(#arrUSD)"/>
  <text x="265" y="132" text-anchor="middle" font-size="10" font-weight="700" fill="#534AB7">锚</text>
  <text x="415" y="132" text-anchor="middle" font-size="10" font-weight="700" fill="#534AB7">标尺</text>
  <rect x="230" y="268" width="220" height="70" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="340" y="288" text-anchor="middle" font-size="12" font-weight="700" fill="#A32D2D">SWIFT系统 · "工具"</text>
...
<div style="text-align: center; margin: 20px 0;">
    <svg width="100%" viewBox="0 0 680 415" role="img" xmlns="http://www.w3.org/2000/svg" style="">
        ...
        <g style="fill:rgb(0, 0, 0);stroke:none;color:rgb(11, 11, 11);stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;opacity:1;font-family:&quot;Anthropic Sans&quot;, -apple-system, &quot;system-ui&quot;, &quot;Segoe UI&quot;, sans-serif;font-size:16px;font-weight:400;text-anchor:start;dominant-baseline:auto">
            <rect x="248" y="140" width="185" height="56" rx="8" stroke-width="0.5" style="fill:rgb(241, 239, 232);stroke:rgb(95, 94, 90);color:rgb(11, 11, 11);stroke-width:0.5px;stroke-linecap:butt;stroke-linejoin:miter;opacity:1;font-family:&quot;Anthropic Sans&quot;, -apple-system, &quot;system-ui&quot;, &quot;Segoe UI&quot;, sans-serif;font-size:16px;font-weight:400;text-anchor:start;dominant-baseline:auto"/>
            <text x="340" y="158" text-anchor="middle" dominant-baseline="central" style="fill:rgb(68, 68, 65);stroke:none;color:rgb(11, 11, 11);stroke-width:1px;stroke-linecap:butt;stroke-linejoin:miter;opacity:1;font-family:&quot;Anthropic Sans&quot;, -apple-system, &quot;system-ui&quot;, &quot;Segoe UI&quot;, sans-serif;font-size:14px;font-weight:500;text-anchor:middle;dominant-baseline:central">停摆·技术性违约</text>
...
<svg viewBox="0 0 680 360" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:680px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="QE贬值力与避险需求力的拉锯：避险需求力大于QE贬值力，结果美元指数上涨">
  <defs>
    <marker id="qeArr" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="var(--text-muted)"/>
    </marker>
  </defs>
...
<svg viewBox="0 0 680 605" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:680px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="特朗普减税政策论述框架主线：美元霸权前提统领政治诱因与经济考量，传导至对华影响，辩证收尾">
  ...
  <g>
    <rect x="130" y="40" width="420" height="62" rx="12" fill="#FAEEDA" stroke="#BA7517" stroke-width="0.75"/>
    <text x="340" y="64" font-size="14" font-weight="500" fill="#412402" text-anchor="middle" dominant-baseline="central">核心前提：美元霸权 = "预算软约束"</text>
    <text x="340" y="86" font-size="12" fill="#633806" text-anchor="middle" dominant-baseline="central">美国敢大规模减税的结构性底气 · 全球为其赤字融资</text>
  </g>
  <line x1="340" y1="102" x2="340" y2="132" stroke="#5F5E5A" stroke-width="1.5" marker-end="url(#arrow-tax)"/>
  <g>
    <rect x="40" y="138" width="290" height="138" rx="10" fill="#E6F1FB" stroke="#378ADD" stroke-width="0.5"/>
    <text x="185" y="162" font-size="13" font-weight="500" fill="#0C447C" text-anchor="middle" dominant-baseline="central">一、政治诱因（为何减税）</text>
    <line x1="60" y1="175" x2="310" y2="175" stroke="#85B7EB" stroke-width="0.5"/>
    <text x="58" y="196" font-size="12" fill="#042C53" dominant-baseline="central">· 意识形态 · 共和党"小政府"传统</text>
  ...
  <g>
    <rect x="350" y="138" width="290" height="138" rx="10" fill="#E6F1FB" stroke="#378ADD" stroke-width="0.5"/>
    <text x="495" y="162" font-size="13" font-weight="500" fill="#0C447C" text-anchor="middle" dominant-baseline="central">二、经济考量（想达何效）</text>
    <line x1="370" y1="175" x2="620" y2="175" stroke="#85B7EB" stroke-width="0.5"/>
    <text x="368" y="196" font-size="12" fill="#042C53" dominant-baseline="central">· 供给侧 · 企业税35%→21%、资本回流</text>
  ...
  <line x1="340" y1="276" x2="340" y2="306" stroke="#5F5E5A" stroke-width="1.5" marker-end="url(#arrow-tax)"/>
  <g>
    <rect x="40" y="312" width="600" height="158" rx="10" fill="#E6F1FB" stroke="#378ADD" stroke-width="0.5"/>
    <text x="340" y="336" font-size="13" font-weight="500" fill="#0C447C" text-anchor="middle" dominant-baseline="central">三、对华影响（传导 + 辩证）</text>
    <line x1="60" y1="349" x2="620" y2="349" stroke="#85B7EB" stroke-width="0.5"/>
    <line x1="340" y1="356" x2="340" y2="460" stroke="#85B7EB" stroke-width="0.5" stroke-dasharray="3 2"/>
    <text x="180" y="372" font-size="12" font-weight="500" fill="#0C447C" text-anchor="middle" dominant-baseline="central">短期压力</text>
  ...
  <line x1="340" y1="470" x2="340" y2="500" stroke="#5F5E5A" stroke-width="1.5" marker-end="url(#arrow-tax)"/>
  <g>
    <rect x="110" y="506" width="460" height="68" rx="12" fill="#FAEEDA" stroke="#BA7517" stroke-width="0.75"/>
    <text x="340" y="530" font-size="14" font-weight="500" fill="#412402" text-anchor="middle" dominant-baseline="central">结论：内政优先 + 美元霸权特权</text>
    <text x="340" y="552" font-size="12" fill="#633806" text-anchor="middle" dominant-baseline="central">压力 → 倒逼 → 机遇 的辩证统一</text>
  </g>
</svg>
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">图：特朗普减税论述框架主线——美元霸权（前提）→ 政治诱因 + 经济考量（动机）→ 对华影响（传导+辩证）→ 结论。<br/><span style="color:#BA7517">金色=前提/结论洞察</span> · <span style="color:#378ADD">蓝色=三板块结构</span>。背诵抓住首尾两个金框，中间蓝框自然串起。</figcaption>
</figure>
...
## <a id="经济周期与理论模型"></a>经济周期与理论模型


### 📺 B站视频推荐

**一个视频搞懂经济周期，普通人该如何应对？**
- 内容：通俗讲解经济周期的基本理论、类型及影响
- 👉 [点击观看](https://www.bilibili.com/video/BV1h1GnzxExf/)
> *补充*
...
<svg viewBox="0 0 680 360" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="经济周期名词组一分类图：汇率与价格理论含一价定律购买力平价利率平价，货币收益含铸币税，产业发展含微笑曲线雁行模式，长周期含康德拉季耶夫周期">
  ...
  <rect x="30" y="64" width="620" height="26" rx="6" fill="rgba(24,95,165,0.12)" stroke="#185FA5" stroke-width="0.7"/>
  <text x="340" y="77" text-anchor="middle" font-size="12" font-weight="700" fill="#0C447C" dominant-baseline="central">汇率与价格理论（回答"汇率怎么定"）</text>
  <rect x="30" y="96" width="200" height="58" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="130" y="114" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">一价定律</text>
  ...
  <rect x="240" y="96" width="200" height="58" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="340" y="114" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">购买力平价（PPP）</text>
  ...
  <rect x="450" y="96" width="200" height="58" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="550" y="114" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">利率平价（IRP）</text>
  ...
  <rect x="30" y="170" width="620" height="26" rx="6" fill="rgba(217,119,6,0.12)" stroke="#D97706" stroke-width="0.7"/>
  <text x="340" y="183" text-anchor="middle" font-size="12" font-weight="700" fill="#92400e" dominant-baseline="central">货币收益（回答"发行者得什么"）</text>
  <rect x="30" y="202" width="620" height="44" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="340" y="218" text-anchor="middle" font-size="11" font-weight="700" fill="var(--text-main)">铸币税（Seigniorage）</text>
...
## <a id="新自由主义与全球化变迁"></a>新自由主义与全球化变迁


### 📺 B站视频推荐

**【直播视频字幕版】20201006黄平：新自由主义的前世**
- 内容：讲解新自由主义的起源、发展及其对全球化的影响
- 👉 [点击观看](https://www.bilibili.com/video/BV1Mf4y1q7hC/)

**【直播视频字幕版】20201110 黄平：新自由主义的今生**
- 内容：讲解华盛顿共识及其对全球经济的影响
- 👉 [点击观看](https://www.bilibili.com/video/BV1GT4y1K7dz/)
> *补充*
> *新自由主义为高频概念，散见于多卷论述题*
...
<div class="dgm">
<div class="dgm-h">🌐 新自由主义全球化兴衰辩证全景图 · 1980s 顺风推进 vs 2016 逆流反噬</div>
<figure style="margin:0;">
<svg viewBox="0 0 820 580" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:10px auto;font-family:system-ui,-apple-system,BlinkMacSystemFont,'PingFang SC','Microsoft YaHei',sans-serif;" role="img" aria-label="新自由主义全球化兴衰辩证全景图：1980s顺风推进四大动因（阶级权力恢复、美元松绑无泪赤字、冷战终结意识形态、全球降成本与风险社会化）通过三十年制造业空心化与阶级失衡反噬，爆发为2016后逆全球化四大动因（民粹选票反噬、大国竞争遏制、资本空间修复极限、安全压倒效率）">
  <defs>
    <linearGradient id="grad1980" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#eff6ff"/>
      <stop offset="100%" stop-color="#dbeafe"/>
    </linearGradient>
    ...
    <linearGradient id="grad2016" x1="0%" y1="0%" x2="0%" y2="100%">
    ...
    <marker id="arrowRed" markerWidth="8" markerHeight="8" refX="6" refY="3" orient="auto">
      <path d="M0,0 L0,6 L7,3 z" fill="#b91c1c"/>
    </marker>
  ...
  <!-- 顶部主标题 -->
  <rect x="0" y="0" width="820" height="58" rx="14" fill="#0f172a"/>
  <rect x="0" y="44" width="820" height="14" fill="#0f172a"/>
  <text x="410" y="27" text-anchor="middle" font-size="16" font-weight="700" fill="#f8fafc">🌐 新自由主义全球化兴衰辩证全景图 · 1980s 顺风推进 vs 2016 逆流反噬</text>
  <text x="410" y="46" text-anchor="middle" font-size="11.5" fill="#94a3b8">核心脉络：以资本为中心的全球扩张 → 国内阶级撕裂与力量对比逆转 → 霸权护持焦虑与民粹反噬</text>

  <!-- 左栏：1980年代顺风推进（四大动因） -->
  <g transform="translate(18, 68)">
    <rect x="0" y="0" width="248" height="456" rx="10" fill="url(#grad1980)" stroke="#93c5fd" stroke-width="1.2" filter="url(#cardShadow)"/>
    <rect x="0" y="0" width="248" height="34" rx="10" fill="#1e3a8a"/>
    <rect x="0" y="24" width="248" height="10" fill="#1e3a8a"/>
    <text x="124" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#ffffff">🚀 1980s 推行全球化动因</text>

    <!-- 卡片1: 滞胀破局 -->
    <rect x="10" y="42" width="228" height="92" rx="7" fill="#ffffff" stroke="#bfdbfe" stroke-width="0.8"/>
    <rect x="18" y="50" width="62" height="18" rx="4" fill="#1e40af"/>
    <text x="49" y="63" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">滞胀困境</text>
    <text x="88" y="63" font-size="11" font-weight="700" fill="#1e3a8a">恢复资本阶级权力</text>
    <text x="18" y="82" font-size="10.5" fill="#334155">• 凯恩斯失灵，新自由主义被推为救药</text>
    <text x="18" y="99" font-size="10.5" fill="#334155">• 削弱工会、压低工资、削减福利保障</text>
    <text x="18" y="116" font-size="10.5" fill="#64748b">• 根本目的：打破工会制约，恢复资本回报</text>

    <!-- 卡片2: 美元松绑 -->
    <rect x="10" y="142" width="228" height="94" rx="7" fill="#ffffff" stroke="#bfdbfe" stroke-width="0.8"/>
    <rect x="18" y="150" width="62" height="18" rx="4" fill="#1e40af"/>
    <text x="49" y="163" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">美元松绑</text>
    <text x="88" y="163" font-size="11" font-weight="700" fill="#1e3a8a">无泪赤字与全球抽税</text>
    <text x="18" y="182" font-size="10.5" fill="#334155">• 1971脱钩黄金，解除顺差刚性兑付束缚</text>
    <text x="18" y="199" font-size="10.5" fill="#334155">• 迫使外围开放金融，逆差输出/美债回流</text>
    <text x="18" y="216" font-size="10.5" fill="#64748b">• 凭储备地位向全球征铸币税与通胀税</text>

    <!-- 卡片3: 冷战终结 -->
    <rect x="10" y="244" width="228" height="94" rx="7" fill="#ffffff" stroke="#bfdbfe" stroke-width="0.8"/>
    <rect x="18" y="252" width="62" height="18" rx="4" fill="#1e40af"/>
    <text x="49" y="265" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">冷战终结</text>
    <text x="88" y="265" font-size="11" font-weight="700" fill="#1e3a8a">“历史终结”意识形态</text>
    <text x="18" y="284" font-size="10.5" fill="#334155">• 将西方体制包装为“普世历史终结”</text>
    <text x="18" y="301" font-size="10.5" fill="#334155">• 诱压苏东与发展中国家“休克疗法”</text>
    <text x="18" y="318" font-size="10.5" fill="#64748b">• 为美式资本全球化开拓原处女地市场</text>

    <!-- 卡片4: 产业链重构 -->
    <rect x="10" y="346" width="228" height="98" rx="7" fill="#ffffff" stroke="#bfdbfe" stroke-width="0.8"/>
    <rect x="18" y="354" width="62" height="18" rx="4" fill="#1e40af"/>
    <text x="49" y="367" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">成本重构</text>
    <text x="88" y="367" font-size="11" font-weight="700" fill="#1e3a8a">跨国离岸与风险外溢</text>
    <text x="18" y="386" font-size="10.5" fill="#334155">• 跨国公司将制造外包东亚低成本洼地</text>
    <text x="18" y="403" font-size="10.5" fill="#334155">• 规避本土严格环保、高劳工福利管制</text>
    <text x="18" y="420" font-size="10.5" fill="#166534">• 跨国资本利润狂飙，国内工会彻底被架空</text>
  </g>

  <!-- 中栏：内在矛盾积累与结构质变（反噬链条） -->
  <g transform="translate(276, 68)">
    <rect x="0" y="0" width="268" height="456" rx="10" fill="url(#gradCenter)" stroke="#fcd34d" stroke-width="1.2" filter="url(#cardShadow)"/>
    <rect x="0" y="0" width="268" height="34" rx="10" fill="#b45309"/>
    <rect x="0" y="24" width="268" height="10" fill="#b45309"/>
    <text x="134" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#ffffff">⚡ 三十年矛盾积累与结构质变</text>

    <!-- 矛盾1: 阶级撕裂 -->
    <rect x="10" y="42" width="248" height="92" rx="7" fill="#ffffff" stroke="#fde68a" stroke-width="0.8"/>
    <text x="18" y="62" font-size="11.5" font-weight="700" fill="#92400e">① 资本狂欢 vs 劳动受损（再分配失灵）</text>
    <text x="18" y="80" font-size="10.5" fill="#334155">• 金融与科技寡头攫取全球化全部超额利润</text>
    <text x="18" y="97" font-size="10.5" fill="#b91c1c">• 前1%财富集中度重回1929大萧条前夜</text>
    <text x="18" y="114" font-size="10.5" fill="#475569">• 涓滴承诺破灭，国家财政无力兜底补偿</text>

    <!-- 矛盾2: 铁锈地带 -->
    <rect x="10" y="142" width="248" height="94" rx="7" fill="#ffffff" stroke="#fde68a" stroke-width="0.8"/>
    <text x="18" y="162" font-size="11.5" font-weight="700" fill="#92400e">② 产业空心化与“被遗忘者”绝望</text>
    <text x="18" y="180" font-size="10.5" fill="#334155">• 五大湖区工厂关闭，数百万优质蓝领岗位蒸发</text>
    <text x="18" y="197" font-size="10.5" fill="#b91c1c">• 白人中下层社区瓦解，阿片类药物泛滥</text>
    <text x="18" y="214" font-size="10.5" fill="#475569">• 人均预期寿命罕见下降，民粹烈火蓄势待发</text>

    <!-- 矛盾3: 力量对比逆转 -->
    <rect x="10" y="244" width="248" height="94" rx="7" fill="#ffffff" stroke="#fde68a" stroke-width="0.8"/>
    <text x="18" y="262" font-size="11.5" font-weight="700" fill="#92400e">③ 中国崛起与力量平衡实质性打破</text>
    <text x="18" y="280" font-size="10.5" fill="#334155">• 中国未按西方设想“和平演变”，坚持制度主体</text>
    <text x="18" y="297" font-size="10.5" fill="#15803d">• 建立全球最完整工业体系 + 产业链编辑能力</text>
    <text x="18" y="314" font-size="10.5" fill="#475569">• 从中低端制造向芯片/AI等高地攀升（萨缪尔森陷阱）</text>

    <!-- 矛盾4: 工具异化 -->
    <rect x="10" y="346" width="248" height="98" rx="7" fill="#ffffff" stroke="#fde68a" stroke-width="0.8"/>
    <text x="18" y="364" font-size="11.5" font-weight="700" fill="#92400e">④ 霸权工具异化：从“赋能”变“资敌”</text>
    <text x="18" y="382" font-size="10.5" fill="#334155">• 美元潮汐收割频频撞墙，外围主权防卫增强</text>
    <text x="18" y="399" font-size="10.5" fill="#b91c1c">• 自由贸易反令中国成为“全球制造业超级大国”</text>
    <text x="18" y="416" font-size="10.5" fill="#334155">• 帝国精英恐惧：全球化正加速埋葬美单极霸权</text>
  </g>

  <!-- 右栏：2016年之后逆流反噬（四大动因） -->
  <g transform="translate(554, 68)">
    <rect x="0" y="0" width="248" height="456" rx="10" fill="url(#grad2016)" stroke="#fca5a5" stroke-width="1.2" filter="url(#cardShadow)"/>
    <rect x="0" y="0" width="248" height="34" rx="10" fill="#991b1b"/>
    <rect x="0" y="24" width="248" height="10" fill="#991b1b"/>
    <text x="124" y="22" text-anchor="middle" font-size="13" font-weight="700" fill="#ffffff">🛑 2016 逆全球化浪潮动因</text>

    <!-- 卡片5: 民粹反噬 -->
    <rect x="10" y="42" width="228" height="92" rx="7" fill="#ffffff" stroke="#fecaca" stroke-width="0.8"/>
    <rect x="18" y="50" width="62" height="18" rx="4" fill="#dc2626"/>
    <text x="49" y="63" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">民粹引爆</text>
    <text x="88" y="63" font-size="11" font-weight="700" fill="#991b1b">国内阶级矛盾外部化</text>
    <text x="18" y="82" font-size="10.5" fill="#334155">• 铁锈带蓝领选票造就特朗普政权上台</text>
    <text x="18" y="99" font-size="10.5" fill="#334155">• 政治家引导怒火归咎“外国抢走饭碗”</text>
    <text x="18" y="116" font-size="10.5" fill="#dc2626">• “美国优先”撕毁多边自贸条约</text>

    <!-- 卡片6: 大国竞争 -->
    <rect x="10" y="142" width="228" height="94" rx="7" fill="#ffffff" stroke="#fecaca" stroke-width="0.8"/>
    <rect x="18" y="150" width="62" height="18" rx="4" fill="#dc2626"/>
    <text x="49" y="163" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">大国竞争</text>
    <text x="88" y="163" font-size="11" font-weight="700" fill="#991b1b">两党共识将华视为头号对手</text>
    <text x="18" y="182" font-size="10.5" fill="#334155">• 判定接触政策彻底失败，回归现实主义</text>
    <text x="18" y="199" font-size="10.5" fill="#334155">• 经贸科技“脱钩/去风险”，构筑小院高墙</text>
    <text x="18" y="216" font-size="10.5" fill="#991b1b">• 不惜牺牲经济效率，也要斩断对手攀升</text>

    <!-- 卡片7: 创造性破坏 -->
    <rect x="10" y="244" width="228" height="94" rx="7" fill="#ffffff" stroke="#fecaca" stroke-width="0.8"/>
    <rect x="18" y="252" width="62" height="18" rx="4" fill="#dc2626"/>
    <text x="49" y="265" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">空间修复</text>
    <text x="88" y="265" font-size="11" font-weight="700" fill="#991b1b">创造性破坏与规则重塑</text>
    <text x="18" y="284" font-size="10.5" fill="#334155">• 资本全球扩张到头，制造危机重置市场</text>
    <text x="18" y="301" font-size="10.5" fill="#334155">• 推出“新华盛顿共识”搞友岸/近岸外包</text>
    <text x="18" y="318" font-size="10.5" fill="#991b1b">• 从全球化领导者蜕变为排他收割圈圈主</text>

    <!-- 卡片8: 疫情与地缘加速 -->
    <rect x="10" y="346" width="228" height="98" rx="7" fill="#ffffff" stroke="#fecaca" stroke-width="0.8"/>
    <rect x="18" y="354" width="62" height="18" rx="4" fill="#dc2626"/>
    <text x="49" y="367" text-anchor="middle" font-size="10" font-weight="700" fill="#ffffff">安全置顶</text>
    <text x="88" y="367" font-size="11" font-weight="700" fill="#991b1b">依赖武器化与阵营割裂</text>
    <text x="18" y="386" font-size="10.5" fill="#334155">• 新冠暴露过度外包脆弱性，借机强推回流</text>
    <text x="18" y="403" font-size="10.5" fill="#334155">• 俄乌冲突将SWIFT与金融相互依赖武器化</text>
    <text x="18" y="420" font-size="10.5" fill="#b91c1c">• “经济安全”凌驾市场效率，世界走向碎片化</text>
  </g>

  <!-- 柱间转换导向箭头 -->
  <path d="M 268 290 L 274 290" fill="none" stroke="#b45309" stroke-width="2.5" marker-end="url(#arrowRight)"/>
  <path d="M 546 290 L 552 290" fill="none" stroke="#b91c1c" stroke-width="2.5" marker-end="url(#arrowRed)"/>

  <!-- 底部翟东升核心理论结论栏 -->
  <g transform="translate(18, 532)">
    <rect x="0" y="0" width="784" height="38" rx="8" fill="#f8fafc" stroke="#cbd5e1" stroke-width="1"/>
    <text x="392" y="16" text-anchor="middle" font-size="11" font-weight="700" fill="#0f172a">💡 翟东升理论落点（《货币、权力与人》）：“新自由主义因其伪科学与真右翼面目必然瓦解，全球理论市场呼唤民本主义政治经济学”</text>
    <text x="392" y="30" text-anchor="middle" font-size="10" fill="#64748b">考场点睛：80年代是资本用全球化压制国内劳动；2016后是失落劳动阶级民粹反弹与帝国护持精英的奇妙同盟</text>
  </g>
</svg>
<figcaption style="margin-top:6px;font-size:11px;color:var(--text-muted);text-align:center;">
图：<b>新自由主义全球化兴衰辩证全景图</b>（1980s 资本阶级权力恢复与全球扩张 ➔ 制造业空心化与阶级撕裂反噬 ➔ 2016后民粹爆发与大国竞争遏制）。
</figcaption>
</figure>
</div>
...
<svg viewBox="0 0 680 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="三国金融自由化对照图：智利芝加哥男孩急速自由化1982崩溃，阿根廷货币局制度2001最大主权违约，乌拉圭被传染2002挤兑；四条教训与对中国的三点启示">
  <defs>
    <marker id="arrLib" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="#0F6E56"/>
    </marker>
  </defs>
  ...
  <rect x="30" y="102" width="190" height="36" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="125" y="116" text-anchor="middle" font-size="10.5" font-weight="700" fill="var(--text-main)">"芝加哥男孩"主导</text>
  ...
  <line x1="340" y1="270" x2="340" y2="294" stroke="#0F6E56" stroke-width="1.4" marker-end="url(#arrLib)"/>
  <text x="352" y="284" font-size="10" font-weight="700" fill="#0F6E56">取反</text>
...
## <a id="区域合作与特定项目"></a>区域合作与特定项目


### 📺 B站视频推荐

**国际政治经济学-全球化与区域经济合作-贺平**
- 内容：讲解全球化背景下的区域经济合作模式与案例
- 👉 [点击观看](https://www.bilibili.com/video/BV18K4y1f7kJ/)
> *补充*
...
*   **转变前（被动模式）**：贸易顺差→外储→买美债→借给发达国家消费（收益率 ~3%，甚至负利率）。本质是"**资金回流**"——穷国借钱给富国，是向美元体系交"铸币税"。
...
*   **外汇储备题**：讲中国储蓄**被动**流向美国（买美债，低收益）的旧模式及其代价（铸币税）；
...
<svg viewBox="0 0 680 390" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:640px;display:block;margin:0 auto;font-family:inherit;" role="img" aria-label="一带一路中国储蓄范式转换图：高储蓄从被动积累买美债转向主动输出实体项目，积极后果三项风险四项，结论从债权到权力">
  <defs>
    <marker id="arrBRI" markerWidth="10" markerHeight="10" refX="8" refY="3" orient="auto" markerUnits="strokeWidth">
      <path d="M0,0 L0,6 L9,3 z" fill="var(--text-muted)"/>
    </marker>
  </defs>
  ...
  <rect x="250" y="62" width="180" height="34" rx="8" fill="rgba(83,74,183,0.10)" stroke="#534AB7" stroke-width="0.8"/>
  <text x="340" y="79" text-anchor="middle" font-size="12" font-weight="700" fill="#3C3489" dominant-baseline="central">中国高储蓄（2022 ≈ GDP 45%）</text>
  <line x1="340" y1="96" x2="190" y2="120" stroke="var(--text-muted)" stroke-width="1.2" marker-end="url(#arrBRI)"/>
  <line x1="340" y1="96" x2="490" y2="120" stroke="var(--text-muted)" stroke-width="1.2" marker-end="url(#arrBRI)"/>
  <rect x="30" y="124" width="290" height="30" rx="6" fill="rgba(95,94,90,0.12)" stroke="#5F5E5A" stroke-width="0.7"/>
  <text x="175" y="139" text-anchor="middle" font-size="12" font-weight="700" fill="#444441" dominant-baseline="central">转变前 · 被动积累（资金回流）</text>
  <rect x="30" y="158" width="290" height="52" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="44" y="176" font-size="10.5" font-weight="700" fill="var(--text-main)">贸易顺差 → 外储 → 买美债</text>
  <text x="44" y="193" font-size="10" fill="var(--text-muted)">收益率 ~3% 甚至负利率</text>
  <text x="44" y="207" font-size="10" fill="var(--text-muted)">向美元体系交"铸币税"</text>
  ...
  <rect x="360" y="158" width="290" height="52" rx="8" fill="var(--card-bg)" stroke="var(--border)" stroke-width="0.6"/>
  <text x="374" y="176" font-size="10.5" font-weight="700" fill="var(--text-main)">储蓄 → 国开行/进出口行 → 实体项目</text>
  ...
  <line x1="175" y1="210" x2="175" y2="236" stroke="var(--text-muted)" stroke-width="1.2" marker-end="url(#arrBRI)"/>
  <line x1="505" y1="210" x2="505" y2="236" stroke="var(--text-muted)" stroke-width="1.2" marker-end="url(#arrBRI)"/>
  <rect x="30" y="240" width="290" height="64" rx="8" fill="rgba(15,110,86,0.08)" stroke="#0F6E56" stroke-width="0.7"/>
  <text x="44" y="258" font-size="11" font-weight="700" fill="#085041">积极后果 ×3</text>
  ...
  <rect x="30" y="330" width="620" height="44" rx="8" fill="rgba(83,74,183,0.08)" stroke="#534AB7" stroke-width="0.8"/>
  <text x="340" y="346" text-anchor="middle" font-size="11.5" font-weight="700" fill="#3C3489" dominant-baseline="central">结论：从"为发达国家融资"到"为全球南方赋能"——从债权到权力</text>
...
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:6px;line-height:1.6;">图：<b>范式转换</b>——中国储蓄从"为发达国家被动融资"（买美债、铸币税）转向"为全球南方主动赋能"（实体投资、结构性权力）；积极后果与风险并存，结论落点在"债权→权力"。</figcaption>
</figure>
...
**【政治经济学】期末复习精品整理**
- 内容：政治经济学重点知识整理，可作为补充复习资料
- 👉 [点击观看](https://www.bilibili.com/video/BV1Hm4y1F7Hr/)

#### 1. [名] 最优货币区（Optimal Currency Area, OCA）
> *出现 1 次：卷5*
...
#### 3. [名] 国际收支（Balance of Payments, BOP）
> *出现 1 次：卷5*
...
### <a id="补遗-发展与政治经济学概念"></a>发展与政治经济学概念
...
<figcaption style="text-align:center;font-size:12px;color:var(--text-muted);margin-top:4px;">图：货币权力金字塔——<b>计价/结算（塔基）→ 投资/干预（中层）→ 储备（高层）→ 锚货币（塔尖）</b>。美元六维全占，人民币正从塔基攀升。</figcaption>
</figure>
</div>

**四、翟东升的核心撕开点："债务定价币种"才是真权力**
